...
Assert-Contains $cargoContent 'version = "10.12.1"' "kernel-lab version 10.7.0"
...
Assert-Contains $mainContent "let eoi_status = if preconditions_met {`n                                                `"ready (dry-run)`"`n                                            } else {`n                                                `"blocked`"`n                                            };" "eoi-runtime-status dry-run ready wording"
Assert-Contains $mainContent "let preconditions_met =`n                                                irq::eoi_runtime_check_all_preconditions(`n                                                    pic_state.executed,`n                                                );" "eoi-runtime-status uses EOI precondition telemetry"
...
Assert-Contains $cargoContent930 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent931 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent940 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent941 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent950 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent951 'version = "10.12.1"' "kernel-lab current version 10.7.0"
...
Assert-Contains $cargoContent960 'version = "10.12.1"' "kernel-lab version 10.7.0"
...
Assert-Contains $cargoContent961 'version = "10.12.1"' "kernel-lab version 10.7.0"
...
Assert-Contains $cargoContent971 'version = "10.12.1"' "kernel-lab version 10.7.0"
...
Assert-Contains $cargoContent980 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent980 'version = "9.7.1"' "kernel-lab stale v9.7.1 package version guard"
Assert-Contains $kernelCargoLockContent980 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $cargoContent981 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent981 'version = "9.8.0"' "kernel-lab stale v9.8.0 package version guard"
Assert-Contains $kernelCargoLockContent981 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
# v9.9.0: Controlled STI Plan Foundation
Write-Host "Verifying v9.9.0 Controlled STI Plan Foundation contracts..."
$v981Tag = & git rev-list -n 1 v9.8.1 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v981Tag) { throw "v9.8.1 tag not found (required baseline)" }
if ($HEAD -eq $v981Tag) { throw "HEAD is still v9.8.1, v9.9.0 work not completed" }
Write-Host "[OK] v9.9.0 branch is beyond v9.8.1 locked baseline"

$cargoContent990 = Get-Content $cargoToml -Raw
$kernelCargoLockContent990 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent990 = Get-Content $irrRs -Raw
$picContent990 = Get-Content $picRs -Raw
$mainContent990 = Get-Content $mainRs -Raw
...
Assert-Contains $cargoContent990 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent990 'version = "9.8.1"' "kernel-lab stale v9.8.1 package version guard"
Assert-Contains $kernelCargoLockContent990 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent990 'line_str == "sti-status"' "sti-status dispatcher"
Assert-Contains $mainContent990 'line_str == "sti-preflight"' "sti-preflight dispatcher"
Assert-Contains $mainContent990 'line_str == "sti-blockers"' "sti-blockers dispatcher"
Assert-Contains $irrContent990 'pub struct StiControlledActivationPlan' "STI plan telemetry struct"
Assert-Contains $irrContent990 'pub fn sti_controlled_activation_plan(' "STI plan telemetry helper"
Assert-Contains $irrContent990 'pub const STI_PLAN_ALLOWED_NO: &str = "no";' "STI plan allowed no wording"
Assert-Contains $irrContent990 'pub const STI_PLAN_RESULT_BLOCKED: &str = "blocked";' "STI plan blocked result wording"
Assert-Contains $irrContent990 'pub const STI_PLAN_NEXT_BLOCKERS: &str = "execute sti-blockers";' "STI plan next blockers wording"

$stiHelperStart990 = $irrContent990.IndexOf('pub fn sti_controlled_activation_plan(')
$stiHelperEnd990 = $irrContent990.Length
if ($stiHelperStart990 -lt 0) { throw "v9.9.0 STI helper isolation failed" }
$stiHelperBlock990 = $irrContent990.Substring($stiHelperStart990, $stiHelperEnd990 - $stiHelperStart990)

$stiPlanStart990 = $mainContent990.IndexOf('} else if line_str == "sti-plan" {')
$stiStatusStart990 = $mainContent990.IndexOf('} else if line_str == "sti-status" {')
$stiPreflightStart990 = $mainContent990.IndexOf('} else if line_str == "sti-preflight" {')
$stiBlockersStart990 = $mainContent990.IndexOf('} else if line_str == "sti-blockers" {')
$stiBlockersEnd990 = $mainContent990.IndexOf('} else if line_str == "eoi-runtime-note" {', $stiBlockersStart990)
if ($stiPlanStart990 -lt 0 -or $stiStatusStart990 -lt $stiPlanStart990 -or $stiPreflightStart990 -lt $stiStatusStart990 -or $stiBlockersStart990 -lt $stiPreflightStart990 -or $stiBlockersEnd990 -lt $stiBlockersStart990) {
    throw "v9.9.0 STI command block isolation failed"
}
$stiPlanBlock990 = $mainContent990.Substring($stiPlanStart990, $stiStatusStart990 - $stiPlanStart990)
$stiStatusBlock990 = $mainContent990.Substring($stiStatusStart990, $stiPreflightStart990 - $stiStatusStart990)
$stiPreflightBlock990 = $mainContent990.Substring($stiPreflightStart990, $stiBlockersStart990 - $stiPreflightStart990)
$stiBlockersBlock990 = $mainContent990.Substring($stiBlockersStart990, $stiBlockersEnd990 - $stiBlockersStart990)

$stiPlanExact990 = 'STI controlled activation plan\nsti instruction: {}\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nPIC unmask: {}\nEOI dispatch: {}\nkeyboard mode: {}\nruntime irq active: {}\n'
$stiStatusExact990 = 'STI controlled activation status\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nsimulation: {}\nsti instruction: {}\nsti allowed: {}\nruntime irq active: {}\n'
$stiPreflightExact990 = 'STI controlled activation preflight\ntoken gate: {}\nreadiness matrix: {}\nEOI runtime boundary: {}\nPIC unmask policy: {}\nhardware mutation: {}\nkeyboard mode: {}\nresult: {}\nnext: {}\n'
$stiBlockersExact990 = 'STI controlled activation blockers\n- activation token: {}\n- runtime gate: {}\n- readiness matrix: {}\n- simulation: {}\n- EOI runtime boundary: {}\n- PIC unmask: {}\n- EOI dispatch: {}\n- keyboard mode: {}\nsti allowed: {}\n'
Assert-Contains $stiPlanBlock990 $stiPlanExact990 "v9.9.0 sti-plan exact output"
Assert-Contains $stiStatusBlock990 $stiStatusExact990 "v9.9.0 sti-status exact output"
Assert-Contains $stiPreflightBlock990 $stiPreflightExact990 "v9.9.0 sti-preflight exact output"
Assert-Contains $stiBlockersBlock990 $stiBlockersExact990 "v9.9.0 sti-blockers exact output"
Assert-ContainsInOrder $stiBlockersBlock990 @(
    '- activation token: {}',
    '- runtime gate: {}',
    '- readiness matrix: {}',
    '- simulation: {}',
    ...
    '- keyboard mode: {}',
    'sti allowed: {}'
) "v9.9.0 STI blockers ordering"

foreach ($stiReadBlock in @($stiStatusBlock990, $stiPreflightBlock990, $stiBlockersBlock990)) {
    Assert-ContainsInOrder $stiReadBlock @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v9.9.0 STI reader ordering"
}

foreach ($forbiddenStiPlanRead in @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    Assert-NotContains $stiPlanBlock990 $forbiddenStiPlanRead "v9.9.0 sti-plan remains constant-only: $forbiddenStiPlanRead"
}

foreach ($stiBlock in @($stiPlanBlock990, $stiStatusBlock990, $stiPreflightBlock990, $stiBlockersBlock990, $stiHelperBlock990)) {
    foreach ($blockedStiCall in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq::irq_runtime_commit()',
        ...
        Assert-NotContains $stiBlock $blockedStiCall "v9.9.0 STI plan path is read-only: $blockedStiCall"
    }
}

$expectedQemuStiPlanOutput990 = "STI controlled activation plan`n    sti instruction: disabled`n    activation token: required`n    runtime gate: not allowed`n    readiness matrix: blocked`n    PIC unmask: disabled`n    EOI dispatch: disabled`n    keyboard mode: polling`n    runtime irq active: no"
$expectedQemuStiStatusOutput990 = "STI controlled activation status`n    activation token: absent`n    runtime gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    sti instruction: disabled`n    sti allowed: no`n    runtime irq active: no"
$expectedQemuStiPreflightOutput990 = "STI controlled activation preflight`n    token gate: absent`n    readiness matrix: blocked`n    EOI runtime boundary: disabled`n    PIC unmask policy: no unmask`n    hardware mutation: no`n    keyboard mode: polling`n    result: blocked`n    next: execute sti-blockers"
$expectedQemuStiBlockersOutput990 = "STI controlled activation blockers`n    - activation token: absent`n    - runtime gate: activation blocked`n    - readiness matrix: runtime irq ready no`n    - simulation: simulation blocked`n    - EOI runtime boundary: disabled`n    - PIC unmask: disabled`n    - EOI dispatch: disabled`n    - keyboard mode: polling`n    sti allowed: no"
Assert-Contains $kernelBootSmokeDocs990 $expectedQemuStiPlanOutput990 "qemu docs sti-plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs990 $expectedQemuStiStatusOutput990 "qemu docs sti-status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs990 $expectedQemuStiPreflightOutput990 "qemu docs sti-preflight exact rendered contract"
Assert-Contains $kernelBootSmokeDocs990 $expectedQemuStiBlockersOutput990 "qemu docs sti-blockers exact rendered contract"
Assert-ContainsInOrder $kernelBootSmokeDocs990 @(
    "- activation token: absent",
    ...
    "sti allowed: no"
) "qemu docs STI blockers rendered ordering"

Assert-Contains $stiStatusBlock990 'sti_plan.sti_allowed' "v9.9.0 sti-status reports STI denied"
Assert-Contains $stiStatusBlock990 'sti_plan.runtime_irq_active' "v9.9.0 sti-status reports inactive runtime IRQ"
Assert-Contains $stiPreflightBlock990 'sti_plan.hardware_mutation' "v9.9.0 sti-preflight reports no hardware mutation"
Assert-Contains $stiPreflightBlock990 'sti_plan.keyboard_mode' "v9.9.0 sti-preflight keeps keyboard polling"
Assert-Contains $stiBlockersBlock990 'sti_plan.pic_unmask' "v9.9.0 sti-blockers reports PIC unmask disabled"
Assert-Contains $stiBlockersBlock990 'sti_plan.eoi_dispatch' "v9.9.0 sti-blockers reports EOI dispatch disabled"
Assert-NotContains $irrContent990 'asm!("sti")' "v9.9.0 irq source still has no STI"
Assert-NotContains $mainContent990 'asm!("sti")' "v9.9.0 kernel main still has no STI"
Assert-NotContains $mainContent990 'global_asm!("sti")' "v9.9.0 kernel main still has no STI global asm"
Assert-Contains $picContent990 'pub const PIC_MASK_ALL: u8 = 0xFF;' "v9.9.0 safe mask-all constant remains allowed"
foreach ($literal in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent990 "write_pic_port(PIC_MASTER_DATA, $literal)" "v9.9.0 no master unmask literal $literal in main"
    Assert-NotContains $mainContent990 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v9.9.0 no slave unmask literal $literal in main"
    Assert-NotContains $picContent990 "write_pic_port(PIC_MASTER_DATA, $literal)" "v9.9.0 no master unmask literal $literal in pic.rs"
    Assert-NotContains $picContent990 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v9.9.0 no slave unmask literal $literal in pic.rs"
}
Assert-NotContains $mainContent990 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v9.9.0 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent990 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v9.9.0 kernel main does not dispatch slave EOI"
Assert-NotContains $mainContent990 'timer_interrupt_handler_stub' "v9.9.0 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent990 'keyboard_interrupt_handler_stub' "v9.9.0 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent990 'timer_irq' "v9.9.0 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent990 'keyboard_irq' "v9.9.0 kernel main has no keyboard IRQ activation path"
Assert-Contains $mainContent990 'polling-only' "v9.9.0 keyboard polling telemetry unchanged"

Write-Host "[OK] v9.9.0 Controlled STI Plan Foundation verified"

# v9.9.1: Controlled STI Plan Hardening
Write-Host "Verifying v9.9.1 Controlled STI Plan Hardening contracts..."
$v990Tag = & git rev-list -n 1 v9.9.0 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v990Tag) { throw "v9.9.0 tag not found (required baseline)" }
if ($HEAD -eq $v990Tag) { throw "HEAD is still v9.9.0, v9.9.1 work not completed" }
Write-Host "[OK] v9.9.1 branch is beyond v9.9.0 locked baseline"

$cargoContent991 = Get-Content $cargoToml -Raw
$kernelCargoLockContent991 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent991 = Get-Content $irrRs -Raw
$picContent991 = Get-Content $picRs -Raw
$mainContent991 = Get-Content $mainRs -Raw
...
Assert-Contains $cargoContent991 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent991 'version = "9.9.0"' "kernel-lab stale v9.9.0 package version guard"
Assert-Contains $kernelCargoLockContent991 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent991 'line_str == "sti-status"' "v9.9.1 sti-status dispatcher"
Assert-Contains $mainContent991 'line_str == "sti-preflight"' "v9.9.1 sti-preflight dispatcher"
Assert-Contains $mainContent991 'line_str == "sti-blockers"' "v9.9.1 sti-blockers dispatcher"

$stiHelperStart991 = $irrContent991.IndexOf('pub fn sti_controlled_activation_plan(')
$stiHelperEnd991 = $irrContent991.Length
if ($stiHelperStart991 -lt 0) { throw "v9.9.1 STI helper isolation failed" }
$stiHelperBlock991 = $irrContent991.Substring($stiHelperStart991, $stiHelperEnd991 - $stiHelperStart991)

$stiPlanStart991 = $mainContent991.IndexOf('} else if line_str == "sti-plan" {')
$stiStatusStart991 = $mainContent991.IndexOf('} else if line_str == "sti-status" {')
$stiPreflightStart991 = $mainContent991.IndexOf('} else if line_str == "sti-preflight" {')
$stiBlockersStart991 = $mainContent991.IndexOf('} else if line_str == "sti-blockers" {')
$stiBlockersEnd991 = $mainContent991.IndexOf('} else if line_str == "eoi-runtime-note" {', $stiBlockersStart991)
if ($stiPlanStart991 -lt 0 -or $stiStatusStart991 -lt $stiPlanStart991 -or $stiPreflightStart991 -lt $stiStatusStart991 -or $stiBlockersStart991 -lt $stiPreflightStart991 -or $stiBlockersEnd991 -lt $stiBlockersStart991) {
    throw "v9.9.1 STI command block isolation failed"
}
$stiPlanBlock991 = $mainContent991.Substring($stiPlanStart991, $stiStatusStart991 - $stiPlanStart991)
$stiStatusBlock991 = $mainContent991.Substring($stiStatusStart991, $stiPreflightStart991 - $stiStatusStart991)
$stiPreflightBlock991 = $mainContent991.Substring($stiPreflightStart991, $stiBlockersStart991 - $stiPreflightStart991)
$stiBlockersBlock991 = $mainContent991.Substring($stiBlockersStart991, $stiBlockersEnd991 - $stiBlockersStart991)

$stiPlanExact991 = 'STI controlled activation plan\nsti instruction: {}\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nPIC unmask: {}\nEOI dispatch: {}\nkeyboard mode: {}\nruntime irq active: {}\n'
$stiStatusExact991 = 'STI controlled activation status\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nsimulation: {}\nsti instruction: {}\nsti allowed: {}\nruntime irq active: {}\n'
$stiPreflightExact991 = 'STI controlled activation preflight\ntoken gate: {}\nreadiness matrix: {}\nEOI runtime boundary: {}\nPIC unmask policy: {}\nhardware mutation: {}\nkeyboard mode: {}\nresult: {}\nnext: {}\n'
$stiBlockersExact991 = 'STI controlled activation blockers\n- activation token: {}\n- runtime gate: {}\n- readiness matrix: {}\n- simulation: {}\n- EOI runtime boundary: {}\n- PIC unmask: {}\n- EOI dispatch: {}\n- keyboard mode: {}\nsti allowed: {}\n'
Assert-Contains $stiPlanBlock991 $stiPlanExact991 "v9.9.1 sti-plan exact output"
Assert-Contains $stiStatusBlock991 $stiStatusExact991 "v9.9.1 sti-status exact output"
Assert-Contains $stiPreflightBlock991 $stiPreflightExact991 "v9.9.1 sti-preflight exact output"
Assert-Contains $stiBlockersBlock991 $stiBlockersExact991 "v9.9.1 sti-blockers exact output"
Assert-ContainsInOrder $stiBlockersBlock991 @(
    '- activation token: {}',
    '- runtime gate: {}',
    '- readiness matrix: {}',
    '- simulation: {}',
    ...
    '- keyboard mode: {}',
    'sti allowed: {}'
) "v9.9.1 STI blockers ordering"

foreach ($stiReadBlock in @($stiStatusBlock991, $stiPreflightBlock991, $stiBlockersBlock991)) {
    Assert-ContainsInOrder $stiReadBlock @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
...
foreach ($forbiddenStiPlanRead in @(
    ...
    Assert-NotContains $stiPlanBlock991 $forbiddenStiPlanRead "v9.9.1 sti-plan remains constant-only: $forbiddenStiPlanRead"
}

foreach ($stiBlock in @($stiPlanBlock991, $stiStatusBlock991, $stiPreflightBlock991, $stiBlockersBlock991, $stiHelperBlock991)) {
    foreach ($blockedStiCall in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        ...
        Assert-NotContains $stiBlock $blockedStiCall "v9.9.1 STI plan path is read-only: $blockedStiCall"
    }
}

$expectedQemuStiPlanOutput991 = "STI controlled activation plan`n    sti instruction: disabled`n    activation token: required`n    runtime gate: not allowed`n    readiness matrix: blocked`n    PIC unmask: disabled`n    EOI dispatch: disabled`n    keyboard mode: polling`n    runtime irq active: no"
$expectedQemuStiStatusOutput991 = "STI controlled activation status`n    activation token: absent`n    runtime gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    sti instruction: disabled`n    sti allowed: no`n    runtime irq active: no"
$expectedQemuStiPreflightOutput991 = "STI controlled activation preflight`n    token gate: absent`n    readiness matrix: blocked`n    EOI runtime boundary: disabled`n    PIC unmask policy: no unmask`n    hardware mutation: no`n    keyboard mode: polling`n    result: blocked`n    next: execute sti-blockers"
$expectedQemuStiBlockersOutput991 = "STI controlled activation blockers`n    - activation token: absent`n    - runtime gate: activation blocked`n    - readiness matrix: runtime irq ready no`n    - simulation: simulation blocked`n    - EOI runtime boundary: disabled`n    - PIC unmask: disabled`n    - EOI dispatch: disabled`n    - keyboard mode: polling`n    sti allowed: no"
Assert-Contains $kernelBootSmokeDocs991 $expectedQemuStiPlanOutput991 "v9.9.1 qemu docs sti-plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs991 $expectedQemuStiStatusOutput991 "v9.9.1 qemu docs sti-status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs991 $expectedQemuStiPreflightOutput991 "v9.9.1 qemu docs sti-preflight exact rendered contract"
Assert-Contains $kernelBootSmokeDocs991 $expectedQemuStiBlockersOutput991 "v9.9.1 qemu docs sti-blockers exact rendered contract"

foreach ($sourceSurface in @($irrContent991, $mainContent991, $kernelBootSmokeDocs991)) {
    foreach ($forbiddenPositiveState in @(
        'sti_allowed: yes',
        'sti allowed: yes',
        'runtime irq active: yes'
    )) {
        Assert-NotContains $sourceSurface $forbiddenPositiveState "v9.9.1 forbids positive STI/runtime IRQ state: $forbiddenPositiveState"
    }
}
Assert-NotContains $irrContent991 'asm!("sti")' "v9.9.1 irq source still has no STI"
Assert-NotContains $irrContent991 'asm!("sti",' "v9.9.1 irq source still has no STI asm args"
Assert-NotContains $mainContent991 'asm!("sti")' "v9.9.1 kernel main still has no STI"
Assert-NotContains $mainContent991 'asm!("sti",' "v9.9.1 kernel main still has no STI asm args"
Assert-NotContains $mainContent991 'global_asm!("sti")' "v9.9.1 kernel main still has no STI global asm"
Assert-NotContains $irrContent991 'enable_interrupts' "v9.9.1 irq source has no interrupt enable wrapper"
Assert-NotContains $mainContent991 'enable_interrupts' "v9.9.1 kernel main has no interrupt enable wrapper"
Assert-NotContains $irrContent991 'interrupts::enable' "v9.9.1 irq source has no CPU interrupt enable path"
Assert-NotContains $mainContent991 'interrupts::enable' "v9.9.1 kernel main has no CPU interrupt enable path"
Assert-Contains $picContent991 'pub const PIC_MASK_ALL: u8 = 0xFF;' "v9.9.1 safe mask-all constant remains allowed"
foreach ($literal in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent991 "write_pic_port(PIC_MASTER_DATA, $literal)" "v9.9.1 no master unmask literal $literal in main"
    Assert-NotContains $mainContent991 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v9.9.1 no slave unmask literal $literal in main"
    Assert-NotContains $picContent991 "write_pic_port(PIC_MASTER_DATA, $literal)" "v9.9.1 no master unmask literal $literal in pic.rs"
    Assert-NotContains $picContent991 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v9.9.1 no slave unmask literal $literal in pic.rs"
}
Assert-NotContains $mainContent991 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v9.9.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent991 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v9.9.1 kernel main does not dispatch slave EOI"
Assert-NotContains $mainContent991 'timer_interrupt_handler_stub' "v9.9.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent991 'keyboard_interrupt_handler_stub' "v9.9.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent991 'timer_irq' "v9.9.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent991 'keyboard_irq' "v9.9.1 kernel main has no keyboard IRQ activation path"
Assert-Contains $mainContent991 'polling-only' "v9.9.1 keyboard polling telemetry unchanged"

Write-Host "[OK] v9.9.1 Controlled STI Plan Hardening verified"

# v10.0.0: Controlled IRQ Runtime Activation Smoke Foundation
Write-Host "Verifying v10.0.0 Controlled IRQ Runtime Activation Smoke Foundation contracts..."
$v991Tag = & git rev-list -n 1 v9.9.1 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v991Tag) { throw "v9.9.1 tag not found (required baseline)" }
if ($HEAD -eq $v991Tag) { throw "HEAD is still v9.9.1, v10.0.0 work not completed" }
Write-Host "[OK] v10.0.0 branch is beyond v9.9.1 locked baseline"

$cargoContent1000 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1000 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1000 = Get-Content $irrRs -Raw
$picContent1000 = Get-Content $picRs -Raw
$mainContent1000 = Get-Content $mainRs -Raw
...
Assert-Contains $cargoContent1000 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1000 'version = "9.9.1"' "kernel-lab stale v9.9.1 package version guard"
Assert-Contains $kernelCargoLockContent1000 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1000 'line_str == "irq-runtime-activation-smoke-status"' "v10.0.0 activation smoke status dispatcher"
Assert-Contains $mainContent1000 'line_str == "irq-runtime-activation-smoke-blockers"' "v10.0.0 activation smoke blockers dispatcher"
Assert-Contains $irrContent1000 'pub struct IrqRuntimeActivationSmoke' "activation smoke telemetry struct"
Assert-Contains $irrContent1000 'pub fn irq_runtime_activation_smoke(' "activation smoke telemetry helper"
Assert-Contains $irrContent1000 'pub const IRQ_ACTIVATION_SMOKE_BLOCKED: &str = "blocked";' "activation smoke blocked wording"
Assert-Contains $irrContent1000 'pub const IRQ_ACTIVATION_SMOKE_RESULT_BLOCKED: &str = "smoke blocked";' "activation smoke result wording"
Assert-Contains $irrContent1000 'pub const IRQ_ACTIVATION_SMOKE_NEXT_BLOCKERS: &str =' "activation smoke next blockers constant"
Assert-Contains $irrContent1000 '"execute irq-runtime-activation-smoke-blockers";' "activation smoke next blockers wording"

$smokeHelperStart1000 = $irrContent1000.IndexOf('pub fn irq_runtime_activation_smoke(')
$smokeHelperEnd1000 = $irrContent1000.Length
if ($smokeHelperStart1000 -lt 0) { throw "v10.0.0 activation smoke helper isolation failed" }
$smokeHelperBlock1000 = $irrContent1000.Substring($smokeHelperStart1000, $smokeHelperEnd1000 - $smokeHelperStart1000)

$smokeStart1000 = $mainContent1000.IndexOf('} else if line_str == "irq-runtime-activation-smoke" {')
$smokeStatusStart1000 = $mainContent1000.IndexOf('} else if line_str == "irq-runtime-activation-smoke-status" {')
$smokeBlockersStart1000 = $mainContent1000.IndexOf('} else if line_str == "irq-runtime-activation-smoke-blockers" {')
$smokeBlockersEnd1000 = $mainContent1000.IndexOf('} else if line_str == "eoi-runtime-note" {', $smokeBlockersStart1000)
if ($smokeStart1000 -lt 0 -or $smokeStatusStart1000 -lt $smokeStart1000 -or $smokeBlockersStart1000 -lt $smokeStatusStart1000 -or $smokeBlockersEnd1000 -lt $smokeBlockersStart1000) {
    throw "v10.0.0 activation smoke command block isolation failed"
}
$smokeBlock1000 = $mainContent1000.Substring($smokeStart1000, $smokeStatusStart1000 - $smokeStart1000)
$smokeStatusBlock1000 = $mainContent1000.Substring($smokeStatusStart1000, $smokeBlockersStart1000 - $smokeStatusStart1000)
$smokeBlockersBlock1000 = $mainContent1000.Substring($smokeBlockersStart1000, $smokeBlockersEnd1000 - $smokeBlockersStart1000)

$smokeExact1000 = 'IRQ runtime activation smoke\nactivation smoke: {}\nhardware mutation: {}\nruntime irq active: {}\nsti instruction: {}\npic unmask: {}\neoi dispatch: {}\nkeyboard mode: {}\nresult: {}\nnext: {}\n'
$smokeStatusExact1000 = 'IRQ runtime activation smoke status\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nsimulation: {}\nsti plan: {}\nactivation smoke: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$smokeBlockersExact1000 = 'IRQ runtime activation smoke blockers\n- activation token: {}\n- runtime gate: {}\n- readiness matrix: {}\n- simulation: {}\n- STI plan: {}\n- EOI runtime boundary: {}\n- PIC unmask: {}\n- EOI dispatch: {}\n- keyboard mode: {}\nactivation smoke: {}\n'
Assert-Contains $smokeBlock1000 $smokeExact1000 "v10.0.0 irq-runtime-activation-smoke exact output"
Assert-Contains $smokeStatusBlock1000 $smokeStatusExact1000 "v10.0.0 irq-runtime-activation-smoke-status exact output"
Assert-Contains $smokeBlockersBlock1000 $smokeBlockersExact1000 "v10.0.0 irq-runtime-activation-smoke-blockers exact output"
Assert-ContainsInOrder $smokeBlockersBlock1000 @(
    '- activation token: {}',
    '- runtime gate: {}',
    '- readiness matrix: {}',
    '- simulation: {}',
    ...
    '- keyboard mode: {}',
    'activation smoke: {}'
) "v10.0.0 activation smoke blockers ordering"

foreach ($smokeReadBlock in @($smokeBlock1000, $smokeStatusBlock1000, $smokeBlockersBlock1000)) {
    Assert-ContainsInOrder $smokeReadBlock @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v10.0.0 activation smoke reader ordering"
}

foreach ($smokeSurface in @($smokeBlock1000, $smokeStatusBlock1000, $smokeBlockersBlock1000, $smokeHelperBlock1000)) {
    foreach ($blockedSmokeCall in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        Assert-NotContains $smokeSurface $blockedSmokeCall "v10.0.0 activation smoke path is read-only: $blockedSmokeCall"
    }
}

$expectedQemuSmokeOutput1000 = "IRQ runtime activation smoke`n    activation smoke: blocked`n    hardware mutation: no`n    runtime irq active: no`n    sti instruction: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    keyboard mode: polling`n    result: smoke blocked`n    next: execute irq-runtime-activation-smoke-blockers"
$expectedQemuSmokeStatusOutput1000 = "IRQ runtime activation smoke status`n    activation token: absent`n    runtime gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    sti plan: blocked`n    activation smoke: blocked`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuSmokeBlockersOutput1000 = "IRQ runtime activation smoke blockers`n    - activation token: absent`n    - runtime gate: activation blocked`n    - readiness matrix: runtime irq ready no`n    - simulation: simulation blocked`n    - STI plan: blocked`n    - EOI runtime boundary: disabled`n    - PIC unmask: disabled`n    - EOI dispatch: disabled`n    - keyboard mode: polling`n    activation smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1000 $expectedQemuSmokeOutput1000 "v10.0.0 qemu docs activation smoke exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1000 $expectedQemuSmokeStatusOutput1000 "v10.0.0 qemu docs activation smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1000 $expectedQemuSmokeBlockersOutput1000 "v10.0.0 qemu docs activation smoke blockers exact rendered contract"

foreach ($sourceSurface in @($irrContent1000, $mainContent1000, $kernelBootSmokeDocs1000)) {
    foreach ($forbiddenPositiveState in @(
        'activation smoke: allowed',
        ...
        Assert-NotContains $sourceSurface $forbiddenPositiveState "v10.0.0 forbids positive activation smoke state: $forbiddenPositiveState"
    }
}
Assert-NotContains $irrContent1000 'asm!("sti")' "v10.0.0 irq source still has no STI"
Assert-NotContains $irrContent1000 'asm!("sti",' "v10.0.0 irq source still has no STI asm args"
Assert-NotContains $mainContent1000 'asm!("sti")' "v10.0.0 kernel main still has no STI"
Assert-NotContains $mainContent1000 'asm!("sti",' "v10.0.0 kernel main still has no STI asm args"
Assert-NotContains $mainContent1000 'global_asm!("sti")' "v10.0.0 kernel main still has no STI global asm"
Assert-NotContains $irrContent1000 'enable_interrupts' "v10.0.0 irq source has no interrupt enable wrapper"
Assert-NotContains $mainContent1000 'enable_interrupts' "v10.0.0 kernel main has no interrupt enable wrapper"
Assert-NotContains $irrContent1000 'interrupts::enable' "v10.0.0 irq source has no CPU interrupt enable path"
Assert-NotContains $mainContent1000 'interrupts::enable' "v10.0.0 kernel main has no CPU interrupt enable path"
foreach ($literal in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1000 "write_pic_port(PIC_MASTER_DATA, $literal)" "v10.0.0 no master unmask literal $literal in main"
    Assert-NotContains $mainContent1000 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v10.0.0 no slave unmask literal $literal in main"
    Assert-NotContains $picContent1000 "write_pic_port(PIC_MASTER_DATA, $literal)" "v10.0.0 no master unmask literal $literal in pic.rs"
    Assert-NotContains $picContent1000 "write_pic_port(PIC_SLAVE_DATA, $literal)" "v10.0.0 no slave unmask literal $literal in pic.rs"
}
Assert-NotContains $mainContent1000 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.0.0 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1000 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.0.0 kernel main does not dispatch slave EOI"
Assert-NotContains $mainContent1000 'timer_interrupt_handler_stub' "v10.0.0 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1000 'keyboard_interrupt_handler_stub' "v10.0.0 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1000 'timer_irq' "v10.0.0 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1000 'keyboard_irq' "v10.0.0 kernel main has no keyboard IRQ activation path"
Assert-Contains $mainContent1000 'polling-only' "v10.0.0 keyboard polling telemetry unchanged"

Write-Host "[OK] v10.0.0 Controlled IRQ Runtime Activation Smoke Foundation verified"

# v10.0.1: Controlled IRQ Runtime Activation Smoke Hardening
Write-Host "Verifying v10.0.1 Controlled IRQ Runtime Activation Smoke Hardening contracts..."
$v1000Tag = & git rev-list -n 1 v10.0.0 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1000Tag) { throw "v10.0.0 tag not found (required baseline)" }

$cargoContent1001 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1001 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1001 = Get-Content $irrRs -Raw
$picContent1001 = Get-Content $picRs -Raw
$mainContent1001 = Get-Content $mainRs -Raw
...
Assert-Contains $cargoContent1001 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1001 'version = "10.0.0"' "kernel-lab stale v10.0.0 package version guard"
Assert-Contains $kernelCargoLockContent1001 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Write-Host "[OK] v10.0.1 version metadata is beyond v10.0.0 locked baseline"

$smokeHelperStart1001 = $irrContent1001.IndexOf('pub fn irq_runtime_activation_smoke(')
$smokeHelperEnd1001 = $irrContent1001.Length
if ($smokeHelperStart1001 -lt 0) { throw "v10.0.1 activation smoke helper isolation failed" }
$smokeHelperBlock1001 = $irrContent1001.Substring($smokeHelperStart1001, $smokeHelperEnd1001 - $smokeHelperStart1001)
$stiHelperStart1001 = $irrContent1001.IndexOf('pub fn sti_controlled_activation_plan(')
$simHelperStart1001 = $irrContent1001.IndexOf('pub fn irq_runtime_activation_simulation(')
$gateHelperStart1001 = $irrContent1001.IndexOf('pub fn irq_runtime_activation_gate(')
if ($stiHelperStart1001 -lt 0 -or $simHelperStart1001 -lt 0 -or $gateHelperStart1001 -lt 0) {
    throw "v10.0.1 activation smoke dependency helper isolation failed"
}
$gateHelperBlock1001 = $irrContent1001.Substring($gateHelperStart1001, $simHelperStart1001 - $gateHelperStart1001)
$simHelperBlock1001 = $irrContent1001.Substring($simHelperStart1001, $stiHelperStart1001 - $simHelperStart1001)
$stiHelperBlock1001 = $irrContent1001.Substring($stiHelperStart1001, $smokeHelperStart1001 - $stiHelperStart1001)

$smokeStart1001 = $mainContent1001.IndexOf('} else if line_str == "irq-runtime-activation-smoke" {')
$smokeStatusStart1001 = $mainContent1001.IndexOf('} else if line_str == "irq-runtime-activation-smoke-status" {')
$smokeBlockersStart1001 = $mainContent1001.IndexOf('} else if line_str == "irq-runtime-activation-smoke-blockers" {')
$smokeBlockersEnd1001 = $mainContent1001.IndexOf('} else if line_str == "eoi-runtime-note" {', $smokeBlockersStart1001)
if ($smokeStart1001 -lt 0 -or $smokeStatusStart1001 -lt $smokeStart1001 -or $smokeBlockersStart1001 -lt $smokeStatusStart1001 -or $smokeBlockersEnd1001 -lt $smokeBlockersStart1001) {
    throw "v10.0.1 activation smoke command block isolation failed"
}
$smokeBlock1001 = $mainContent1001.Substring($smokeStart1001, $smokeStatusStart1001 - $smokeStart1001)
$smokeStatusBlock1001 = $mainContent1001.Substring($smokeStatusStart1001, $smokeBlockersStart1001 - $smokeStatusStart1001)
$smokeBlockersBlock1001 = $mainContent1001.Substring($smokeBlockersStart1001, $smokeBlockersEnd1001 - $smokeBlockersStart1001)

$smokeExact1001 = 'IRQ runtime activation smoke\nactivation smoke: {}\nhardware mutation: {}\nruntime irq active: {}\nsti instruction: {}\npic unmask: {}\neoi dispatch: {}\nkeyboard mode: {}\nresult: {}\nnext: {}\n'
$smokeStatusExact1001 = 'IRQ runtime activation smoke status\nactivation token: {}\nruntime gate: {}\nreadiness matrix: {}\nsimulation: {}\nsti plan: {}\nactivation smoke: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$smokeBlockersExact1001 = 'IRQ runtime activation smoke blockers\n- activation token: {}\n- runtime gate: {}\n- readiness matrix: {}\n- simulation: {}\n- STI plan: {}\n- EOI runtime boundary: {}\n- PIC unmask: {}\n- EOI dispatch: {}\n- keyboard mode: {}\nactivation smoke: {}\n'
Assert-Contains $smokeBlock1001 $smokeExact1001 "v10.0.1 irq-runtime-activation-smoke exact output"
Assert-Contains $smokeStatusBlock1001 $smokeStatusExact1001 "v10.0.1 irq-runtime-activation-smoke-status exact output"
Assert-Contains $smokeBlockersBlock1001 $smokeBlockersExact1001 "v10.0.1 irq-runtime-activation-smoke-blockers exact output"

Assert-ContainsInOrder $smokeBlock1001 @(
    'activation smoke: {}',
    'hardware mutation: {}',
    'runtime irq active: {}',
    'sti instruction: {}',
    ...
    'result: {}',
    'next: {}'
) "v10.0.1 activation smoke exact field ordering"
Assert-ContainsInOrder $smokeStatusBlock1001 @(
    'activation token: {}',
    'runtime gate: {}',
    'readiness matrix: {}',
    'simulation: {}',
    ...
    'hardware mutation: {}',
    'runtime irq active: {}'
) "v10.0.1 activation smoke status field ordering"
Assert-ContainsInOrder $smokeBlockersBlock1001 @(
    '- activation token: {}',
    '- runtime gate: {}',
    '- readiness matrix: {}',
    '- simulation: {}',
    ...
    '- keyboard mode: {}',
    'activation smoke: {}'
) "v10.0.1 activation smoke blockers ordering"

foreach ($smokeReadBlock1001 in @($smokeBlock1001, $smokeStatusBlock1001, $smokeBlockersBlock1001)) {
    Assert-ContainsInOrder $smokeReadBlock1001 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
        ...
        'irq::sti_controlled_activation_plan(',
        'irq::irq_runtime_activation_smoke('
    ) "v10.0.1 activation smoke reader ordering"
}

$expectedQemuSmokeOutput1001 = "IRQ runtime activation smoke`n    activation smoke: blocked`n    hardware mutation: no`n    runtime irq active: no`n    sti instruction: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    keyboard mode: polling`n    result: smoke blocked`n    next: execute irq-runtime-activation-smoke-blockers"
$expectedQemuSmokeStatusOutput1001 = "IRQ runtime activation smoke status`n    activation token: absent`n    runtime gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    sti plan: blocked`n    activation smoke: blocked`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuSmokeBlockersOutput1001 = "IRQ runtime activation smoke blockers`n    - activation token: absent`n    - runtime gate: activation blocked`n    - readiness matrix: runtime irq ready no`n    - simulation: simulation blocked`n    - STI plan: blocked`n    - EOI runtime boundary: disabled`n    - PIC unmask: disabled`n    - EOI dispatch: disabled`n    - keyboard mode: polling`n    activation smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1001 $expectedQemuSmokeOutput1001 "v10.0.1 qemu docs activation smoke exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1001 $expectedQemuSmokeStatusOutput1001 "v10.0.1 qemu docs activation smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1001 $expectedQemuSmokeBlockersOutput1001 "v10.0.1 qemu docs activation smoke blockers exact rendered contract"
Assert-ContainsInOrder $kernelBootSmokeDocs1001 @(
    ...
    "eoi dispatch: disabled",
    "keyboard mode: polling"
) "v10.0.1 qemu docs activation smoke critical line ordering"

foreach ($smokeSurface1001 in @($smokeBlock1001, $smokeStatusBlock1001, $smokeBlockersBlock1001, $smokeHelperBlock1001, $stiHelperBlock1001, $simHelperBlock1001, $gateHelperBlock1001)) {
    foreach ($blockedSmokeCall1001 in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        Assert-NotContains $smokeSurface1001 $blockedSmokeCall1001 "v10.0.1 activation smoke path is read-only: $blockedSmokeCall1001"
    }
}

foreach ($sourceSurface1001 in @($irrContent1001, $mainContent1001, $kernelBootSmokeDocs1001)) {
    foreach ($forbiddenPositiveState1001 in @(
        'activation smoke: allowed',
        'hardware mutation: yes',
        'runtime irq active: yes',
        'sti instruction: enabled',
        'sti allowed: yes',
        'pic unmask: enabled',
        'pic unmask: yes',
        'eoi dispatch: enabled',
        ...
        Assert-NotContains $sourceSurface1001 $forbiddenPositiveState1001 "v10.0.1 forbids positive activation smoke state: $forbiddenPositiveState1001"
    }
}
Assert-NotContains $irrContent1001 'asm!("sti")' "v10.0.1 irq source still has no STI"
Assert-NotContains $irrContent1001 'asm!("sti",' "v10.0.1 irq source still has no STI asm args"
Assert-NotContains $mainContent1001 'asm!("sti")' "v10.0.1 kernel main still has no STI"
Assert-NotContains $mainContent1001 'asm!("sti",' "v10.0.1 kernel main still has no STI asm args"
Assert-NotContains $mainContent1001 'global_asm!("sti")' "v10.0.1 kernel main still has no STI global asm"
Assert-NotContains $irrContent1001 'enable_interrupts' "v10.0.1 irq source has no interrupt enable wrapper"
Assert-NotContains $mainContent1001 'enable_interrupts' "v10.0.1 kernel main has no interrupt enable wrapper"
Assert-NotContains $irrContent1001 'interrupts::enable' "v10.0.1 irq source has no CPU interrupt enable path"
Assert-NotContains $mainContent1001 'interrupts::enable' "v10.0.1 kernel main has no CPU interrupt enable path"
foreach ($literal1001 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1001 "write_pic_port(PIC_MASTER_DATA, $literal1001)" "v10.0.1 no master unmask literal $literal1001 in main"
    Assert-NotContains $mainContent1001 "write_pic_port(PIC_SLAVE_DATA, $literal1001)" "v10.0.1 no slave unmask literal $literal1001 in main"
    Assert-NotContains $picContent1001 "write_pic_port(PIC_MASTER_DATA, $literal1001)" "v10.0.1 no master unmask literal $literal1001 in pic.rs"
    Assert-NotContains $picContent1001 "write_pic_port(PIC_SLAVE_DATA, $literal1001)" "v10.0.1 no slave unmask literal $literal1001 in pic.rs"
}
Assert-NotContains $mainContent1001 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.0.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1001 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.0.1 kernel main does not dispatch slave EOI"
Assert-NotContains $mainContent1001 'timer_interrupt_handler_stub' "v10.0.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1001 'keyboard_interrupt_handler_stub' "v10.0.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1001 'timer_irq' "v10.0.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1001 'keyboard_irq' "v10.0.1 kernel main has no keyboard IRQ activation path"
Assert-Contains $mainContent1001 'polling-only' "v10.0.1 keyboard polling telemetry unchanged"
Assert-Contains $mainContent1001 'keyboard mode: {}' "v10.0.1 activation smoke renders keyboard mode"
Assert-Contains $irrContent1001 'keyboard_mode: matrix.keyboard_mode' "v10.0.1 activation smoke keeps keyboard mode from readiness matrix"

Write-Host "[OK] v10.0.1 Controlled IRQ Runtime Activation Smoke Hardening verified"

# v10.1.0: Controlled Runtime EOI Dispatch Smoke Foundation
Write-Host "Verifying v10.1.0 Controlled Runtime EOI Dispatch Smoke Foundation contracts..."
$v1001Tag = & git rev-list -n 1 v10.0.1 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1001Tag) { throw "v10.0.1 tag not found (required baseline)" }
if ($HEAD -eq $v1001Tag) { throw "HEAD is still v10.0.1 baseline, v10.1.0 work not completed" }

$cargoContent1010 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1010 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1010 = Get-Content $irrRs -Raw
$picContent1010 = Get-Content $picRs -Raw
$mainContent1010 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1010 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1010 = $kernelBootSmokeDocs1010 -replace "`r`n", "`n"
$kernelIrqDocs1010 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1010 = $kernelIrqDocs1010 -replace "`r`n", "`n"

Assert-Contains $cargoContent1010 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1010 'version = "10.0.1"' "kernel-lab stale v10.0.1 package version guard"
Assert-Contains $kernelCargoLockContent1010 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1010 'line_str == "eoi-dispatch-smoke-status"' "v10.1.0 eoi dispatch smoke status dispatcher"
Assert-Contains $mainContent1010 'line_str == "eoi-dispatch-smoke-plan"' "v10.1.0 eoi dispatch smoke plan dispatcher"
Assert-Contains $mainContent1010 'line_str == "eoi-dispatch-smoke-blockers"' "v10.1.0 eoi dispatch smoke blockers dispatcher"
Assert-Contains $irrContent1010 "pub struct EoiDispatchSmoke" "v10.1.0 eoi dispatch smoke telemetry struct"
Assert-Contains $irrContent1010 "pub fn eoi_dispatch_smoke(" "v10.1.0 eoi dispatch smoke helper"

$eoiSmokeHelperStart1010 = $irrContent1010.IndexOf('pub fn eoi_dispatch_smoke(')
if ($eoiSmokeHelperStart1010 -lt 0) { throw "v10.1.0 eoi dispatch smoke helper isolation failed" }
$eoiSmokeHelperBlock1010 = $irrContent1010.Substring($eoiSmokeHelperStart1010)
$eoiSmokeNoteStart1010 = $mainContent1010.IndexOf('} else if line_str == "eoi-dispatch-smoke-note" {')
$eoiSmokeStatusStart1010 = $mainContent1010.IndexOf('} else if line_str == "eoi-dispatch-smoke-status" {')
$eoiSmokePlanStart1010 = $mainContent1010.IndexOf('} else if line_str == "eoi-dispatch-smoke-plan" {')
$eoiSmokeBlockersStart1010 = $mainContent1010.IndexOf('} else if line_str == "eoi-dispatch-smoke-blockers" {')
$eoiSmokeEnd1010 = $mainContent1010.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiSmokeBlockersStart1010)
if ($eoiSmokeNoteStart1010 -lt 0 -or $eoiSmokeStatusStart1010 -lt $eoiSmokeNoteStart1010 -or $eoiSmokePlanStart1010 -lt $eoiSmokeStatusStart1010 -or $eoiSmokeBlockersStart1010 -lt $eoiSmokePlanStart1010 -or $eoiSmokeEnd1010 -lt $eoiSmokeBlockersStart1010) {
    throw "v10.1.0 eoi dispatch smoke command block isolation failed"
}
$eoiSmokeNoteBlock1010 = $mainContent1010.Substring($eoiSmokeNoteStart1010, $eoiSmokeStatusStart1010 - $eoiSmokeNoteStart1010)
$eoiSmokeStatusBlock1010 = $mainContent1010.Substring($eoiSmokeStatusStart1010, $eoiSmokePlanStart1010 - $eoiSmokeStatusStart1010)
$eoiSmokePlanBlock1010 = $mainContent1010.Substring($eoiSmokePlanStart1010, $eoiSmokeBlockersStart1010 - $eoiSmokePlanStart1010)
$eoiSmokeBlockersBlock1010 = $mainContent1010.Substring($eoiSmokeBlockersStart1010, $eoiSmokeEnd1010 - $eoiSmokeBlockersStart1010)

$eoiSmokeNoteExact1010 = 'EOI dispatch smoke note\nscope: controlled dry-run foundation\nack target: planned PIC EOI routing only\nmaster EOI: {}\nslave EOI: {}\nhardware mutation: {}\nsti: {}\npic unmask: {}\nruntime irq active: {}\n'
$eoiSmokeStatusExact1010 = 'EOI dispatch smoke status\neoi dispatch smoke: {}\ndispatch mode: {}\npic remap smoke: {}\nirq gates: {}\npic eoi writes: {}\nsti instruction: {}\npic unmask: {}\nkeyboard mode: {}\nruntime irq active: {}\n'
$eoiSmokePlanExact1010 = 'EOI dispatch smoke plan\n1. require PIC remap controlled smoke prerequisite\n2. require IRQ gate bind smoke prerequisite\n3. model IRQ0 master EOI route only\n4. model IRQ1 master EOI route only\n5. keep PIC_EOI writes disabled\n6. keep runtime IRQ inactive\nresult: {}\n'
$eoiSmokeBlockersExact1010 = 'EOI dispatch smoke blockers\n- {}\n- {}\n- PIC_EOI writes: disabled by guard\n- {}\n- {}\n- {}\n- {}\neoi dispatch smoke: {}\n'
Assert-Contains $eoiSmokeNoteBlock1010 $eoiSmokeNoteExact1010 "v10.1.0 eoi-dispatch-smoke-note exact output"
Assert-Contains $eoiSmokeStatusBlock1010 $eoiSmokeStatusExact1010 "v10.1.0 eoi-dispatch-smoke-status exact output"
Assert-Contains $eoiSmokePlanBlock1010 $eoiSmokePlanExact1010 "v10.1.0 eoi-dispatch-smoke-plan exact output"
Assert-Contains $eoiSmokeBlockersBlock1010 $eoiSmokeBlockersExact1010 "v10.1.0 eoi-dispatch-smoke-blockers exact output"

foreach ($eoiSmokeReadBlock1010 in @($eoiSmokeNoteBlock1010, $eoiSmokeStatusBlock1010, $eoiSmokePlanBlock1010, $eoiSmokeBlockersBlock1010)) {
    Assert-ContainsInOrder $eoiSmokeReadBlock1010 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v10.1.0 eoi dispatch smoke reader ordering"
}

$expectedQemuEoiSmokeNote1010 = "EOI dispatch smoke note`n    scope: controlled dry-run foundation`n    ack target: planned PIC EOI routing only`n    master EOI: command 0x20 -> port 0x20 (planned)`n    slave EOI: command 0x20 -> port 0xA0 then 0x20 (planned)`n    hardware mutation: no`n    sti: disabled`n    pic unmask: disabled`n    runtime irq active: no"
$expectedQemuEoiSmokeStatus1010 = "EOI dispatch smoke status`n    eoi dispatch smoke: blocked`n    dispatch mode: dry-run`n    pic remap smoke: not ready`n    irq gates: not bound`n    pic eoi writes: disabled`n    sti instruction: disabled`n    pic unmask: disabled`n    keyboard mode: polling`n    runtime irq active: no"
$expectedQemuEoiSmokePlan1010 = "EOI dispatch smoke plan`n    1. require PIC remap controlled smoke prerequisite`n    2. require IRQ gate bind smoke prerequisite`n    3. model IRQ0 master EOI route only`n    4. model IRQ1 master EOI route only`n    5. keep PIC_EOI writes disabled`n    6. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuEoiSmokeBlockers1010 = "EOI dispatch smoke blockers`n    - PIC remap smoke: not ready for controlled smoke`n    - IRQ gates: vectors 32/33 not bound`n    - PIC_EOI writes: disabled by guard`n    - STI: disabled`n    - PIC unmask: disabled`n    - live IRQ0/IRQ1: disabled`n    - keyboard IRQ path: disabled`n    eoi dispatch smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1010 $expectedQemuEoiSmokeNote1010 "v10.1.0 qemu docs eoi dispatch smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1010 $expectedQemuEoiSmokeStatus1010 "v10.1.0 qemu docs eoi dispatch smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1010 $expectedQemuEoiSmokePlan1010 "v10.1.0 qemu docs eoi dispatch smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1010 $expectedQemuEoiSmokeBlockers1010 "v10.1.0 qemu docs eoi dispatch smoke blockers exact rendered contract"
Assert-Contains $kernelIrqDocs1010 "## Controlled Runtime EOI Dispatch Smoke Foundation" "v10.1.0 irq docs eoi dispatch smoke section"
Assert-Contains $kernelIrqDocs1010 "eoi-dispatch-smoke-status" "v10.1.0 irq docs eoi dispatch smoke status command"
Assert-Contains $kernelIrqDocs1010 "pic eoi writes: disabled" "v10.1.0 irq docs pic eoi writes disabled"

foreach ($eoiSmokeSurface1010 in @($eoiSmokeNoteBlock1010, $eoiSmokeStatusBlock1010, $eoiSmokePlanBlock1010, $eoiSmokeBlockersBlock1010, $eoiSmokeHelperBlock1010)) {
    foreach ($blockedEoiSmokeCall1010 in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        Assert-NotContains $eoiSmokeSurface1010 $blockedEoiSmokeCall1010 "v10.1.0 eoi dispatch smoke path is read-only: $blockedEoiSmokeCall1010"
    }
}

Assert-NotContains $irrContent1010 'asm!("sti")' "v10.1.0 irq source still has no STI"
Assert-NotContains $irrContent1010 'asm!("sti",' "v10.1.0 irq source still has no STI asm args"
Assert-NotContains $mainContent1010 'asm!("sti")' "v10.1.0 kernel main still has no STI"
Assert-NotContains $mainContent1010 'asm!("sti",' "v10.1.0 kernel main still has no STI asm args"
Assert-NotContains $mainContent1010 'global_asm!("sti")' "v10.1.0 kernel main still has no STI global asm"
Assert-NotContains $irrContent1010 'enable_interrupts' "v10.1.0 irq source has no interrupt enable wrapper"
Assert-NotContains $mainContent1010 'enable_interrupts' "v10.1.0 kernel main has no interrupt enable wrapper"
Assert-NotContains $irrContent1010 'interrupts::enable' "v10.1.0 irq source has no CPU interrupt enable path"
Assert-NotContains $mainContent1010 'interrupts::enable' "v10.1.0 kernel main has no CPU interrupt enable path"
foreach ($literal1010 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1010 "write_pic_port(PIC_MASTER_DATA, $literal1010)" "v10.1.0 no master unmask literal $literal1010 in main"
    Assert-NotContains $mainContent1010 "write_pic_port(PIC_SLAVE_DATA, $literal1010)" "v10.1.0 no slave unmask literal $literal1010 in main"
    Assert-NotContains $picContent1010 "write_pic_port(PIC_MASTER_DATA, $literal1010)" "v10.1.0 no master unmask literal $literal1010 in pic.rs"
    Assert-NotContains $picContent1010 "write_pic_port(PIC_SLAVE_DATA, $literal1010)" "v10.1.0 no slave unmask literal $literal1010 in pic.rs"
}
Assert-NotContains $mainContent1010 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.1.0 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1010 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.1.0 kernel main does not dispatch slave EOI"
Assert-NotContains $picContent1010 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.1.0 pic source does not dispatch master EOI"
Assert-NotContains $picContent1010 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.1.0 pic source does not dispatch slave EOI"
Assert-NotContains $mainContent1010 'timer_interrupt_handler_stub' "v10.1.0 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1010 'keyboard_interrupt_handler_stub' "v10.1.0 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1010 'timer_irq' "v10.1.0 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1010 'keyboard_irq' "v10.1.0 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1010 'keyboard mode: {}' "v10.1.0 eoi dispatch smoke renders keyboard mode"
Assert-Contains $irrContent1010 'runtime_irq_active: matrix.runtime_irq_active' "v10.1.0 eoi dispatch smoke keeps runtime irq inactive from readiness matrix"

Write-Host "[OK] v10.1.0 Controlled Runtime EOI Dispatch Smoke Foundation verified"

# v10.1.1: Controlled Runtime EOI Dispatch Smoke Hardening
Write-Host "Verifying v10.1.1 Controlled Runtime EOI Dispatch Smoke Hardening contracts..."
$v1010Tag = & git rev-list -n 1 v10.1.0 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1010Tag) { throw "v10.1.0 tag not found (required baseline)" }

$cargoContent1011 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1011 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1011 = Get-Content $irrRs -Raw
$picContent1011 = Get-Content $picRs -Raw
$mainContent1011 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1011 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1011 = $kernelBootSmokeDocs1011 -replace "`r`n", "`n"
$kernelIrqDocs1011 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1011 = $kernelIrqDocs1011 -replace "`r`n", "`n"

Assert-Contains $cargoContent1011 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1011 'version = "10.1.0"' "kernel-lab stale v10.1.0 package version guard"
Assert-Contains $kernelCargoLockContent1011 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1011 'eoi-dispatch-smoke-note eoi-dispatch-smoke-status eoi-dispatch-smoke-plan eoi-dispatch-smoke-blockers' "help string includes v10.1.1 eoi dispatch smoke commands"
Assert-Contains $mainContent1011 'line_str == "eoi-dispatch-smoke-note"' "v10.1.1 eoi dispatch smoke note dispatcher"
Assert-Contains $mainContent1011 'line_str == "eoi-dispatch-smoke-status"' "v10.1.1 eoi dispatch smoke status dispatcher"
Assert-Contains $mainContent1011 'line_str == "eoi-dispatch-smoke-plan"' "v10.1.1 eoi dispatch smoke plan dispatcher"
Assert-Contains $mainContent1011 'line_str == "eoi-dispatch-smoke-blockers"' "v10.1.1 eoi dispatch smoke blockers dispatcher"
Assert-Contains $irrContent1011 "pub struct EoiDispatchSmoke" "v10.1.1 eoi dispatch smoke telemetry struct"
Assert-Contains $irrContent1011 "pub fn eoi_dispatch_smoke(" "v10.1.1 eoi dispatch smoke helper"

$eoiSmokeHelperStart1011 = $irrContent1011.IndexOf('pub fn eoi_dispatch_smoke(')
if ($eoiSmokeHelperStart1011 -lt 0) { throw "v10.1.1 eoi dispatch smoke helper isolation failed" }
$eoiSmokeHelperEnd1011 = $irrContent1011.IndexOf('pub fn irq_runtime_activation_smoke_blockers(', $eoiSmokeHelperStart1011)
if ($eoiSmokeHelperEnd1011 -lt 0) { $eoiSmokeHelperEnd1011 = $irrContent1011.Length }
$eoiSmokeHelperBlock1011 = $irrContent1011.Substring($eoiSmokeHelperStart1011, $eoiSmokeHelperEnd1011 - $eoiSmokeHelperStart1011)
$eoiSmokeNoteStart1011 = $mainContent1011.IndexOf('} else if line_str == "eoi-dispatch-smoke-note" {')
$eoiSmokeStatusStart1011 = $mainContent1011.IndexOf('} else if line_str == "eoi-dispatch-smoke-status" {')
$eoiSmokePlanStart1011 = $mainContent1011.IndexOf('} else if line_str == "eoi-dispatch-smoke-plan" {')
$eoiSmokeBlockersStart1011 = $mainContent1011.IndexOf('} else if line_str == "eoi-dispatch-smoke-blockers" {')
$eoiSmokeEnd1011 = $mainContent1011.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiSmokeBlockersStart1011)
if ($eoiSmokeNoteStart1011 -lt 0 -or $eoiSmokeStatusStart1011 -lt $eoiSmokeNoteStart1011 -or $eoiSmokePlanStart1011 -lt $eoiSmokeStatusStart1011 -or $eoiSmokeBlockersStart1011 -lt $eoiSmokePlanStart1011 -or $eoiSmokeEnd1011 -lt $eoiSmokeBlockersStart1011) {
    throw "v10.1.1 eoi dispatch smoke command block isolation failed"
}
$eoiSmokeNoteBlock1011 = $mainContent1011.Substring($eoiSmokeNoteStart1011, $eoiSmokeStatusStart1011 - $eoiSmokeNoteStart1011)
$eoiSmokeStatusBlock1011 = $mainContent1011.Substring($eoiSmokeStatusStart1011, $eoiSmokePlanStart1011 - $eoiSmokeStatusStart1011)
$eoiSmokePlanBlock1011 = $mainContent1011.Substring($eoiSmokePlanStart1011, $eoiSmokeBlockersStart1011 - $eoiSmokePlanStart1011)
$eoiSmokeBlockersBlock1011 = $mainContent1011.Substring($eoiSmokeBlockersStart1011, $eoiSmokeEnd1011 - $eoiSmokeBlockersStart1011)

$eoiSmokeNoteExact1011 = 'EOI dispatch smoke note\nscope: controlled dry-run foundation\nack target: planned PIC EOI routing only\nmaster EOI: {}\nslave EOI: {}\nhardware mutation: {}\nsti: {}\npic unmask: {}\nruntime irq active: {}\n'
$eoiSmokeStatusExact1011 = 'EOI dispatch smoke status\neoi dispatch smoke: {}\ndispatch mode: {}\npic remap smoke: {}\nirq gates: {}\npic eoi writes: {}\nsti instruction: {}\npic unmask: {}\nkeyboard mode: {}\nruntime irq active: {}\n'
$eoiSmokePlanExact1011 = 'EOI dispatch smoke plan\n1. require PIC remap controlled smoke prerequisite\n2. require IRQ gate bind smoke prerequisite\n3. model IRQ0 master EOI route only\n4. model IRQ1 master EOI route only\n5. keep PIC_EOI writes disabled\n6. keep runtime IRQ inactive\nresult: {}\n'
$eoiSmokeBlockersExact1011 = 'EOI dispatch smoke blockers\n- {}\n- {}\n- PIC_EOI writes: disabled by guard\n- {}\n- {}\n- {}\n- {}\neoi dispatch smoke: {}\n'
Assert-Contains $eoiSmokeNoteBlock1011 $eoiSmokeNoteExact1011 "v10.1.1 eoi-dispatch-smoke-note exact output"
Assert-Contains $eoiSmokeStatusBlock1011 $eoiSmokeStatusExact1011 "v10.1.1 eoi-dispatch-smoke-status exact output"
Assert-Contains $eoiSmokePlanBlock1011 $eoiSmokePlanExact1011 "v10.1.1 eoi-dispatch-smoke-plan exact output"
Assert-Contains $eoiSmokeBlockersBlock1011 $eoiSmokeBlockersExact1011 "v10.1.1 eoi-dispatch-smoke-blockers exact output"

foreach ($eoiSmokeReadBlock1011 in @($eoiSmokeNoteBlock1011, $eoiSmokeStatusBlock1011, $eoiSmokePlanBlock1011, $eoiSmokeBlockersBlock1011)) {
    Assert-ContainsInOrder $eoiSmokeReadBlock1011 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
        ...
        'irq::irq_runtime_activation_smoke(',
        'irq::eoi_dispatch_smoke('
    ) "v10.1.1 eoi dispatch smoke reader ordering"
}

$expectedQemuEoiSmokeNote1011 = "EOI dispatch smoke note`n    scope: controlled dry-run foundation`n    ack target: planned PIC EOI routing only`n    master EOI: command 0x20 -> port 0x20 (planned)`n    slave EOI: command 0x20 -> port 0xA0 then 0x20 (planned)`n    hardware mutation: no`n    sti: disabled`n    pic unmask: disabled`n    runtime irq active: no"
$expectedQemuEoiSmokeStatus1011 = "EOI dispatch smoke status`n    eoi dispatch smoke: blocked`n    dispatch mode: dry-run`n    pic remap smoke: not ready`n    irq gates: not bound`n    pic eoi writes: disabled`n    sti instruction: disabled`n    pic unmask: disabled`n    keyboard mode: polling`n    runtime irq active: no"
$expectedQemuEoiSmokePlan1011 = "EOI dispatch smoke plan`n    1. require PIC remap controlled smoke prerequisite`n    2. require IRQ gate bind smoke prerequisite`n    3. model IRQ0 master EOI route only`n    4. model IRQ1 master EOI route only`n    5. keep PIC_EOI writes disabled`n    6. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuEoiSmokeBlockers1011 = "EOI dispatch smoke blockers`n    - PIC remap smoke: not ready for controlled smoke`n    - IRQ gates: vectors 32/33 not bound`n    - PIC_EOI writes: disabled by guard`n    - STI: disabled`n    - PIC unmask: disabled`n    - live IRQ0/IRQ1: disabled`n    - keyboard IRQ path: disabled`n    eoi dispatch smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1011 $expectedQemuEoiSmokeNote1011 "v10.1.1 qemu docs eoi dispatch smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1011 $expectedQemuEoiSmokeStatus1011 "v10.1.1 qemu docs eoi dispatch smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1011 $expectedQemuEoiSmokePlan1011 "v10.1.1 qemu docs eoi dispatch smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1011 $expectedQemuEoiSmokeBlockers1011 "v10.1.1 qemu docs eoi dispatch smoke blockers exact rendered contract"
Assert-Contains $kernelIrqDocs1011 "## Controlled Runtime EOI Dispatch Smoke Hardening" "v10.1.1 irq docs eoi dispatch smoke hardening section"
Assert-Contains $kernelIrqDocs1011 "No output wording changes from v10.1.0 are introduced." "v10.1.1 irq docs no behavior change"
Assert-Contains $kernelBootSmokeDocs1011 "v10.1.1 hardens the EOI dispatch smoke verification surface without changing these rendered outputs." "v10.1.1 qemu docs hardening note"

foreach ($eoiSmokeSurface1011 in @($eoiSmokeNoteBlock1011, $eoiSmokeStatusBlock1011, $eoiSmokePlanBlock1011, $eoiSmokeBlockersBlock1011, $eoiSmokeHelperBlock1011)) {
    foreach ($blockedEoiSmokeCall1011 in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        Assert-NotContains $eoiSmokeSurface1011 $blockedEoiSmokeCall1011 "v10.1.1 eoi dispatch smoke path is read-only: $blockedEoiSmokeCall1011"
    }
}
...
Assert-NotContains $mainContent1011 'asm!("sti",' "v10.1.1 kernel main still has no STI asm args"
Assert-NotContains $mainContent1011 'global_asm!("sti")' "v10.1.1 kernel main still has no STI global asm"
Assert-NotContains $irrContent1011 'enable_interrupts' "v10.1.1 irq source has no interrupt enable wrapper"
Assert-NotContains $mainContent1011 'enable_interrupts' "v10.1.1 kernel main has no interrupt enable wrapper"
Assert-NotContains $irrContent1011 'interrupts::enable' "v10.1.1 irq source has no CPU interrupt enable path"
Assert-NotContains $mainContent1011 'interrupts::enable' "v10.1.1 kernel main has no CPU interrupt enable path"
foreach ($literal1011 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1011 "write_pic_port(PIC_MASTER_DATA, $literal1011)" "v10.1.1 no master unmask literal $literal1011 in main"
    Assert-NotContains $mainContent1011 "write_pic_port(PIC_SLAVE_DATA, $literal1011)" "v10.1.1 no slave unmask literal $literal1011 in main"
    Assert-NotContains $picContent1011 "write_pic_port(PIC_MASTER_DATA, $literal1011)" "v10.1.1 no master unmask literal $literal1011 in pic.rs"
    Assert-NotContains $picContent1011 "write_pic_port(PIC_SLAVE_DATA, $literal1011)" "v10.1.1 no slave unmask literal $literal1011 in pic.rs"
}
Assert-NotContains $mainContent1011 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.1.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1011 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.1.1 kernel main does not dispatch slave EOI"
Assert-NotContains $picContent1011 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.1.1 pic source does not dispatch master EOI"
Assert-NotContains $picContent1011 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.1.1 pic source does not dispatch slave EOI"
Assert-NotContains $mainContent1011 'timer_interrupt_handler_stub' "v10.1.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1011 'keyboard_interrupt_handler_stub' "v10.1.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1011 'timer_irq' "v10.1.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1011 'keyboard_irq' "v10.1.1 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1011 'keyboard mode: {}' "v10.1.1 eoi dispatch smoke renders keyboard mode"
Assert-Contains $mainContent1011 'polling-only' "v10.1.1 keyboard polling telemetry unchanged"
Assert-Contains $mainContent1011 'let status = serial::inb(0x64);' "v10.1.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1011 'let scancode = serial::inb(0x60);' "v10.1.1 keyboard scancode polling remains PS/2 read"
Assert-Contains $irrContent1011 'runtime_irq_active: matrix.runtime_irq_active' "v10.1.1 eoi dispatch smoke keeps runtime irq inactive from readiness matrix"

foreach ($forbiddenPositive1011 in @(
    'eoi dispatch smoke: allowed',
    'eoi dispatch smoke: active',
    'eoi dispatch smoke: enabled',
    'runtime eoi dispatch: active',
    'runtime eoi dispatch: enabled',
    'pic eoi writes: enabled',
    'runtime irq active: yes',
    'sti: enabled',
    'sti instruction: enabled',
    'pic unmask: enabled',
    ...
    Assert-NotContains $mainContent1011 $forbiddenPositive1011 "v10.1.1 forbidden positive runtime state in main: $forbiddenPositive1011"
    Assert-NotContains $irrContent1011 $forbiddenPositive1011 "v10.1.1 forbidden positive runtime state in irq source: $forbiddenPositive1011"
    Assert-NotContains $kernelIrqDocs1011 $forbiddenPositive1011 "v10.1.1 forbidden positive runtime state in irq docs: $forbiddenPositive1011"
    Assert-NotContains $kernelBootSmokeDocs1011 $forbiddenPositive1011 "v10.1.1 forbidden positive runtime state in qemu docs: $forbiddenPositive1011"
}

Write-Host "[OK] v10.1.1 Controlled Runtime EOI Dispatch Smoke Hardening verified"

# v10.2.0: Controlled PIC Mask Unmask Smoke Foundation
Write-Host "Verifying v10.2.0 Controlled PIC Mask Unmask Smoke Foundation contracts..."
$v1011Tag = & git rev-list -n 1 v10.1.1 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1011Tag) { throw "v10.1.1 tag not found (required baseline)" }

$cargoContent1020 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1020 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1020 = Get-Content $irrRs -Raw
$picContent1020 = Get-Content $picRs -Raw
$mainContent1020 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1020 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1020 = $kernelBootSmokeDocs1020 -replace "`r`n", "`n"
$kernelIrqDocs1020 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1020 = $kernelIrqDocs1020 -replace "`r`n", "`n"

Assert-Contains $cargoContent1020 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1020 'version = "10.1.1"' "kernel-lab stale v10.1.1 package version guard"
Assert-Contains $kernelCargoLockContent1020 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1020 'pic-unmask-smoke-note pic-unmask-smoke-status pic-unmask-smoke-plan pic-unmask-smoke-blockers' "help string includes v10.2.0 pic unmask smoke commands"
Assert-Contains $mainContent1020 'line_str == "pic-unmask-smoke-note"' "v10.2.0 pic unmask smoke note dispatcher"
Assert-Contains $mainContent1020 'line_str == "pic-unmask-smoke-status"' "v10.2.0 pic unmask smoke status dispatcher"
Assert-Contains $mainContent1020 'line_str == "pic-unmask-smoke-plan"' "v10.2.0 pic unmask smoke plan dispatcher"
Assert-Contains $mainContent1020 'line_str == "pic-unmask-smoke-blockers"' "v10.2.0 pic unmask smoke blockers dispatcher"
Assert-Contains $irrContent1020 "pub struct PicUnmaskSmoke" "v10.2.0 pic unmask smoke telemetry struct"
Assert-Contains $irrContent1020 "pub fn pic_unmask_smoke(" "v10.2.0 pic unmask smoke helper"

$picUnmaskSmokeHelperStart1020 = $irrContent1020.IndexOf('pub fn pic_unmask_smoke(')
if ($picUnmaskSmokeHelperStart1020 -lt 0) { throw "v10.2.0 pic unmask smoke helper isolation failed" }
$picUnmaskSmokeHelperBlock1020 = $irrContent1020.Substring($picUnmaskSmokeHelperStart1020)
$picUnmaskSmokeNoteStart1020 = $mainContent1020.IndexOf('} else if line_str == "pic-unmask-smoke-note" {')
$picUnmaskSmokeStatusStart1020 = $mainContent1020.IndexOf('} else if line_str == "pic-unmask-smoke-status" {')
$picUnmaskSmokePlanStart1020 = $mainContent1020.IndexOf('} else if line_str == "pic-unmask-smoke-plan" {')
$picUnmaskSmokeBlockersStart1020 = $mainContent1020.IndexOf('} else if line_str == "pic-unmask-smoke-blockers" {')
$picUnmaskSmokeEnd1020 = $mainContent1020.IndexOf('} else if line_str == "eoi-runtime-note" {', $picUnmaskSmokeBlockersStart1020)
if ($picUnmaskSmokeNoteStart1020 -lt 0 -or $picUnmaskSmokeStatusStart1020 -lt $picUnmaskSmokeNoteStart1020 -or $picUnmaskSmokePlanStart1020 -lt $picUnmaskSmokeStatusStart1020 -or $picUnmaskSmokeBlockersStart1020 -lt $picUnmaskSmokePlanStart1020 -or $picUnmaskSmokeEnd1020 -lt $picUnmaskSmokeBlockersStart1020) {
    throw "v10.2.0 pic unmask smoke command block isolation failed"
}
$picUnmaskSmokeNoteBlock1020 = $mainContent1020.Substring($picUnmaskSmokeNoteStart1020, $picUnmaskSmokeStatusStart1020 - $picUnmaskSmokeNoteStart1020)
$picUnmaskSmokeStatusBlock1020 = $mainContent1020.Substring($picUnmaskSmokeStatusStart1020, $picUnmaskSmokePlanStart1020 - $picUnmaskSmokeStatusStart1020)
$picUnmaskSmokePlanBlock1020 = $mainContent1020.Substring($picUnmaskSmokePlanStart1020, $picUnmaskSmokeBlockersStart1020 - $picUnmaskSmokePlanStart1020)
$picUnmaskSmokeBlockersBlock1020 = $mainContent1020.Substring($picUnmaskSmokeBlockersStart1020, $picUnmaskSmokeEnd1020 - $picUnmaskSmokeBlockersStart1020)

$picUnmaskSmokeNoteExact1020 = 'PIC unmask smoke note\nscope: controlled dry-run foundation\ntarget IRQ lines: {}\nmask policy: {}\nunmask policy: {}\nlive unmask: {}\nhardware mutation: {}\nsti: {}\nruntime irq active: {}\n'
$picUnmaskSmokeStatusExact1020 = 'PIC unmask smoke status\npic unmask smoke: {}\ndispatch mode: {}\ntarget IRQ lines: {}\npic mask policy: {}\nactivation token: {}\nactivation gate: {}\nEOI boundary: {}\nSTI plan: {}\nEOI dispatch smoke: {}\nlive unmask: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$picUnmaskSmokePlanExact1020 = 'PIC unmask smoke plan\n1. require PIC mask plan prerequisite\n2. require readiness matrix prerequisite\n3. require activation token and gate prerequisite\n4. require EOI boundary and dispatch smoke prerequisite\n5. keep target IRQ lines: {}\n6. keep PIC data-port writes disabled\n7. keep runtime IRQ inactive\nresult: {}\n'
$picUnmaskSmokeBlockersExact1020 = 'PIC unmask smoke blockers\n- activation token: {}\n- activation gate: {}\n- EOI runtime boundary: {}\n- STI: {}\n- live unmask: {}\n- runtime IRQ active: {}\n- {}\npic unmask smoke: {}\n'
Assert-Contains $picUnmaskSmokeNoteBlock1020 $picUnmaskSmokeNoteExact1020 "v10.2.0 pic-unmask-smoke-note exact output"
Assert-Contains $picUnmaskSmokeStatusBlock1020 $picUnmaskSmokeStatusExact1020 "v10.2.0 pic-unmask-smoke-status exact output"
Assert-Contains $picUnmaskSmokePlanBlock1020 $picUnmaskSmokePlanExact1020 "v10.2.0 pic-unmask-smoke-plan exact output"
Assert-Contains $picUnmaskSmokeBlockersBlock1020 $picUnmaskSmokeBlockersExact1020 "v10.2.0 pic-unmask-smoke-blockers exact output"

foreach ($picUnmaskSmokeReadBlock1020 in @($picUnmaskSmokeNoteBlock1020, $picUnmaskSmokeStatusBlock1020, $picUnmaskSmokePlanBlock1020, $picUnmaskSmokeBlockersBlock1020)) {
    Assert-ContainsInOrder $picUnmaskSmokeReadBlock1020 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v10.2.0 pic unmask smoke reader ordering"
}

$expectedQemuPicUnmaskSmokeNote1020 = "PIC unmask smoke note`n    scope: controlled dry-run foundation`n    target IRQ lines: none`n    mask policy: all masked (0xFF)`n    unmask policy: no lines scheduled for unmask`n    live unmask: no`n    hardware mutation: no`n    sti: disabled`n    runtime irq active: no"
$expectedQemuPicUnmaskSmokeStatus1020 = "PIC unmask smoke status`n    pic unmask smoke: blocked`n    dispatch mode: dry-run`n    target IRQ lines: none`n    pic mask policy: all masked (0xFF)`n    activation token: absent`n    activation gate: activation blocked`n    EOI boundary: disabled`n    STI plan: blocked`n    EOI dispatch smoke: blocked`n    live unmask: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuPicUnmaskSmokePlan1020 = "PIC unmask smoke plan`n    1. require PIC mask plan prerequisite`n    2. require readiness matrix prerequisite`n    3. require activation token and gate prerequisite`n    4. require EOI boundary and dispatch smoke prerequisite`n    5. keep target IRQ lines: none`n    6. keep PIC data-port writes disabled`n    7. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuPicUnmaskSmokeBlockers1020 = "PIC unmask smoke blockers`n    - activation token: absent`n    - activation gate: activation blocked`n    - EOI runtime boundary: disabled`n    - STI: disabled`n    - live unmask: no`n    - runtime IRQ active: no`n    - keyboard IRQ path: disabled`n    pic unmask smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1020 $expectedQemuPicUnmaskSmokeNote1020 "v10.2.0 qemu docs pic unmask smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1020 $expectedQemuPicUnmaskSmokeStatus1020 "v10.2.0 qemu docs pic unmask smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1020 $expectedQemuPicUnmaskSmokePlan1020 "v10.2.0 qemu docs pic unmask smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1020 $expectedQemuPicUnmaskSmokeBlockers1020 "v10.2.0 qemu docs pic unmask smoke blockers exact rendered contract"
Assert-Contains $kernelIrqDocs1020 "## Controlled PIC Mask Unmask Smoke Foundation" "v10.2.0 irq docs pic unmask smoke section"
Assert-Contains $kernelIrqDocs1020 'target IRQ lines remain `none`' "v10.2.0 irq docs target irq lines none"

foreach ($picUnmaskSmokeSurface1020 in @($picUnmaskSmokeNoteBlock1020, $picUnmaskSmokeStatusBlock1020, $picUnmaskSmokePlanBlock1020, $picUnmaskSmokeBlockersBlock1020, $picUnmaskSmokeHelperBlock1020)) {
    foreach ($blockedPicUnmaskSmokeCall1020 in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
        'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
        'write_pic_port(PIC_MASTER_DATA',
        'write_pic_port(PIC_SLAVE_DATA',
        'asm!("sti")',
        'asm!("sti",',
        'global_asm!("sti")',
        'enable_interrupts',
        ...
        Assert-NotContains $picUnmaskSmokeSurface1020 $blockedPicUnmaskSmokeCall1020 "v10.2.0 pic unmask smoke path is read-only: $blockedPicUnmaskSmokeCall1020"
    }
}

foreach ($literal1020 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1020 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1020 + ')') "v10.2.0 no master unmask literal $literal1020 in main"
    Assert-NotContains $mainContent1020 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1020 + ')') "v10.2.0 no slave unmask literal $literal1020 in main"
    Assert-NotContains $picContent1020 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1020 + ')') "v10.2.0 no master unmask literal $literal1020 in pic.rs"
    Assert-NotContains $picContent1020 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1020 + ')') "v10.2.0 no slave unmask literal $literal1020 in pic.rs"
}
Assert-NotContains $mainContent1020 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.2.0 kernel main does not dispatch master EOI"
...
Assert-NotContains $mainContent1020 'keyboard_irq' "v10.2.0 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1020 'let status = serial::inb(0x64);' "v10.2.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1020 'let scancode = serial::inb(0x60);' "v10.2.0 keyboard scancode polling remains PS/2 read"
Assert-Contains $irrContent1020 'runtime_irq_active: matrix.runtime_irq_active' "v10.2.0 eoi dispatch smoke keeps runtime irq inactive from readiness matrix"
Assert-Contains $irrContent1020 'runtime_irq_active: matrix.runtime_irq_active' "v10.2.0 pic unmask smoke keeps runtime irq inactive from readiness matrix"

foreach ($forbiddenPicUnmaskPositive1020 in @(
    'pic unmask smoke: active',
    'pic unmask smoke: enabled',
    'target IRQ lines: IRQ0',
    'target IRQ lines: IRQ1',
    'live unmask: yes',
    'pic data writes: enabled',
    'runtime irq active: yes',
    'runtime eoi dispatch: active',
    'runtime eoi dispatch: enabled',
    'eoi dispatch smoke: enabled',
    ...
    Assert-NotContains $mainContent1020 $forbiddenPicUnmaskPositive1020 "v10.2.0 forbidden positive pic unmask runtime state in main: $forbiddenPicUnmaskPositive1020"
    Assert-NotContains $irrContent1020 $forbiddenPicUnmaskPositive1020 "v10.2.0 forbidden positive pic unmask runtime state in irq source: $forbiddenPicUnmaskPositive1020"
    Assert-NotContains $kernelIrqDocs1020 $forbiddenPicUnmaskPositive1020 "v10.2.0 forbidden positive pic unmask runtime state in irq docs: $forbiddenPicUnmaskPositive1020"
    Assert-NotContains $kernelBootSmokeDocs1020 $forbiddenPicUnmaskPositive1020 "v10.2.0 forbidden positive pic unmask runtime state in qemu docs: $forbiddenPicUnmaskPositive1020"
}

Write-Host "[OK] v10.2.0 Controlled PIC Mask Unmask Smoke Foundation verified"

# v10.2.1: Controlled PIC Mask Unmask Smoke Hardening
Write-Host "Verifying v10.2.1 Controlled PIC Mask Unmask Smoke Hardening contracts..."
$v1020Tag = & git rev-list -n 1 v10.2.0 2>$null
$v1020TagType = & git cat-file -t v10.2.0 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1020Tag) { throw "v10.2.0 tag not found (required baseline)" }
if (($v1020TagType | Select-Object -First 1) -ne "tag") { throw "v10.2.0 must be an annotated tag baseline" }

$cargoContent1021 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1021 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1021 = Get-Content $irrRs -Raw
$picContent1021 = Get-Content $picRs -Raw
$mainContent1021 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1021 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1021 = $kernelBootSmokeDocs1021 -replace "`r`n", "`n"
$kernelIrqDocs1021 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1021 = $kernelIrqDocs1021 -replace "`r`n", "`n"

Assert-Contains $cargoContent1021 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1021 'version = "10.2.0"' "kernel-lab stale v10.2.0 package version guard"
Assert-Contains $kernelCargoLockContent1021 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1021 'pic-unmask-smoke-note pic-unmask-smoke-status pic-unmask-smoke-plan pic-unmask-smoke-blockers' "help string includes v10.2.1 pic unmask smoke commands"
Assert-Contains $mainContent1021 'line_str == "pic-unmask-smoke-note"' "v10.2.1 pic unmask smoke note dispatcher"
Assert-Contains $mainContent1021 'line_str == "pic-unmask-smoke-status"' "v10.2.1 pic unmask smoke status dispatcher"
Assert-Contains $mainContent1021 'line_str == "pic-unmask-smoke-plan"' "v10.2.1 pic unmask smoke plan dispatcher"
Assert-Contains $mainContent1021 'line_str == "pic-unmask-smoke-blockers"' "v10.2.1 pic unmask smoke blockers dispatcher"
Assert-Contains $irrContent1021 "pub struct PicUnmaskSmoke" "v10.2.1 pic unmask smoke telemetry struct"
Assert-Contains $irrContent1021 "pub fn pic_unmask_smoke(" "v10.2.1 pic unmask smoke helper"

$picUnmaskSmokeHelperStart1021 = $irrContent1021.IndexOf('pub fn pic_unmask_smoke(')
if ($picUnmaskSmokeHelperStart1021 -lt 0) { throw "v10.2.1 pic unmask smoke helper isolation failed" }
$picUnmaskSmokeHelperBlock1021 = $irrContent1021.Substring($picUnmaskSmokeHelperStart1021)
$picUnmaskSmokeNoteStart1021 = $mainContent1021.IndexOf('} else if line_str == "pic-unmask-smoke-note" {')
$picUnmaskSmokeStatusStart1021 = $mainContent1021.IndexOf('} else if line_str == "pic-unmask-smoke-status" {')
$picUnmaskSmokePlanStart1021 = $mainContent1021.IndexOf('} else if line_str == "pic-unmask-smoke-plan" {')
$picUnmaskSmokeBlockersStart1021 = $mainContent1021.IndexOf('} else if line_str == "pic-unmask-smoke-blockers" {')
$picUnmaskSmokeEnd1021 = $mainContent1021.IndexOf('} else if line_str == "eoi-runtime-note" {', $picUnmaskSmokeBlockersStart1021)
if ($picUnmaskSmokeNoteStart1021 -lt 0 -or $picUnmaskSmokeStatusStart1021 -lt $picUnmaskSmokeNoteStart1021 -or $picUnmaskSmokePlanStart1021 -lt $picUnmaskSmokeStatusStart1021 -or $picUnmaskSmokeBlockersStart1021 -lt $picUnmaskSmokePlanStart1021 -or $picUnmaskSmokeEnd1021 -lt $picUnmaskSmokeBlockersStart1021) {
    throw "v10.2.1 pic unmask smoke command block isolation failed"
}
$picUnmaskSmokeNoteBlock1021 = $mainContent1021.Substring($picUnmaskSmokeNoteStart1021, $picUnmaskSmokeStatusStart1021 - $picUnmaskSmokeNoteStart1021)
$picUnmaskSmokeStatusBlock1021 = $mainContent1021.Substring($picUnmaskSmokeStatusStart1021, $picUnmaskSmokePlanStart1021 - $picUnmaskSmokeStatusStart1021)
$picUnmaskSmokePlanBlock1021 = $mainContent1021.Substring($picUnmaskSmokePlanStart1021, $picUnmaskSmokeBlockersStart1021 - $picUnmaskSmokePlanStart1021)
$picUnmaskSmokeBlockersBlock1021 = $mainContent1021.Substring($picUnmaskSmokeBlockersStart1021, $picUnmaskSmokeEnd1021 - $picUnmaskSmokeBlockersStart1021)

$picUnmaskSmokeNoteExact1021 = 'PIC unmask smoke note\nscope: controlled dry-run foundation\ntarget IRQ lines: {}\nmask policy: {}\nunmask policy: {}\nlive unmask: {}\nhardware mutation: {}\nsti: {}\nruntime irq active: {}\n'
$picUnmaskSmokeStatusExact1021 = 'PIC unmask smoke status\npic unmask smoke: {}\ndispatch mode: {}\ntarget IRQ lines: {}\npic mask policy: {}\nactivation token: {}\nactivation gate: {}\nEOI boundary: {}\nSTI plan: {}\nEOI dispatch smoke: {}\nlive unmask: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$picUnmaskSmokePlanExact1021 = 'PIC unmask smoke plan\n1. require PIC mask plan prerequisite\n2. require readiness matrix prerequisite\n3. require activation token and gate prerequisite\n4. require EOI boundary and dispatch smoke prerequisite\n5. keep target IRQ lines: {}\n6. keep PIC data-port writes disabled\n7. keep runtime IRQ inactive\nresult: {}\n'
$picUnmaskSmokeBlockersExact1021 = 'PIC unmask smoke blockers\n- activation token: {}\n- activation gate: {}\n- EOI runtime boundary: {}\n- STI: {}\n- live unmask: {}\n- runtime IRQ active: {}\n- {}\npic unmask smoke: {}\n'
Assert-Contains $picUnmaskSmokeNoteBlock1021 $picUnmaskSmokeNoteExact1021 "v10.2.1 pic-unmask-smoke-note exact output"
Assert-Contains $picUnmaskSmokeStatusBlock1021 $picUnmaskSmokeStatusExact1021 "v10.2.1 pic-unmask-smoke-status exact output"
Assert-Contains $picUnmaskSmokePlanBlock1021 $picUnmaskSmokePlanExact1021 "v10.2.1 pic-unmask-smoke-plan exact output"
Assert-Contains $picUnmaskSmokeBlockersBlock1021 $picUnmaskSmokeBlockersExact1021 "v10.2.1 pic-unmask-smoke-blockers exact output"

$expectedQemuPicUnmaskSmokeNote1021 = "PIC unmask smoke note`n    scope: controlled dry-run foundation`n    target IRQ lines: none`n    mask policy: all masked (0xFF)`n    unmask policy: no lines scheduled for unmask`n    live unmask: no`n    hardware mutation: no`n    sti: disabled`n    runtime irq active: no"
$expectedQemuPicUnmaskSmokeStatus1021 = "PIC unmask smoke status`n    pic unmask smoke: blocked`n    dispatch mode: dry-run`n    target IRQ lines: none`n    pic mask policy: all masked (0xFF)`n    activation token: absent`n    activation gate: activation blocked`n    EOI boundary: disabled`n    STI plan: blocked`n    EOI dispatch smoke: blocked`n    live unmask: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuPicUnmaskSmokePlan1021 = "PIC unmask smoke plan`n    1. require PIC mask plan prerequisite`n    2. require readiness matrix prerequisite`n    3. require activation token and gate prerequisite`n    4. require EOI boundary and dispatch smoke prerequisite`n    5. keep target IRQ lines: none`n    6. keep PIC data-port writes disabled`n    7. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuPicUnmaskSmokeBlockers1021 = "PIC unmask smoke blockers`n    - activation token: absent`n    - activation gate: activation blocked`n    - EOI runtime boundary: disabled`n    - STI: disabled`n    - live unmask: no`n    - runtime IRQ active: no`n    - keyboard IRQ path: disabled`n    pic unmask smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1021 $expectedQemuPicUnmaskSmokeNote1021 "v10.2.1 qemu docs pic unmask smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1021 $expectedQemuPicUnmaskSmokeStatus1021 "v10.2.1 qemu docs pic unmask smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1021 $expectedQemuPicUnmaskSmokePlan1021 "v10.2.1 qemu docs pic unmask smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1021 $expectedQemuPicUnmaskSmokeBlockers1021 "v10.2.1 qemu docs pic unmask smoke blockers exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1021 "v10.2.1 hardens the PIC unmask smoke verification surface without changing these rendered outputs." "v10.2.1 qemu docs hardening note"
Assert-Contains $kernelIrqDocs1021 "## Controlled PIC Mask Unmask Smoke Hardening" "v10.2.1 irq docs hardening section"
Assert-Contains $kernelIrqDocs1021 "without adding runtime behavior or changing output wording from v10.2.0" "v10.2.1 irq docs hardening no behavior change"

foreach ($picUnmaskSmokeSurface1021 in @($picUnmaskSmokeNoteBlock1021, $picUnmaskSmokeStatusBlock1021, $picUnmaskSmokePlanBlock1021, $picUnmaskSmokeBlockersBlock1021, $picUnmaskSmokeHelperBlock1021)) {
    foreach ($blockedPicUnmaskSmokeCall1021 in @(
        'write_pic_port(',
        'outb(',
        'set_handler(',
        'irq_runtime_commit',
        ...
        Assert-NotContains $picUnmaskSmokeSurface1021 $blockedPicUnmaskSmokeCall1021 "v10.2.1 pic unmask smoke path is read-only: $blockedPicUnmaskSmokeCall1021"
    }
}

foreach ($literal1021 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1021 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1021 + ')') "v10.2.1 no master unmask literal $literal1021 in main"
    Assert-NotContains $mainContent1021 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1021 + ')') "v10.2.1 no slave unmask literal $literal1021 in main"
    Assert-NotContains $picContent1021 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1021 + ')') "v10.2.1 no master unmask literal $literal1021 in pic.rs"
    Assert-NotContains $picContent1021 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1021 + ')') "v10.2.1 no slave unmask literal $literal1021 in pic.rs"
}
Assert-NotContains $mainContent1021 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.2.1 kernel main does not dispatch master EOI"
...
Assert-NotContains $mainContent1021 'keyboard_irq' "v10.2.1 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1021 'let status = serial::inb(0x64);' "v10.2.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1021 'let scancode = serial::inb(0x60);' "v10.2.1 keyboard scancode polling remains PS/2 read"
Assert-Contains $mainContent1021 'keyboard mode: polling' "v10.2.1 keyboard polling output unchanged"
Assert-Contains $irrContent1021 'runtime_irq_active: matrix.runtime_irq_active' "v10.2.1 pic unmask smoke keeps runtime irq inactive from readiness matrix"

foreach ($forbiddenPicUnmaskPositive1021 in @(
    'pic unmask smoke: active',
    'pic unmask smoke: enabled',
    'target IRQ lines: IRQ0',
    'target IRQ lines: IRQ1',
    ...
    Assert-NotContains $mainContent1021 $forbiddenPicUnmaskPositive1021 "v10.2.1 forbidden positive pic unmask runtime state in main: $forbiddenPicUnmaskPositive1021"
    Assert-NotContains $irrContent1021 $forbiddenPicUnmaskPositive1021 "v10.2.1 forbidden positive pic unmask runtime state in irq source: $forbiddenPicUnmaskPositive1021"
    Assert-NotContains $kernelIrqDocs1021 $forbiddenPicUnmaskPositive1021 "v10.2.1 forbidden positive pic unmask runtime state in irq docs: $forbiddenPicUnmaskPositive1021"
    Assert-NotContains $kernelBootSmokeDocs1021 $forbiddenPicUnmaskPositive1021 "v10.2.1 forbidden positive pic unmask runtime state in qemu docs: $forbiddenPicUnmaskPositive1021"
}

Write-Host "[OK] v10.2.1 Controlled PIC Mask Unmask Smoke Hardening verified"

# v10.3.0: Controlled IDT Runtime Bind Smoke Foundation
Write-Host "Verifying v10.3.0 Controlled IDT Runtime Bind Smoke Foundation contracts..."
$v1021Tag = & git rev-list -n 1 v10.2.1 2>$null
$v1021TagType = & git cat-file -t v10.2.1 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1021Tag) { throw "v10.2.1 tag not found (required baseline)" }
if (($v1021TagType | Select-Object -First 1) -ne "tag") { throw "v10.2.1 must be an annotated tag baseline" }

$cargoContent1030 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1030 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1030 = Get-Content $irrRs -Raw
$picContent1030 = Get-Content $picRs -Raw
$mainContent1030 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1030 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1030 = $kernelBootSmokeDocs1030 -replace "`r`n", "`n"
$kernelIrqDocs1030 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1030 = $kernelIrqDocs1030 -replace "`r`n", "`n"

Assert-Contains $cargoContent1030 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1030 'version = "10.2.1"' "kernel-lab stale v10.2.1 package version guard"
Assert-Contains $kernelCargoLockContent1030 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1030 'idt-runtime-bind-smoke-note idt-runtime-bind-smoke-status idt-runtime-bind-smoke-plan idt-runtime-bind-smoke-blockers' "help string includes v10.3.0 idt runtime bind smoke commands"
Assert-Contains $mainContent1030 'line_str == "idt-runtime-bind-smoke-note"' "v10.3.0 idt runtime bind smoke note dispatcher"
Assert-Contains $mainContent1030 'line_str == "idt-runtime-bind-smoke-status"' "v10.3.0 idt runtime bind smoke status dispatcher"
Assert-Contains $mainContent1030 'line_str == "idt-runtime-bind-smoke-plan"' "v10.3.0 idt runtime bind smoke plan dispatcher"
Assert-Contains $mainContent1030 'line_str == "idt-runtime-bind-smoke-blockers"' "v10.3.0 idt runtime bind smoke blockers dispatcher"
Assert-Contains $irrContent1030 "pub struct IdtRuntimeBindSmoke" "v10.3.0 idt runtime bind smoke telemetry struct"
Assert-Contains $irrContent1030 "pub fn idt_runtime_bind_smoke(" "v10.3.0 idt runtime bind smoke helper"

$idtRuntimeBindSmokeHelperStart1030 = $irrContent1030.IndexOf('pub fn idt_runtime_bind_smoke(')
if ($idtRuntimeBindSmokeHelperStart1030 -lt 0) { throw "v10.3.0 idt runtime bind smoke helper isolation failed" }
$idtRuntimeBindSmokeHelperBlock1030 = $irrContent1030.Substring($idtRuntimeBindSmokeHelperStart1030)
$idtRuntimeBindSmokeNoteStart1030 = $mainContent1030.IndexOf('} else if line_str == "idt-runtime-bind-smoke-note" {')
$idtRuntimeBindSmokeStatusStart1030 = $mainContent1030.IndexOf('} else if line_str == "idt-runtime-bind-smoke-status" {')
$idtRuntimeBindSmokePlanStart1030 = $mainContent1030.IndexOf('} else if line_str == "idt-runtime-bind-smoke-plan" {')
$idtRuntimeBindSmokeBlockersStart1030 = $mainContent1030.IndexOf('} else if line_str == "idt-runtime-bind-smoke-blockers" {')
$idtRuntimeBindSmokeEnd1030 = $mainContent1030.IndexOf('} else if line_str == "eoi-runtime-note" {', $idtRuntimeBindSmokeBlockersStart1030)
if ($idtRuntimeBindSmokeNoteStart1030 -lt 0 -or $idtRuntimeBindSmokeStatusStart1030 -lt $idtRuntimeBindSmokeNoteStart1030 -or $idtRuntimeBindSmokePlanStart1030 -lt $idtRuntimeBindSmokeStatusStart1030 -or $idtRuntimeBindSmokeBlockersStart1030 -lt $idtRuntimeBindSmokePlanStart1030 -or $idtRuntimeBindSmokeEnd1030 -lt $idtRuntimeBindSmokeBlockersStart1030) {
    throw "v10.3.0 idt runtime bind smoke command block isolation failed"
}
$idtRuntimeBindSmokeNoteBlock1030 = $mainContent1030.Substring($idtRuntimeBindSmokeNoteStart1030, $idtRuntimeBindSmokeStatusStart1030 - $idtRuntimeBindSmokeNoteStart1030)
$idtRuntimeBindSmokeStatusBlock1030 = $mainContent1030.Substring($idtRuntimeBindSmokeStatusStart1030, $idtRuntimeBindSmokePlanStart1030 - $idtRuntimeBindSmokeStatusStart1030)
$idtRuntimeBindSmokePlanBlock1030 = $mainContent1030.Substring($idtRuntimeBindSmokePlanStart1030, $idtRuntimeBindSmokeBlockersStart1030 - $idtRuntimeBindSmokePlanStart1030)
$idtRuntimeBindSmokeBlockersBlock1030 = $mainContent1030.Substring($idtRuntimeBindSmokeBlockersStart1030, $idtRuntimeBindSmokeEnd1030 - $idtRuntimeBindSmokeBlockersStart1030)

$idtRuntimeBindSmokeNoteExact1030 = 'IDT runtime bind smoke note\nscope: controlled dry-run foundation\ntarget vectors: {}\nlive handler bind: {}\nhardware mutation: {}\nsti: {}\nruntime irq active: {}\n'
$idtRuntimeBindSmokeStatusExact1030 = 'IDT runtime bind smoke status\nidt runtime bind smoke: {}\ndispatch mode: {}\ntarget vectors: {}\nirq gate bind smoke: {}\nEOI dispatch smoke: {}\nPIC unmask smoke: {}\nSTI plan: {}\nlive handler bind: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$idtRuntimeBindSmokePlanExact1030 = 'IDT runtime bind smoke plan\n1. require activation token and gate prerequisite\n2. require readiness matrix prerequisite\n3. require IRQ gate bind smoke prerequisite\n4. require EOI dispatch smoke boundary\n5. require PIC unmask smoke boundary\n6. keep live handler bind disabled\n7. keep runtime IRQ inactive\nresult: {}\n'
$idtRuntimeBindSmokeBlockersExact1030 = 'IDT runtime bind smoke blockers\n- activation token: {}\n- activation gate: {}\n- IRQ gate bind smoke: vectors 32/33 not bound\n- EOI dispatch smoke: {}\n- PIC unmask smoke: {}\n- STI: {}\n- live handler bind: {}\n- runtime IRQ active: {}\nidt runtime bind smoke: {}\n'
Assert-Contains $idtRuntimeBindSmokeNoteBlock1030 $idtRuntimeBindSmokeNoteExact1030 "v10.3.0 idt-runtime-bind-smoke-note exact output"
Assert-Contains $idtRuntimeBindSmokeStatusBlock1030 $idtRuntimeBindSmokeStatusExact1030 "v10.3.0 idt-runtime-bind-smoke-status exact output"
Assert-Contains $idtRuntimeBindSmokePlanBlock1030 $idtRuntimeBindSmokePlanExact1030 "v10.3.0 idt-runtime-bind-smoke-plan exact output"
Assert-Contains $idtRuntimeBindSmokeBlockersBlock1030 $idtRuntimeBindSmokeBlockersExact1030 "v10.3.0 idt-runtime-bind-smoke-blockers exact output"

foreach ($idtRuntimeBindSmokeReadBlock1030 in @($idtRuntimeBindSmokeNoteBlock1030, $idtRuntimeBindSmokeStatusBlock1030, $idtRuntimeBindSmokePlanBlock1030, $idtRuntimeBindSmokeBlockersBlock1030)) {
    Assert-ContainsInOrder $idtRuntimeBindSmokeReadBlock1030 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v10.3.0 idt runtime bind smoke reader ordering"
}

$expectedQemuIdtRuntimeBindSmokeNote1030 = "IDT runtime bind smoke note`n    scope: controlled dry-run foundation`n    target vectors: 32/33 planned`n    live handler bind: no`n    hardware mutation: no`n    sti: disabled`n    runtime irq active: no"
$expectedQemuIdtRuntimeBindSmokeStatus1030 = "IDT runtime bind smoke status`n    idt runtime bind smoke: blocked`n    dispatch mode: dry-run`n    target vectors: 32/33 planned`n    irq gate bind smoke: not bound`n    EOI dispatch smoke: blocked`n    PIC unmask smoke: blocked`n    STI plan: blocked`n    live handler bind: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuIdtRuntimeBindSmokePlan1030 = "IDT runtime bind smoke plan`n    1. require activation token and gate prerequisite`n    2. require readiness matrix prerequisite`n    3. require IRQ gate bind smoke prerequisite`n    4. require EOI dispatch smoke boundary`n    5. require PIC unmask smoke boundary`n    6. keep live handler bind disabled`n    7. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuIdtRuntimeBindSmokeBlockers1030 = "IDT runtime bind smoke blockers`n    - activation token: absent`n    - activation gate: activation blocked`n    - IRQ gate bind smoke: vectors 32/33 not bound`n    - EOI dispatch smoke: blocked`n    - PIC unmask smoke: blocked`n    - STI: disabled`n    - live handler bind: no`n    - runtime IRQ active: no`n    idt runtime bind smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1030 $expectedQemuIdtRuntimeBindSmokeNote1030 "v10.3.0 qemu docs idt runtime bind smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1030 $expectedQemuIdtRuntimeBindSmokeStatus1030 "v10.3.0 qemu docs idt runtime bind smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1030 $expectedQemuIdtRuntimeBindSmokePlan1030 "v10.3.0 qemu docs idt runtime bind smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1030 $expectedQemuIdtRuntimeBindSmokeBlockers1030 "v10.3.0 qemu docs idt runtime bind smoke blockers exact rendered contract"
Assert-Contains $kernelIrqDocs1030 "## Controlled IDT Runtime Bind Smoke Foundation" "v10.3.0 irq docs idt runtime bind smoke section"
Assert-Contains $kernelIrqDocs1030 'no IDT handlers are bound' "v10.3.0 irq docs no handler bind"

foreach ($idtRuntimeBindSmokeSurface1030 in @($idtRuntimeBindSmokeNoteBlock1030, $idtRuntimeBindSmokeStatusBlock1030, $idtRuntimeBindSmokePlanBlock1030, $idtRuntimeBindSmokeBlockersBlock1030, $idtRuntimeBindSmokeHelperBlock1030)) {
    foreach ($blockedIdtRuntimeBindSmokeCall1030 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $idtRuntimeBindSmokeSurface1030 $blockedIdtRuntimeBindSmokeCall1030 "v10.3.0 idt runtime bind smoke path is read-only: $blockedIdtRuntimeBindSmokeCall1030"
    }
}

foreach ($literal1030 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1030 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1030 + ')') "v10.3.0 no master unmask literal $literal1030 in main"
    Assert-NotContains $mainContent1030 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1030 + ')') "v10.3.0 no slave unmask literal $literal1030 in main"
    Assert-NotContains $picContent1030 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1030 + ')') "v10.3.0 no master unmask literal $literal1030 in pic.rs"
    Assert-NotContains $picContent1030 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1030 + ')') "v10.3.0 no slave unmask literal $literal1030 in pic.rs"
}
Assert-NotContains $mainContent1030 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.3.0 kernel main does not dispatch master EOI"
...
Assert-NotContains $mainContent1030 'keyboard_irq' "v10.3.0 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1030 'let status = serial::inb(0x64);' "v10.3.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1030 'let scancode = serial::inb(0x60);' "v10.3.0 keyboard scancode polling remains PS/2 read"
Assert-Contains $mainContent1030 'keyboard mode: polling' "v10.3.0 keyboard polling output unchanged"
Assert-Contains $irrContent1030 'runtime_irq_active: matrix.runtime_irq_active' "v10.3.0 idt runtime bind smoke keeps runtime irq inactive from readiness matrix"

foreach ($forbiddenIdtRuntimeBindPositive1030 in @(
    'idt runtime bind smoke: active',
    'idt runtime bind smoke: enabled',
    'live handler bind: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'runtime eoi dispatch: active',
    'runtime eoi dispatch: enabled',
    ...
    Assert-NotContains $mainContent1030 $forbiddenIdtRuntimeBindPositive1030 "v10.3.0 forbidden positive idt runtime bind state in main: $forbiddenIdtRuntimeBindPositive1030"
    Assert-NotContains $irrContent1030 $forbiddenIdtRuntimeBindPositive1030 "v10.3.0 forbidden positive idt runtime bind state in irq source: $forbiddenIdtRuntimeBindPositive1030"
    Assert-NotContains $kernelIrqDocs1030 $forbiddenIdtRuntimeBindPositive1030 "v10.3.0 forbidden positive idt runtime bind state in irq docs: $forbiddenIdtRuntimeBindPositive1030"
    Assert-NotContains $kernelBootSmokeDocs1030 $forbiddenIdtRuntimeBindPositive1030 "v10.3.0 forbidden positive idt runtime bind state in qemu docs: $forbiddenIdtRuntimeBindPositive1030"
}

Write-Host "[OK] v10.3.0 Controlled IDT Runtime Bind Smoke Foundation verified"

# v10.4.0: Controlled IDT Runtime Bind Smoke Hardening
Write-Host "Verifying v10.4.0 Controlled IDT Runtime Bind Smoke Hardening contracts..."
$v1030Tag = & git rev-list -n 1 v10.3.0 2>$null
$v1030TagType = & git cat-file -t v10.3.0 2>$null
$HEAD = & git rev-parse HEAD
if ($null -eq $v1030Tag) { throw "v10.3.0 tag not found (required baseline)" }
if (($v1030TagType | Select-Object -First 1) -ne "tag") { throw "v10.3.0 must be an annotated tag baseline" }

$cargoContent1031 = Get-Content $cargoToml -Raw
$kernelCargoLockContent1031 = Get-Content (Join-Path $repoRoot "kernel-lab\Cargo.lock") -Raw
$irrContent1031 = Get-Content $irrRs -Raw
$picContent1031 = Get-Content $picRs -Raw
$mainContent1031 = Get-Content $mainRs -Raw
$kernelBootSmokeDocs1031 = Get-Content (Join-Path $repoRoot "docs\QEMU_BOOT_SMOKE.md") -Raw
$kernelBootSmokeDocs1031 = $kernelBootSmokeDocs1031 -replace "`r`n", "`n"
$kernelIrqDocs1031 = Get-Content (Join-Path $repoRoot "docs\KERNEL_IRQ.md") -Raw
$kernelIrqDocs1031 = $kernelIrqDocs1031 -replace "`r`n", "`n"

Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.7.0"
Assert-NotContains $cargoContent1031 'version = "10.3.0"' "kernel-lab stale v10.3.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.7.0"
...
Assert-Contains $mainContent1031 'idt-runtime-bind-smoke-note idt-runtime-bind-smoke-status idt-runtime-bind-smoke-plan idt-runtime-bind-smoke-blockers' "help string includes v10.4.0 idt runtime bind smoke commands"
Assert-Contains $mainContent1031 'line_str == "idt-runtime-bind-smoke-note"' "v10.4.0 idt runtime bind smoke note dispatcher"
Assert-Contains $mainContent1031 'line_str == "idt-runtime-bind-smoke-status"' "v10.4.0 idt runtime bind smoke status dispatcher"
Assert-Contains $mainContent1031 'line_str == "idt-runtime-bind-smoke-plan"' "v10.4.0 idt runtime bind smoke plan dispatcher"
Assert-Contains $mainContent1031 'line_str == "idt-runtime-bind-smoke-blockers"' "v10.4.0 idt runtime bind smoke blockers dispatcher"
Assert-Contains $irrContent1031 "pub struct IdtRuntimeBindSmoke" "v10.4.0 idt runtime bind smoke telemetry struct"
Assert-Contains $irrContent1031 "pub fn idt_runtime_bind_smoke(" "v10.4.0 idt runtime bind smoke helper"

$idtRuntimeBindSmokeHelperStart1031 = $irrContent1031.IndexOf('pub fn idt_runtime_bind_smoke(')
if ($idtRuntimeBindSmokeHelperStart1031 -lt 0) { throw "v10.4.0 idt runtime bind smoke helper isolation failed" }
$idtRuntimeBindSmokeHelperBlock1031 = $irrContent1031.Substring($idtRuntimeBindSmokeHelperStart1031)
$idtRuntimeBindSmokeNoteStart1031 = $mainContent1031.IndexOf('} else if line_str == "idt-runtime-bind-smoke-note" {')
$idtRuntimeBindSmokeStatusStart1031 = $mainContent1031.IndexOf('} else if line_str == "idt-runtime-bind-smoke-status" {')
$idtRuntimeBindSmokePlanStart1031 = $mainContent1031.IndexOf('} else if line_str == "idt-runtime-bind-smoke-plan" {')
$idtRuntimeBindSmokeBlockersStart1031 = $mainContent1031.IndexOf('} else if line_str == "idt-runtime-bind-smoke-blockers" {')
$idtRuntimeBindSmokeEnd1031 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $idtRuntimeBindSmokeBlockersStart1031)
if ($idtRuntimeBindSmokeNoteStart1031 -lt 0 -or $idtRuntimeBindSmokeStatusStart1031 -lt $idtRuntimeBindSmokeNoteStart1031 -or $idtRuntimeBindSmokePlanStart1031 -lt $idtRuntimeBindSmokeStatusStart1031 -or $idtRuntimeBindSmokeBlockersStart1031 -lt $idtRuntimeBindSmokePlanStart1031 -or $idtRuntimeBindSmokeEnd1031 -lt $idtRuntimeBindSmokeBlockersStart1031) {
    throw "v10.4.0 idt runtime bind smoke command block isolation failed"
}
$idtRuntimeBindSmokeNoteBlock1031 = $mainContent1031.Substring($idtRuntimeBindSmokeNoteStart1031, $idtRuntimeBindSmokeStatusStart1031 - $idtRuntimeBindSmokeNoteStart1031)
$idtRuntimeBindSmokeStatusBlock1031 = $mainContent1031.Substring($idtRuntimeBindSmokeStatusStart1031, $idtRuntimeBindSmokePlanStart1031 - $idtRuntimeBindSmokeStatusStart1031)
$idtRuntimeBindSmokePlanBlock1031 = $mainContent1031.Substring($idtRuntimeBindSmokePlanStart1031, $idtRuntimeBindSmokeBlockersStart1031 - $idtRuntimeBindSmokePlanStart1031)
$idtRuntimeBindSmokeBlockersBlock1031 = $mainContent1031.Substring($idtRuntimeBindSmokeBlockersStart1031, $idtRuntimeBindSmokeEnd1031 - $idtRuntimeBindSmokeBlockersStart1031)

$idtRuntimeBindSmokeNoteExact1031 = 'IDT runtime bind smoke note\nscope: controlled dry-run foundation\ntarget vectors: {}\nlive handler bind: {}\nhardware mutation: {}\nsti: {}\nruntime irq active: {}\n'
$idtRuntimeBindSmokeStatusExact1031 = 'IDT runtime bind smoke status\nidt runtime bind smoke: {}\ndispatch mode: {}\ntarget vectors: {}\nirq gate bind smoke: {}\nEOI dispatch smoke: {}\nPIC unmask smoke: {}\nSTI plan: {}\nlive handler bind: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$idtRuntimeBindSmokePlanExact1031 = 'IDT runtime bind smoke plan\n1. require activation token and gate prerequisite\n2. require readiness matrix prerequisite\n3. require IRQ gate bind smoke prerequisite\n4. require EOI dispatch smoke boundary\n5. require PIC unmask smoke boundary\n6. keep live handler bind disabled\n7. keep runtime IRQ inactive\nresult: {}\n'
$idtRuntimeBindSmokeBlockersExact1031 = 'IDT runtime bind smoke blockers\n- activation token: {}\n- activation gate: {}\n- IRQ gate bind smoke: vectors 32/33 not bound\n- EOI dispatch smoke: {}\n- PIC unmask smoke: {}\n- STI: {}\n- live handler bind: {}\n- runtime IRQ active: {}\nidt runtime bind smoke: {}\n'
Assert-Contains $idtRuntimeBindSmokeNoteBlock1031 $idtRuntimeBindSmokeNoteExact1031 "v10.4.0 idt-runtime-bind-smoke-note exact output"
Assert-Contains $idtRuntimeBindSmokeStatusBlock1031 $idtRuntimeBindSmokeStatusExact1031 "v10.4.0 idt-runtime-bind-smoke-status exact output"
Assert-Contains $idtRuntimeBindSmokePlanBlock1031 $idtRuntimeBindSmokePlanExact1031 "v10.4.0 idt-runtime-bind-smoke-plan exact output"
Assert-Contains $idtRuntimeBindSmokeBlockersBlock1031 $idtRuntimeBindSmokeBlockersExact1031 "v10.4.0 idt-runtime-bind-smoke-blockers exact output"

foreach ($idtRuntimeBindSmokeReadBlock1031 in @($idtRuntimeBindSmokeNoteBlock1031, $idtRuntimeBindSmokeStatusBlock1031, $idtRuntimeBindSmokePlanBlock1031, $idtRuntimeBindSmokeBlockersBlock1031)) {
    Assert-ContainsInOrder $idtRuntimeBindSmokeReadBlock1031 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
        ...
        'irq::pic_unmask_smoke(',
        'irq::idt_runtime_bind_smoke('
    ) "v10.4.0 idt runtime bind smoke reader ordering"
}

$expectedQemuIdtRuntimeBindSmokeNote1031 = "IDT runtime bind smoke note`n    scope: controlled dry-run foundation`n    target vectors: 32/33 planned`n    live handler bind: no`n    hardware mutation: no`n    sti: disabled`n    runtime irq active: no"
$expectedQemuIdtRuntimeBindSmokeStatus1031 = "IDT runtime bind smoke status`n    idt runtime bind smoke: blocked`n    dispatch mode: dry-run`n    target vectors: 32/33 planned`n    irq gate bind smoke: not bound`n    EOI dispatch smoke: blocked`n    PIC unmask smoke: blocked`n    STI plan: blocked`n    live handler bind: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuIdtRuntimeBindSmokePlan1031 = "IDT runtime bind smoke plan`n    1. require activation token and gate prerequisite`n    2. require readiness matrix prerequisite`n    3. require IRQ gate bind smoke prerequisite`n    4. require EOI dispatch smoke boundary`n    5. require PIC unmask smoke boundary`n    6. keep live handler bind disabled`n    7. keep runtime IRQ inactive`n    result: dry-run only"
$expectedQemuIdtRuntimeBindSmokeBlockers1031 = "IDT runtime bind smoke blockers`n    - activation token: absent`n    - activation gate: activation blocked`n    - IRQ gate bind smoke: vectors 32/33 not bound`n    - EOI dispatch smoke: blocked`n    - PIC unmask smoke: blocked`n    - STI: disabled`n    - live handler bind: no`n    - runtime IRQ active: no`n    idt runtime bind smoke: blocked"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuIdtRuntimeBindSmokeNote1031 "v10.4.0 qemu docs idt runtime bind smoke note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuIdtRuntimeBindSmokeStatus1031 "v10.4.0 qemu docs idt runtime bind smoke status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuIdtRuntimeBindSmokePlan1031 "v10.4.0 qemu docs idt runtime bind smoke plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuIdtRuntimeBindSmokeBlockers1031 "v10.4.0 qemu docs idt runtime bind smoke blockers exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 'v10.3.1 hardens the IDT runtime bind smoke verification surface without changing these rendered outputs; this surface remains a runtime bind smoke plan, not a live runtime handler bind.' "v10.4.0 qemu docs smoke plan not live bind note"
Assert-Contains $kernelIrqDocs1031 "## Controlled IDT Runtime Bind Smoke Hardening" "v10.4.0 irq docs idt runtime bind smoke hardening section"
Assert-Contains $kernelIrqDocs1031 'remain a smoke plan and contract surface only' "v10.4.0 irq docs smoke plan contract wording"
Assert-Contains $kernelIrqDocs1031 'do not bind runtime handlers' "v10.4.0 irq docs no runtime handler bind"

foreach ($idtRuntimeBindSmokeSurface1031 in @($idtRuntimeBindSmokeNoteBlock1031, $idtRuntimeBindSmokeStatusBlock1031, $idtRuntimeBindSmokePlanBlock1031, $idtRuntimeBindSmokeBlockersBlock1031, $idtRuntimeBindSmokeHelperBlock1031)) {
    foreach ($blockedIdtRuntimeBindSmokeCall1031 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $idtRuntimeBindSmokeSurface1031 $blockedIdtRuntimeBindSmokeCall1031 "v10.4.0 idt runtime bind smoke path is read-only: $blockedIdtRuntimeBindSmokeCall1031"
    }
}

$irqGateBindSmokeStart1031 = $mainContent1031.IndexOf('} else if line_str == "irq-gate-bind-smoke" {')
$irqGateBindSmokeEnd1031 = $mainContent1031.IndexOf('} else if line_str == "irq-gate-bind-status" {', $irqGateBindSmokeStart1031)
if ($irqGateBindSmokeStart1031 -lt 0 -or $irqGateBindSmokeEnd1031 -lt $irqGateBindSmokeStart1031) {
    throw "v10.4.0 irq gate bind smoke block isolation failed"
}
$irqGateBindSmokeBlock1031 = $mainContent1031.Substring($irqGateBindSmokeStart1031, $irqGateBindSmokeEnd1031 - $irqGateBindSmokeStart1031)
Assert-Contains $irqGateBindSmokeBlock1031 'idt::IDT.entries[32].set_handler(' "v10.4.0 vector 32 set_handler remains only in old controlled smoke path"
Assert-Contains $irqGateBindSmokeBlock1031 'interrupts::irq0_timer_gate_smoke_asm' "v10.4.0 vector 32 set_handler target remains smoke wrapper"
Assert-Contains $irqGateBindSmokeBlock1031 'idt::IDT.entries[33].set_handler(' "v10.4.0 vector 33 set_handler remains only in old controlled smoke path"
Assert-Contains $irqGateBindSmokeBlock1031 'interrupts::irq1_keyboard_gate_smoke_asm' "v10.4.0 vector 33 set_handler target remains smoke wrapper"
$mainWithoutAllowedIrqGateBind1031 = [regex]::Replace($mainContent1031, 'idt::IDT\.entries\[32\]\.set_handler\(\s*interrupts::irq0_timer_gate_smoke_asm\s+as \*const \(\),\s*\);', '')
$mainWithoutAllowedIrqGateBind1031 = [regex]::Replace($mainWithoutAllowedIrqGateBind1031, 'idt::IDT\.entries\[33\]\.set_handler\(\s*interrupts::irq1_keyboard_gate_smoke_asm\s+as \*const \(\),\s*\);', '')
$mainWithoutAllowedIrqGateBind1031 = $mainWithoutAllowedIrqGateBind1031.Replace('idt::IDT.entries[32].set_handler(interrupts::irq0_timer_gate_smoke_asm as *const ())', '')
$mainWithoutAllowedIrqGateBind1031 = $mainWithoutAllowedIrqGateBind1031.Replace('idt::IDT.entries[33].set_handler(interrupts::irq1_keyboard_gate_smoke_asm as *const ())', '')
Assert-NotContains $mainWithoutAllowedIrqGateBind1031 'entries[32].set_handler' "v10.4.0 no vector 32 set_handler outside old controlled smoke path"
Assert-NotContains $mainWithoutAllowedIrqGateBind1031 'entries[33].set_handler' "v10.4.0 no vector 33 set_handler outside old controlled smoke path"

foreach ($literal1031 in @('0x00', '0xFC', '0xFD', '0xFE')) {
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1031 + ')') "v10.4.0 no master unmask literal $literal1031 in main"
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1031 + ')') "v10.4.0 no slave unmask literal $literal1031 in main"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1031 + ')') "v10.4.0 no master unmask literal $literal1031 in pic.rs"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1031 + ')') "v10.4.0 no slave unmask literal $literal1031 in pic.rs"
}
Assert-NotContains $mainContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.4.0 kernel main does not dispatch master EOI"
...
Assert-NotContains $mainContent1031 'keyboard_irq' "v10.4.0 kernel main has no keyboard IRQ path"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.4.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.4.0 keyboard scancode polling remains PS/2 read"
Assert-Contains $mainContent1031 'keyboard mode: polling' "v10.4.0 keyboard polling output unchanged"
Assert-Contains $irrContent1031 'runtime_irq_active: matrix.runtime_irq_active' "v10.4.0 idt runtime bind smoke keeps runtime irq inactive from readiness matrix"

foreach ($forbiddenIdtRuntimeBindPositive1031 in @(
    'idt runtime bind smoke: active',
    'idt runtime bind smoke: enabled',
    'live handler bind: yes',
    'hardware mutation: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenIdtRuntimeBindPositive1031 "v10.4.0 forbidden positive idt runtime bind state in main: $forbiddenIdtRuntimeBindPositive1031"
    Assert-NotContains $irrContent1031 $forbiddenIdtRuntimeBindPositive1031 "v10.4.0 forbidden positive idt runtime bind state in irq source: $forbiddenIdtRuntimeBindPositive1031"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenIdtRuntimeBindPositive1031 "v10.4.0 forbidden positive idt runtime bind state in irq docs: $forbiddenIdtRuntimeBindPositive1031"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenIdtRuntimeBindPositive1031 "v10.4.0 forbidden positive idt runtime bind state in qemu docs: $forbiddenIdtRuntimeBindPositive1031"
}

Write-Host "[OK] v10.4.0 Controlled IDT Runtime Bind Smoke Hardening verified"

# v10.4.0: Controlled IRQ Runtime Readiness Final Gate
Write-Host "Verifying v10.4.0 Controlled IRQ Runtime Readiness Final Gate contracts..."
$v1031Tag = & git rev-list -n 1 v10.3.1 2>$null
$v1031TagType = & git cat-file -t v10.3.1 2>$null
...
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-status"' "v10.4.0 final gate status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-check"' "v10.4.0 final gate check dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-blockers"' "v10.4.0 final gate blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeFinalGate' "v10.4.0 final gate telemetry struct"
Assert-Contains $irrContent1031 'pub fn irq_runtime_final_gate(' "v10.4.0 final gate helper"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_FINAL_GATE_ALLOWED_NO: &str = "no";' "v10.4.0 final gate activation remains disallowed"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_FINAL_GATE_LIVE_IDT_BIND_NO: &str = "no";' "v10.4.0 final gate live idt bind remains disabled"

$finalGateHelperStart1040 = $irrContent1031.IndexOf('pub fn irq_runtime_final_gate(')
if ($finalGateHelperStart1040 -lt 0) { throw "v10.4.0 final gate helper isolation failed" }
$finalGateHelperBlock1040 = $irrContent1031.Substring($finalGateHelperStart1040)
$finalGateNoteStart1040 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-note" {')
$finalGateStatusStart1040 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-status" {')
$finalGateCheckStart1040 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-check" {')
$finalGateBlockersStart1040 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-blockers" {')
$finalGateEnd1040 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $finalGateBlockersStart1040)
if ($finalGateNoteStart1040 -lt 0 -or $finalGateStatusStart1040 -lt $finalGateNoteStart1040 -or $finalGateCheckStart1040 -lt $finalGateStatusStart1040 -or $finalGateBlockersStart1040 -lt $finalGateCheckStart1040 -or $finalGateEnd1040 -lt $finalGateBlockersStart1040) {
    throw "v10.4.0 final gate command block isolation failed"
}
$finalGateNoteBlock1040 = $mainContent1031.Substring($finalGateNoteStart1040, $finalGateStatusStart1040 - $finalGateNoteStart1040)
$finalGateStatusBlock1040 = $mainContent1031.Substring($finalGateStatusStart1040, $finalGateCheckStart1040 - $finalGateStatusStart1040)
$finalGateCheckBlock1040 = $mainContent1031.Substring($finalGateCheckStart1040, $finalGateBlockersStart1040 - $finalGateCheckStart1040)
$finalGateBlockersBlock1040 = $mainContent1031.Substring($finalGateBlockersStart1040, $finalGateEnd1040 - $finalGateBlockersStart1040)

$finalGateNoteExact1040 = 'IRQ runtime final gate note\nscope: {}\nactivation inputs: {}\nfinal activation allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$finalGateStatusExact1040 = 'IRQ runtime final gate status\nactivation token: {}\nactivation gate: {}\nreadiness matrix: {}\nsimulation: {}\nSTI plan: {}\nactivation smoke: {}\nEOI dispatch smoke: {}\nPIC unmask smoke: {}\nIDT runtime bind smoke: {}\nkeyboard mode: {}\nfinal activation allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$finalGateCheckExact1040 = 'IRQ runtime final gate check\nsti: {}\npic unmask: {}\neoi dispatch: {}\nlive idt bind: {}\nkeyboard mode: {}\nfinal activation allowed: {}\nresult: {}\nnext: {}\n'
$finalGateBlockersExact1040 = 'IRQ runtime final gate blockers\n- activation token: {}\n- activation gate: {}\n- readiness matrix: {}\n- simulation: {}\n- STI plan: {}\n- activation smoke: {}\n- EOI dispatch smoke: {}\n- PIC unmask smoke: {}\n- IDT runtime bind smoke: {}\n- keyboard mode: {}\nfinal activation allowed: {}\n'
Assert-Contains $finalGateNoteBlock1040 $finalGateNoteExact1040 "v10.4.0 final gate note exact output"
Assert-Contains $finalGateStatusBlock1040 $finalGateStatusExact1040 "v10.4.0 final gate status exact output"
Assert-Contains $finalGateCheckBlock1040 $finalGateCheckExact1040 "v10.4.0 final gate check exact output"
Assert-Contains $finalGateBlockersBlock1040 $finalGateBlockersExact1040 "v10.4.0 final gate blockers exact output"

foreach ($finalGateReadBlock1040 in @($finalGateNoteBlock1040, $finalGateStatusBlock1040, $finalGateCheckBlock1040, $finalGateBlockersBlock1040)) {
    Assert-ContainsInOrder $finalGateReadBlock1040 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    ) "v10.4.0 final gate reader ordering"
}

$expectedQemuFinalGateStatus1040 = "IRQ runtime final gate status`n    activation token: absent`n    activation gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    STI plan: blocked`n    activation smoke: blocked`n    EOI dispatch smoke: blocked`n    PIC unmask smoke: blocked`n    IDT runtime bind smoke: blocked`n    keyboard mode: polling`n    final activation allowed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuFinalGateCheck1040 = "IRQ runtime final gate check`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling`n    final activation allowed: no`n    result: release proof blocked`n    next: none"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateStatus1040 "v10.4.0 qemu docs final gate status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateCheck1040 "v10.4.0 qemu docs final gate check exact rendered contract"
Assert-Contains $kernelIrqDocs1031 "## Controlled IRQ Runtime Readiness Final Gate" "v10.4.0 irq docs final gate section"
Assert-Contains $kernelIrqDocs1031 "final activation remains disallowed" "v10.4.0 irq docs final activation disabled"

foreach ($finalGateSurface1040 in @($finalGateNoteBlock1040, $finalGateStatusBlock1040, $finalGateCheckBlock1040, $finalGateBlockersBlock1040, $finalGateHelperBlock1040)) {
    foreach ($blockedFinalGateCall1040 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $finalGateSurface1040 $blockedFinalGateCall1040 "v10.4.0 final gate path is read-only: $blockedFinalGateCall1040"
    }
}

foreach ($forbiddenFinalGatePositive1040 in @(
    'final activation allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'live idt bind: yes',
    'pic unmask: enabled',
    ...
    Assert-NotContains $mainContent1031 $forbiddenFinalGatePositive1040 "v10.4.0 forbidden positive final gate state in main: $forbiddenFinalGatePositive1040"
    Assert-NotContains $irrContent1031 $forbiddenFinalGatePositive1040 "v10.4.0 forbidden positive final gate state in irq source: $forbiddenFinalGatePositive1040"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenFinalGatePositive1040 "v10.4.0 forbidden positive final gate state in irq docs: $forbiddenFinalGatePositive1040"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenFinalGatePositive1040 "v10.4.0 forbidden positive final gate state in qemu docs: $forbiddenFinalGatePositive1040"
}

Write-Host "[OK] v10.4.0 Controlled IRQ Runtime Readiness Final Gate verified"

# v10.4.1: Controlled IRQ Runtime Readiness Final Gate Hardening
Write-Host "Verifying v10.4.1 Controlled IRQ Runtime Readiness Final Gate Hardening contracts..."
$v1040Tag = & git rev-list -n 1 v10.4.0 2>$null
$v1040TagType = & git cat-file -t v10.4.0 2>$null
if ($null -eq $v1040Tag) { throw "v10.4.0 tag not found (required baseline)" }
if (($v1040TagType | Select-Object -First 1) -ne "tag") { throw "v10.4.0 must be an annotated tag baseline" }

Assert-NotContains $cargoContent1031 'version = "10.4.0"' "kernel-lab stale v10.4.0 package version guard"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.4.0"' "kernel-lab stale v10.4.0 lockfile version guard"
Assert-Contains $mainContent1031 'irq-runtime-final-gate-note irq-runtime-final-gate-status irq-runtime-final-gate-check irq-runtime-final-gate-blockers' "help string includes v10.4.1 final gate commands"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-note"' "v10.4.1 final gate note dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-status"' "v10.4.1 final gate status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-check"' "v10.4.1 final gate check dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-final-gate-blockers"' "v10.4.1 final gate blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeFinalGate' "v10.4.1 final gate telemetry struct"
Assert-Contains $irrContent1031 'pub fn irq_runtime_final_gate(' "v10.4.1 final gate helper"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_FINAL_GATE_ALLOWED_NO: &str = "no";' "v10.4.1 final gate activation remains disallowed"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_FINAL_GATE_LIVE_IDT_BIND_NO: &str = "no";' "v10.4.1 final gate live idt bind remains disabled"

$finalGateHelperStart1041 = $irrContent1031.IndexOf('pub fn irq_runtime_final_gate(')
if ($finalGateHelperStart1041 -lt 0) { throw "v10.4.1 final gate helper isolation failed" }
$finalGateHelperBlock1041 = $irrContent1031.Substring($finalGateHelperStart1041)
$finalGateNoteStart1041 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-note" {')
$finalGateStatusStart1041 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-status" {')
$finalGateCheckStart1041 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-check" {')
$finalGateBlockersStart1041 = $mainContent1031.IndexOf('} else if line_str == "irq-runtime-final-gate-blockers" {')
$finalGateEnd1041 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $finalGateBlockersStart1041)
if ($finalGateNoteStart1041 -lt 0 -or $finalGateStatusStart1041 -lt $finalGateNoteStart1041 -or $finalGateCheckStart1041 -lt $finalGateStatusStart1041 -or $finalGateBlockersStart1041 -lt $finalGateCheckStart1041 -or $finalGateEnd1041 -lt $finalGateBlockersStart1041) {
    throw "v10.4.1 final gate command block isolation failed"
}
$finalGateNoteBlock1041 = $mainContent1031.Substring($finalGateNoteStart1041, $finalGateStatusStart1041 - $finalGateNoteStart1041)
$finalGateStatusBlock1041 = $mainContent1031.Substring($finalGateStatusStart1041, $finalGateCheckStart1041 - $finalGateStatusStart1041)
$finalGateCheckBlock1041 = $mainContent1031.Substring($finalGateCheckStart1041, $finalGateBlockersStart1041 - $finalGateCheckStart1041)
$finalGateBlockersBlock1041 = $mainContent1031.Substring($finalGateBlockersStart1041, $finalGateEnd1041 - $finalGateBlockersStart1041)

$finalGateNoteExact1041 = 'IRQ runtime final gate note\nscope: {}\nactivation inputs: {}\nfinal activation allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$finalGateStatusExact1041 = 'IRQ runtime final gate status\nactivation token: {}\nactivation gate: {}\nreadiness matrix: {}\nsimulation: {}\nSTI plan: {}\nactivation smoke: {}\nEOI dispatch smoke: {}\nPIC unmask smoke: {}\nIDT runtime bind smoke: {}\nkeyboard mode: {}\nfinal activation allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$finalGateCheckExact1041 = 'IRQ runtime final gate check\nsti: {}\npic unmask: {}\neoi dispatch: {}\nlive idt bind: {}\nkeyboard mode: {}\nfinal activation allowed: {}\nresult: {}\nnext: {}\n'
$finalGateBlockersExact1041 = 'IRQ runtime final gate blockers\n- activation token: {}\n- activation gate: {}\n- readiness matrix: {}\n- simulation: {}\n- STI plan: {}\n- activation smoke: {}\n- EOI dispatch smoke: {}\n- PIC unmask smoke: {}\n- IDT runtime bind smoke: {}\n- keyboard mode: {}\nfinal activation allowed: {}\n'
Assert-Contains $finalGateNoteBlock1041 $finalGateNoteExact1041 "v10.4.1 final gate note exact output"
Assert-Contains $finalGateStatusBlock1041 $finalGateStatusExact1041 "v10.4.1 final gate status exact output"
Assert-Contains $finalGateCheckBlock1041 $finalGateCheckExact1041 "v10.4.1 final gate check exact output"
Assert-Contains $finalGateBlockersBlock1041 $finalGateBlockersExact1041 "v10.4.1 final gate blockers exact output"

foreach ($finalGateReadBlock1041 in @($finalGateNoteBlock1041, $finalGateStatusBlock1041, $finalGateCheckBlock1041, $finalGateBlockersBlock1041)) {
    Assert-ContainsInOrder $finalGateReadBlock1041 @(
        'pic::ProgrammableInterruptController::pic_remap_state();',
        'irq::irq_gate_bind_state();',
        'pic::ProgrammableInterruptController::pic_mask_plan();',
        'pic::ProgrammableInterruptController::pic_mask_status();',
        ...
        'irq::idt_runtime_bind_smoke(',
        'irq::irq_runtime_final_gate('
    ) "v10.4.1 final gate reader ordering"
}

$expectedQemuFinalGateNote1041 = "IRQ runtime final gate note`n    scope: controlled read-only release proof`n    activation inputs: token/gate/matrix/simulation/sti/activation-smoke/eoi/pic-unmask/idt-bind`n    final activation allowed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuFinalGateStatus1041 = "IRQ runtime final gate status`n    activation token: absent`n    activation gate: activation blocked`n    readiness matrix: blocked`n    simulation: simulation blocked`n    STI plan: blocked`n    activation smoke: blocked`n    EOI dispatch smoke: blocked`n    PIC unmask smoke: blocked`n    IDT runtime bind smoke: blocked`n    keyboard mode: polling`n    final activation allowed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuFinalGateCheck1041 = "IRQ runtime final gate check`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling`n    final activation allowed: no`n    result: release proof blocked`n    next: none"
$expectedQemuFinalGateBlockers1041 = "IRQ runtime final gate blockers`n    - activation token: absent`n    - activation gate: activation blocked`n    - readiness matrix: runtime irq ready no`n    - simulation: simulation blocked`n    - STI plan: blocked`n    - activation smoke: blocked`n    - EOI dispatch smoke: blocked`n    - PIC unmask smoke: blocked`n    - IDT runtime bind smoke: blocked`n    - keyboard mode: polling`n    final activation allowed: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateNote1041 "v10.4.1 qemu docs final gate note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateStatus1041 "v10.4.1 qemu docs final gate status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateCheck1041 "v10.4.1 qemu docs final gate check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuFinalGateBlockers1041 "v10.4.1 qemu docs final gate blockers exact rendered contract"
Assert-Contains $kernelIrqDocs1031 "## Controlled IRQ Runtime Readiness Final Gate" "v10.4.1 irq docs final gate section"
Assert-Contains $kernelIrqDocs1031 'v10.4.1` hardens that surface without changing the rendered command output or runtime state' "v10.4.1 irq docs unchanged output/runtime note"

foreach ($finalGateSurface1041 in @($finalGateNoteBlock1041, $finalGateStatusBlock1041, $finalGateCheckBlock1041, $finalGateBlockersBlock1041, $finalGateHelperBlock1041)) {
    foreach ($blockedFinalGateCall1041 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $finalGateSurface1041 $blockedFinalGateCall1041 "v10.4.1 final gate path is read-only: $blockedFinalGateCall1041"
    }
}

foreach ($forbiddenFinalGatePositive1041 in @(
    'final activation allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'live idt bind: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenFinalGatePositive1041 "v10.4.1 forbidden positive final gate state in main: $forbiddenFinalGatePositive1041"
    Assert-NotContains $irrContent1031 $forbiddenFinalGatePositive1041 "v10.4.1 forbidden positive final gate state in irq source: $forbiddenFinalGatePositive1041"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenFinalGatePositive1041 "v10.4.1 forbidden positive final gate state in irq docs: $forbiddenFinalGatePositive1041"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenFinalGatePositive1041 "v10.4.1 forbidden positive final gate state in qemu docs: $forbiddenFinalGatePositive1041"
}

foreach ($forbiddenLiveIrq1041 in @(
    'timer_interrupt_handler_stub',
    'keyboard_interrupt_handler_stub',
    'timer_irq',
    'keyboard_irq'
)) {
    Assert-NotContains $mainContent1031 $forbiddenLiveIrq1041 "v10.4.1 no live IRQ0/IRQ1 path in main: $forbiddenLiveIrq1041"
    Assert-NotContains $irrContent1031 $forbiddenLiveIrq1041 "v10.4.1 no live IRQ0/IRQ1 path in irq source: $forbiddenLiveIrq1041"
}

foreach ($literal1041 in @('0x00', '0x01', '0x02', '0x04', '0x08', '0x10', '0x20', '0x40', '0x7F', '0xFE')) {
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1041 + ')') "v10.4.1 no master unmask literal $literal1041 in main"
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1041 + ')') "v10.4.1 no slave unmask literal $literal1041 in main"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1041 + ')') "v10.4.1 no master unmask literal $literal1041 in pic.rs"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1041 + ')') "v10.4.1 no slave unmask literal $literal1041 in pic.rs"
}
Assert-NotContains $mainContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.4.1 kernel main does not dispatch master EOI"
...
Assert-Contains $kernelIrqDocs1031 'keyboard input remains polling-only' "v10.4.1 irq docs keyboard polling remains documented"
Assert-Contains $kernelBootSmokeDocs1031 'keyboard fallback' "v10.4.1 qemu docs keyboard fallback remains documented"

Write-Host "[OK] v10.4.1 Controlled IRQ Runtime Readiness Final Gate Hardening verified"

# v10.5.0: Controlled Activation Decision Freeze
Write-Host "Verifying v10.5.0 Controlled Activation Decision Freeze contracts..."
$v1041Tag = & git rev-list -n 1 v10.4.1 2>$null
$v1041TagType = & git cat-file -t v10.4.1 2>$null
...
Assert-Contains $mainContent1031 'line_str == "irq-runtime-decision-status"' "v10.5.0 decision status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-decision-freeze"' "v10.5.0 decision freeze dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-decision-blockers"' "v10.5.0 decision blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeActivationDecision' "v10.5.0 decision telemetry struct"
Assert-Contains $irrContent1031 'pub fn irq_runtime_decision_freeze(' "v10.5.0 decision freeze helper"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_DECISION_FROZEN_BLOCKED: &str = "frozen blocked";' "v10.5.0 decision remains frozen blocked"
...
$decisionNoteBlock1050 = $mainContent1031.Substring($decisionNoteStart1050, $decisionStatusStart1050 - $decisionNoteStart1050)
$decisionStatusBlock1050 = $mainContent1031.Substring($decisionStatusStart1050, $decisionFreezeStart1050 - $decisionStatusStart1050)
$decisionFreezeBlock1050 = $mainContent1031.Substring($decisionFreezeStart1050, $decisionBlockersStart1050 - $decisionFreezeStart1050)
$decisionBlockersBlock1050 = $mainContent1031.Substring($decisionBlockersStart1050, $decisionEnd1050 - $decisionBlockersStart1050)

$decisionNoteExact1050 = 'IRQ runtime activation decision note\nscope: {}\nactivation inputs: {}\nactivation decision: {}\nfinal activation allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$decisionStatusExact1050 = 'IRQ runtime activation decision\nactivation decision: {}\nfinal activation allowed: {}\nruntime irq active: {}\nhardware mutation: {}\nsti: {}\npic unmask: {}\neoi dispatch: {}\nlive idt bind: {}\nkeyboard mode: {}\n'
$decisionBlockersExact1050 = 'IRQ runtime activation decision blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nactivation decision: {}\n'
Assert-Contains $decisionNotePrintBlock1050 $decisionNoteExact1050 "v10.5.0 decision note exact output"
Assert-Contains $decisionStatusPrintBlock1050 $decisionStatusExact1050 "v10.5.0 decision status/freeze exact output"
Assert-Contains $decisionBlockersPrintBlock1050 $decisionBlockersExact1050 "v10.5.0 decision blockers exact output"
Assert-Contains $decisionNoteBlock1050 'print_irq_runtime_decision_note();' "v10.5.0 decision note dispatcher calls print helper"
Assert-Contains $decisionStatusBlock1050 'print_irq_runtime_decision_status();' "v10.5.0 decision status dispatcher calls print helper"
Assert-Contains $decisionFreezeBlock1050 'print_irq_runtime_decision_status();' "v10.5.0 decision freeze dispatcher calls frozen status helper"
Assert-Contains $decisionBlockersBlock1050 'print_irq_runtime_decision_blockers();' "v10.5.0 decision blockers dispatcher calls print helper"

Assert-ContainsInOrder $decisionSnapshotBlock1050 @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
...
) "v10.5.0 decision reader ordering"

$expectedQemuDecisionNote1050 = "IRQ runtime activation decision note`n    scope: controlled activation decision freeze`n    activation inputs: final-gate/activation-smoke/simulation/sti/eoi/pic-unmask/idt-bind/token/gate/matrix/keyboard`n    activation decision: frozen blocked`n    final activation allowed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuDecisionStatus1050 = "IRQ runtime activation decision`n    activation decision: frozen blocked`n    final activation allowed: no`n    runtime irq active: no`n    hardware mutation: no`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling"
$expectedQemuDecisionBlockers1050 = "IRQ runtime activation decision blockers`n    - STI instruction disabled`n    - PIC unmask disabled`n    - EOI dispatch disabled`n    - live IDT bind disabled`n    - keyboard IRQ path disabled`n    - runtime IRQ active state disabled`n    activation decision: frozen blocked"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionNote1050 "v10.5.0 qemu docs decision note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionStatus1050 "v10.5.0 qemu docs decision status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionBlockers1050 "v10.5.0 qemu docs decision blockers exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 'v10.5.0` is a Controlled Activation Decision Freeze release' "v10.5.0 qemu docs release note"
Assert-Contains $kernelIrqDocs1031 "## Controlled Activation Decision Freeze" "v10.5.0 irq docs decision section"
Assert-Contains $kernelIrqDocs1031 'activation remains `frozen blocked`' "v10.5.0 irq docs frozen blocked contract"

foreach ($decisionSurface1050 in @($decisionSnapshotBlock1050, $decisionNotePrintBlock1050, $decisionStatusPrintBlock1050, $decisionBlockersPrintBlock1050, $decisionNoteBlock1050, $decisionStatusBlock1050, $decisionFreezeBlock1050, $decisionBlockersBlock1050, $decisionHelperBlock1050)) {
    foreach ($blockedDecisionCall1050 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $decisionSurface1050 $blockedDecisionCall1050 "v10.5.0 decision path is read-only: $blockedDecisionCall1050"
    }
}

foreach ($forbiddenDecisionPositive1050 in @(
    ...
    Assert-NotContains $mainContent1031 $forbiddenDecisionPositive1050 "v10.5.0 forbidden positive decision state in main: $forbiddenDecisionPositive1050"
    Assert-NotContains $irrContent1031 $forbiddenDecisionPositive1050 "v10.5.0 forbidden positive decision state in irq source: $forbiddenDecisionPositive1050"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenDecisionPositive1050 "v10.5.0 forbidden positive decision state in irq docs: $forbiddenDecisionPositive1050"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenDecisionPositive1050 "v10.5.0 forbidden positive decision state in qemu docs: $forbiddenDecisionPositive1050"
}

Write-Host "[OK] v10.5.0 Controlled Activation Decision Freeze verified"

# v10.5.1: Controlled Activation Decision Freeze Hardening
Write-Host "Verifying v10.5.1 Controlled Activation Decision Freeze Hardening contracts..."
$v1050Tag = & git rev-list -n 1 v10.5.0 2>$null
$v1050TagType = & git cat-file -t v10.5.0 2>$null
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "current irq docs title preserves later release"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "current qemu docs title preserves later release"
...
Assert-Contains $decisionNotePrintBlock1050 $decisionNoteExact1050 "v10.5.1 decision note exact output unchanged"
Assert-Contains $decisionStatusPrintBlock1050 $decisionStatusExact1050 "v10.5.1 decision status/freeze exact output unchanged"
Assert-Contains $decisionBlockersPrintBlock1050 $decisionBlockersExact1050 "v10.5.1 decision blockers exact output unchanged"
Assert-Contains $decisionNoteBlock1050 'print_irq_runtime_decision_note();' "v10.5.1 decision note dispatcher remains helper-only"
Assert-Contains $decisionStatusBlock1050 'print_irq_runtime_decision_status();' "v10.5.1 decision status dispatcher remains helper-only"
Assert-Contains $decisionFreezeBlock1050 'print_irq_runtime_decision_status();' "v10.5.1 decision freeze dispatcher remains status contract"
Assert-Contains $decisionBlockersBlock1050 'print_irq_runtime_decision_blockers();' "v10.5.1 decision blockers dispatcher remains helper-only"
...
Assert-ContainsInOrder $decisionSnapshotBlock1050 @(
    ...
    'irq::irq_runtime_final_gate(',
    'irq::irq_runtime_decision_freeze('
) "v10.5.1 decision reader ordering unchanged"

$expectedQemuDecisionFreeze1051 = "dbyte-kernel> irq-runtime-decision-freeze`n    IRQ runtime activation decision`n    activation decision: frozen blocked`n    final activation allowed: no`n    runtime irq active: no`n    hardware mutation: no`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionNote1050 "v10.5.1 qemu docs decision note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionStatus1050 "v10.5.1 qemu docs decision status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionFreeze1051 "v10.5.1 qemu docs decision freeze exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuDecisionBlockers1050 "v10.5.1 qemu docs decision blockers exact rendered contract"

foreach ($decisionSurface1051 in @($decisionSnapshotBlock1050, $decisionNotePrintBlock1050, $decisionStatusPrintBlock1050, $decisionBlockersPrintBlock1050, $decisionNoteBlock1050, $decisionStatusBlock1050, $decisionFreezeBlock1050, $decisionBlockersBlock1050, $decisionHelperBlock1050)) {
    foreach ($blockedDecisionCall1051 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $decisionSurface1051 $blockedDecisionCall1051 "v10.5.1 decision path is read-only: $blockedDecisionCall1051"
    }
}

foreach ($decisionDispatchBlock1051 in @($decisionNoteBlock1050, $decisionStatusBlock1050, $decisionFreezeBlock1050, $decisionBlockersBlock1050)) {
    foreach ($blockedDispatcherInline1051 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $decisionDispatchBlock1051 $blockedDispatcherInline1051 "v10.5.1 decision dispatcher remains helper-only: $blockedDispatcherInline1051"
    }
}

foreach ($forbiddenDecisionPositive1051 in @(
    'activation decision: allowed',
    'final activation allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenDecisionPositive1051 "v10.5.1 forbidden positive decision state in main: $forbiddenDecisionPositive1051"
    Assert-NotContains $irrContent1031 $forbiddenDecisionPositive1051 "v10.5.1 forbidden positive decision state in irq source: $forbiddenDecisionPositive1051"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenDecisionPositive1051 "v10.5.1 forbidden positive decision state in irq docs: $forbiddenDecisionPositive1051"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenDecisionPositive1051 "v10.5.1 forbidden positive decision state in qemu docs: $forbiddenDecisionPositive1051"
}

foreach ($literal1051 in @('0x00', '0x01', '0x02', '0x03', '0x7f', '0xfe', '0xfd')) {
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1051 + ')') "v10.5.1 no master unmask literal $literal1051 in main"
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1051 + ')') "v10.5.1 no slave unmask literal $literal1051 in main"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1051 + ')') "v10.5.1 no master unmask literal $literal1051 in pic.rs"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1051 + ')') "v10.5.1 no slave unmask literal $literal1051 in pic.rs"
}
Assert-NotContains $mainContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.5.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.5.1 kernel main does not dispatch slave EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.5.1 pic source does not dispatch master EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.5.1 pic source does not dispatch slave EOI"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.5.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.5.1 keyboard scancode polling remains PS/2 read"
Assert-Contains $kernelIrqDocs1031 'keyboard input remains polling-only' "v10.5.1 irq docs keyboard polling remains documented"
Assert-Contains $kernelBootSmokeDocs1031 'keyboard fallback' "v10.5.1 qemu docs keyboard fallback remains documented"

Write-Host "[OK] v10.5.1 Controlled Activation Decision Freeze Hardening verified"

# v10.6.0: Controlled Hardware Mutation Readiness Checklist
Write-Host "Verifying v10.6.0 Controlled Hardware Mutation Readiness Checklist contracts..."
$v1051Tag = & git rev-list -n 1 v10.5.1 2>$null
$v1051TagType = & git cat-file -t v10.5.1 2>$null
...
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-status"' "v10.6.0 mutation status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-check"' "v10.6.0 mutation check dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-blockers"' "v10.6.0 mutation blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeHardwareMutationChecklist' "v10.6.0 mutation checklist telemetry struct"
Assert-Contains $irrContent1031 'pub fn irq_runtime_mutation_check(' "v10.6.0 mutation checklist helper"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_MUTATION_READY_NO: &str = "no";' "v10.6.0 mutation readiness remains no"
...
$mutationNoteBlock1060 = $mainContent1031.Substring($mutationNoteStart1060, $mutationStatusStart1060 - $mutationNoteStart1060)
$mutationStatusBlock1060 = $mainContent1031.Substring($mutationStatusStart1060, $mutationCheckStart1060 - $mutationStatusStart1060)
$mutationCheckBlock1060 = $mainContent1031.Substring($mutationCheckStart1060, $mutationBlockersStart1060 - $mutationCheckStart1060)
$mutationBlockersBlock1060 = $mainContent1031.Substring($mutationBlockersStart1060, $mutationEnd1060 - $mutationBlockersStart1060)

$mutationNoteExact1060 = 'IRQ runtime hardware mutation note\nscope: {}\nmutation inputs: {}\nhardware mutation ready: {}\nactivation decision: {}\nruntime irq active: {}\n'
$mutationStatusExact1060 = 'IRQ runtime hardware mutation readiness\nhardware mutation ready: {}\nactivation decision: {}\nfinal activation allowed: {}\nruntime irq active: {}\nsti mutation: {}\npic unmask mutation: {}\neoi dispatch mutation: {}\nidt live bind mutation: {}\nkeyboard irq mutation: {}\n'
$mutationBlockersExact1060 = 'IRQ runtime hardware mutation blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nhardware mutation ready: {}\n'
Assert-Contains $mutationNotePrintBlock1060 $mutationNoteExact1060 "v10.6.0 mutation note exact output"
Assert-Contains $mutationStatusPrintBlock1060 $mutationStatusExact1060 "v10.6.0 mutation status/check exact output"
Assert-Contains $mutationBlockersPrintBlock1060 $mutationBlockersExact1060 "v10.6.0 mutation blockers exact output"
Assert-Contains $mutationNoteBlock1060 'print_irq_runtime_mutation_note();' "v10.6.0 mutation note dispatcher calls print helper"
Assert-Contains $mutationStatusBlock1060 'print_irq_runtime_mutation_status();' "v10.6.0 mutation status dispatcher calls print helper"
Assert-Contains $mutationCheckBlock1060 'print_irq_runtime_mutation_status();' "v10.6.0 mutation check dispatcher calls status helper"
Assert-Contains $mutationBlockersBlock1060 'print_irq_runtime_mutation_blockers();' "v10.6.0 mutation blockers dispatcher calls print helper"

Assert-ContainsInOrder $mutationSnapshotBlock1060 @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
...
) "v10.6.0 mutation reader ordering"

$expectedQemuMutationNote1060 = "IRQ runtime hardware mutation note`n    scope: controlled hardware mutation readiness checklist`n    mutation inputs: decision/final-gate/activation-smoke/sti/eoi/pic-unmask/idt-bind/token/gate/matrix/keyboard`n    hardware mutation ready: no`n    activation decision: frozen blocked`n    runtime irq active: no"
$expectedQemuMutationStatus1060 = "IRQ runtime hardware mutation readiness`n    hardware mutation ready: no`n    activation decision: frozen blocked`n    final activation allowed: no`n    runtime irq active: no`n    sti mutation: disabled`n    pic unmask mutation: disabled`n    eoi dispatch mutation: disabled`n    idt live bind mutation: disabled`n    keyboard irq mutation: disabled"
$expectedQemuMutationCheck1060 = "dbyte-kernel> irq-runtime-mutation-check`n    IRQ runtime hardware mutation readiness`n    hardware mutation ready: no`n    activation decision: frozen blocked`n    final activation allowed: no`n    runtime irq active: no`n    sti mutation: disabled`n    pic unmask mutation: disabled`n    eoi dispatch mutation: disabled`n    idt live bind mutation: disabled`n    keyboard irq mutation: disabled"
$expectedQemuMutationBlockers1060 = "IRQ runtime hardware mutation blockers`n    - activation decision frozen blocked`n    - final activation disallowed`n    - runtime IRQ active state disabled`n    - STI mutation disabled`n    - PIC unmask mutation disabled`n    - EOI dispatch mutation disabled`n    - IDT live bind mutation disabled`n    - keyboard IRQ mutation disabled`n    hardware mutation ready: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationNote1060 "v10.6.0 qemu docs mutation note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationStatus1060 "v10.6.0 qemu docs mutation status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationCheck1060 "v10.6.0 qemu docs mutation check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationBlockers1060 "v10.6.0 qemu docs mutation blockers exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 'v10.6.0` is a Controlled Hardware Mutation Readiness Checklist release' "v10.6.0 qemu docs release note"
Assert-Contains $kernelIrqDocs1031 "## Controlled Hardware Mutation Readiness Checklist" "v10.6.0 irq docs mutation section"
Assert-Contains $kernelIrqDocs1031 'Hardware mutation remains not ready' "v10.6.0 irq docs mutation remains not ready"

foreach ($mutationSurface1060 in @($mutationSnapshotBlock1060, $mutationNotePrintBlock1060, $mutationStatusPrintBlock1060, $mutationBlockersPrintBlock1060, $mutationNoteBlock1060, $mutationStatusBlock1060, $mutationCheckBlock1060, $mutationBlockersBlock1060, $mutationHelperBlock1060)) {
    foreach ($blockedMutationCall1060 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $mutationSurface1060 $blockedMutationCall1060 "v10.6.0 mutation path is read-only: $blockedMutationCall1060"
    }
}

foreach ($mutationDispatchBlock1060 in @($mutationNoteBlock1060, $mutationStatusBlock1060, $mutationCheckBlock1060, $mutationBlockersBlock1060)) {
    foreach ($blockedMutationDispatcherInline1060 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $mutationDispatchBlock1060 $blockedMutationDispatcherInline1060 "v10.6.0 mutation dispatcher remains helper-only: $blockedMutationDispatcherInline1060"
    }
}

foreach ($forbiddenMutationPositive1060 in @(
    'hardware mutation ready: yes',
    'activation decision: allowed',
    'runtime irq active: yes',
    'sti mutation: enabled',
    'pic unmask mutation: enabled',
    'eoi dispatch mutation: enabled',
    'idt live bind mutation: enabled',
    'keyboard irq mutation: enabled'
)) {
    Assert-NotContains $mainContent1031 $forbiddenMutationPositive1060 "v10.6.0 forbidden positive mutation state in main: $forbiddenMutationPositive1060"
    Assert-NotContains $irrContent1031 $forbiddenMutationPositive1060 "v10.6.0 forbidden positive mutation state in irq source: $forbiddenMutationPositive1060"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenMutationPositive1060 "v10.6.0 forbidden positive mutation state in irq docs: $forbiddenMutationPositive1060"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenMutationPositive1060 "v10.6.0 forbidden positive mutation state in qemu docs: $forbiddenMutationPositive1060"
}

Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.6.0 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.6.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.6.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.6.0 Controlled Hardware Mutation Readiness Checklist verified"

# v10.6.1: Controlled Hardware Mutation Readiness Checklist Hardening
Write-Host "Verifying v10.6.1 Controlled Hardware Mutation Readiness Checklist Hardening contracts..."
$v1060Tag = & git rev-list -n 1 v10.6.0 2>$null
$v1060TagType = & git cat-file -t v10.6.0 2>$null
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.6.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.6.1 qemu docs title"
...
Assert-Contains $mainContent1031 'irq-runtime-mutation-note irq-runtime-mutation-status irq-runtime-mutation-check irq-runtime-mutation-blockers irq-runtime-mutation-sequence-note irq-runtime-mutation-sequence-status irq-runtime-mutation-sequence-plan irq-runtime-mutation-sequence-blockers' "help string includes v10.6.1 mutation commands"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-note"' "v10.6.1 mutation note dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-status"' "v10.6.1 mutation status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-check"' "v10.6.1 mutation check dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-blockers"' "v10.6.1 mutation blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeHardwareMutationChecklist' "v10.6.1 mutation checklist telemetry struct preserved"
Assert-Contains $irrContent1031 'pub fn irq_runtime_mutation_check(' "v10.6.1 mutation checklist helper preserved"
Assert-Contains $mainContent1031 'fn irq_runtime_mutation_snapshot() -> irq::IrqRuntimeHardwareMutationChecklist' "v10.6.1 shared mutation snapshot helper preserved"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_MUTATION_READY_NO: &str = "no";' "v10.6.1 mutation readiness remains no"

Assert-Contains $mutationNotePrintBlock1060 $mutationNoteExact1060 "v10.6.1 mutation note exact output preserved"
Assert-Contains $mutationStatusPrintBlock1060 $mutationStatusExact1060 "v10.6.1 mutation status exact output preserved"
Assert-Contains $mutationStatusPrintBlock1060 $mutationStatusExact1060 "v10.6.1 mutation check exact output preserved through status helper"
Assert-Contains $mutationBlockersPrintBlock1060 $mutationBlockersExact1060 "v10.6.1 mutation blockers exact output preserved"
Assert-Contains $mutationNoteBlock1060 'print_irq_runtime_mutation_note();' "v10.6.1 mutation note dispatcher calls print helper"
Assert-Contains $mutationStatusBlock1060 'print_irq_runtime_mutation_status();' "v10.6.1 mutation status dispatcher calls print helper"
Assert-Contains $mutationCheckBlock1060 'print_irq_runtime_mutation_status();' "v10.6.1 mutation check dispatcher calls status helper"
Assert-Contains $mutationBlockersBlock1060 'print_irq_runtime_mutation_blockers();' "v10.6.1 mutation blockers dispatcher calls print helper"
...
Assert-ContainsInOrder $mutationSnapshotBlock1060 @(
    ...
    'irq::irq_runtime_decision_freeze(',
    'irq::irq_runtime_mutation_check('
) "v10.6.1 mutation reader ordering"

Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationNote1060 "v10.6.1 qemu docs mutation note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationStatus1060 "v10.6.1 qemu docs mutation status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationCheck1060 "v10.6.1 qemu docs mutation check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuMutationBlockers1060 "v10.6.1 qemu docs mutation blockers exact rendered contract"

foreach ($mutationSurface1061 in @($mutationSnapshotBlock1060, $mutationNotePrintBlock1060, $mutationStatusPrintBlock1060, $mutationBlockersPrintBlock1060, $mutationNoteBlock1060, $mutationStatusBlock1060, $mutationCheckBlock1060, $mutationBlockersBlock1060, $mutationHelperBlock1060)) {
    foreach ($blockedMutationCall1061 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $mutationSurface1061 $blockedMutationCall1061 "v10.6.1 mutation path is read-only: $blockedMutationCall1061"
    }
}

foreach ($mutationDispatchBlock1061 in @($mutationNoteBlock1060, $mutationStatusBlock1060, $mutationCheckBlock1060, $mutationBlockersBlock1060)) {
    foreach ($blockedMutationDispatcherInline1061 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $mutationDispatchBlock1061 $blockedMutationDispatcherInline1061 "v10.6.1 mutation dispatcher remains helper-only: $blockedMutationDispatcherInline1061"
    }
}

foreach ($forbiddenMutationPositive1061 in @(
    'hardware mutation ready: yes',
    'activation decision: allowed',
    'runtime irq active: yes',
    'sti mutation: enabled',
    ...
    Assert-NotContains $mainContent1031 $forbiddenMutationPositive1061 "v10.6.1 forbidden positive mutation state in main: $forbiddenMutationPositive1061"
    Assert-NotContains $irrContent1031 $forbiddenMutationPositive1061 "v10.6.1 forbidden positive mutation state in irq source: $forbiddenMutationPositive1061"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenMutationPositive1061 "v10.6.1 forbidden positive mutation state in irq docs: $forbiddenMutationPositive1061"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenMutationPositive1061 "v10.6.1 forbidden positive mutation state in qemu docs: $forbiddenMutationPositive1061"
}

foreach ($literal1061 in @('0x00', '0x01', '0x02', '0x03', '0x7f', '0xfe', '0xfd')) {
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1061 + ')') "v10.6.1 no master unmask literal $literal1061 in main"
    Assert-NotContains $mainContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1061 + ')') "v10.6.1 no slave unmask literal $literal1061 in main"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_MASTER_DATA, ' + $literal1061 + ')') "v10.6.1 no master unmask literal $literal1061 in pic.rs"
    Assert-NotContains $picContent1031 ('write_pic_port(PIC_SLAVE_DATA, ' + $literal1061 + ')') "v10.6.1 no slave unmask literal $literal1061 in pic.rs"
}
Assert-NotContains $mainContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.6.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.6.1 kernel main does not dispatch slave EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.6.1 pic source does not dispatch master EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.6.1 pic source does not dispatch slave EOI"
Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.6.1 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.6.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.6.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.6.1 Controlled Hardware Mutation Readiness Checklist Hardening verified"

# v10.7.0: Controlled Mutation Smoke Sequencer Foundation
Write-Host "Verifying v10.7.0 Controlled Mutation Smoke Sequencer Foundation contracts..."
$v1061Tag = & git rev-list -n 1 v10.6.1 2>$null
$v1061TagType = & git cat-file -t v10.6.1 2>$null
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.7.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.7.0 qemu docs title"
...
Assert-Contains $mainContent1031 'irq-runtime-mutation-sequence-note irq-runtime-mutation-sequence-status irq-runtime-mutation-sequence-plan irq-runtime-mutation-sequence-blockers' "help string includes v10.7.0 mutation sequence commands"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-sequence-note"' "v10.7.0 mutation sequence note dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-sequence-status"' "v10.7.0 mutation sequence status dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-sequence-plan"' "v10.7.0 mutation sequence plan dispatcher"
Assert-Contains $mainContent1031 'line_str == "irq-runtime-mutation-sequence-blockers"' "v10.7.0 mutation sequence blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct IrqRuntimeMutationSmokeSequence' "v10.7.0 mutation sequence telemetry struct"
Assert-Contains $irrContent1031 'pub fn irq_runtime_mutation_sequence(' "v10.7.0 mutation sequence helper"
Assert-Contains $mainContent1031 'fn irq_runtime_mutation_sequence_snapshot() -> irq::IrqRuntimeMutationSmokeSequence' "v10.7.0 shared mutation sequence snapshot helper"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_MUTATION_SEQUENCE_READY_NO: &str = "no";' "v10.7.0 mutation sequence readiness remains no"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_MUTATION_SEQUENCE_NEXT_NONE: &str = "none";' "v10.7.0 mutation sequence next step remains none"
Assert-Contains $irrContent1031 'pub const IRQ_RUNTIME_MUTATION_SEQUENCE_ALLOWED_NONE: &str = "none";' "v10.7.0 mutation sequence allowed steps remain none"
...
$sequenceNoteBlock1070 = $mainContent1031.Substring($sequenceNoteStart1070, $sequenceStatusStart1070 - $sequenceNoteStart1070)
$sequenceStatusBlock1070 = $mainContent1031.Substring($sequenceStatusStart1070, $sequencePlanStart1070 - $sequenceStatusStart1070)
$sequencePlanBlock1070 = $mainContent1031.Substring($sequencePlanStart1070, $sequenceBlockersStart1070 - $sequencePlanStart1070)
$sequenceBlockersBlock1070 = $mainContent1031.Substring($sequenceBlockersStart1070, $sequenceEnd1070 - $sequenceBlockersStart1070)

$sequenceNoteExact1070 = 'IRQ runtime mutation smoke sequence note\nscope: {}\nsequence inputs: {}\nmutation sequence ready: {}\nnext mutation step: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$sequenceStatusExact1070 = 'IRQ runtime mutation smoke sequence\nmutation sequence ready: {}\nhardware mutation: {}\nruntime irq active: {}\nnext mutation step: {}\nallowed mutation steps: {}\nsti: {}\npic unmask: {}\neoi dispatch: {}\nlive idt bind: {}\nkeyboard mode: {}\n'
$sequenceBlockersExact1070 = 'IRQ runtime mutation smoke sequence blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nmutation sequence ready: {}\n'
Assert-Contains $sequenceNotePrintBlock1070 $sequenceNoteExact1070 "v10.7.0 mutation sequence note exact output"
Assert-Contains $sequenceStatusPrintBlock1070 $sequenceStatusExact1070 "v10.7.0 mutation sequence status/plan exact output"
Assert-Contains $sequenceBlockersPrintBlock1070 $sequenceBlockersExact1070 "v10.7.0 mutation sequence blockers exact output"
Assert-Contains $sequenceNoteBlock1070 'print_irq_runtime_mutation_sequence_note();' "v10.7.0 mutation sequence note dispatcher calls print helper"
Assert-Contains $sequenceStatusBlock1070 'print_irq_runtime_mutation_sequence_status();' "v10.7.0 mutation sequence status dispatcher calls print helper"
Assert-Contains $sequencePlanBlock1070 'print_irq_runtime_mutation_sequence_status();' "v10.7.0 mutation sequence plan dispatcher calls status helper"
Assert-Contains $sequenceBlockersBlock1070 'print_irq_runtime_mutation_sequence_blockers();' "v10.7.0 mutation sequence blockers dispatcher calls print helper"

Assert-ContainsInOrder $sequenceSnapshotBlock1070 @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
...
) "v10.7.0 mutation sequence reader ordering"

$expectedQemuSequenceNote1070 = "IRQ runtime mutation smoke sequence note`n    scope: controlled mutation smoke sequencer`n    sequence inputs: mutation-checklist/decision/final-gate/activation-smoke/sti/eoi/pic-unmask/idt-bind/token/gate/matrix/keyboard`n    mutation sequence ready: no`n    next mutation step: none`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuSequenceStatus1070 = "IRQ runtime mutation smoke sequence`n    mutation sequence ready: no`n    hardware mutation: no`n    runtime irq active: no`n    next mutation step: none`n    allowed mutation steps: none`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling"
$expectedQemuSequencePlan1070 = "dbyte-kernel> irq-runtime-mutation-sequence-plan`n    IRQ runtime mutation smoke sequence`n    mutation sequence ready: no`n    hardware mutation: no`n    runtime irq active: no`n    next mutation step: none`n    allowed mutation steps: none`n    sti: disabled`n    pic unmask: disabled`n    eoi dispatch: disabled`n    live idt bind: no`n    keyboard mode: polling"
$expectedQemuSequenceBlockers1070 = "IRQ runtime mutation smoke sequence blockers`n    - activation decision frozen blocked`n    - final activation disallowed`n    - hardware mutation checklist not ready`n    - runtime IRQ active state disabled`n    - STI disabled`n    - PIC unmask disabled`n    - EOI dispatch disabled`n    - live IDT bind disabled`n    - keyboard mode polling`n    mutation sequence ready: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuSequenceNote1070 "v10.7.0 qemu docs mutation sequence note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuSequenceStatus1070 "v10.7.0 qemu docs mutation sequence status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuSequencePlan1070 "v10.7.0 qemu docs mutation sequence plan exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuSequenceBlockers1070 "v10.7.0 qemu docs mutation sequence blockers exact rendered contract"

foreach ($sequenceSurface1070 in @($sequenceSnapshotBlock1070, $sequenceNotePrintBlock1070, $sequenceStatusPrintBlock1070, $sequenceBlockersPrintBlock1070, $sequenceNoteBlock1070, $sequenceStatusBlock1070, $sequencePlanBlock1070, $sequenceBlockersBlock1070, $sequenceHelperBlock1070)) {
    foreach ($blockedSequenceCall1070 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $sequenceSurface1070 $blockedSequenceCall1070 "v10.7.0 mutation sequence path is read-only: $blockedSequenceCall1070"
    }
}

foreach ($sequenceDispatchBlock1070 in @($sequenceNoteBlock1070, $sequenceStatusBlock1070, $sequencePlanBlock1070, $sequenceBlockersBlock1070)) {
    foreach ($blockedSequenceDispatcherInline1070 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $sequenceDispatchBlock1070 $blockedSequenceDispatcherInline1070 "v10.7.0 mutation sequence dispatcher remains helper-only: $blockedSequenceDispatcherInline1070"
    }
}

foreach ($forbiddenSequencePositive1070 in @(
    'mutation sequence ready: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'next mutation step: idt',
    'next mutation step: eoi',
    'next mutation step: pic',
    'next mutation step: sti',
    'allowed mutation steps: idt',
    'allowed mutation steps: eoi',
    'allowed mutation steps: pic',
    'allowed mutation steps: sti',
    'sti: enabled',
    'pic unmask: enabled',
    'eoi dispatch: enabled',
    'live idt bind: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenSequencePositive1070 "v10.7.0 forbidden positive mutation sequence state in main: $forbiddenSequencePositive1070"
    Assert-NotContains $irrContent1031 $forbiddenSequencePositive1070 "v10.7.0 forbidden positive mutation sequence state in irq source: $forbiddenSequencePositive1070"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenSequencePositive1070 "v10.7.0 forbidden positive mutation sequence state in irq docs: $forbiddenSequencePositive1070"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenSequencePositive1070 "v10.7.0 forbidden positive mutation sequence state in qemu docs: $forbiddenSequencePositive1070"
}

Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.7.0 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.7.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.7.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.7.0 Controlled Mutation Smoke Sequencer Foundation verified"

# v10.7.1: Controlled Mutation Smoke Sequencer Hardening
Write-Host "Verifying v10.7.1 Controlled Mutation Smoke Sequencer Hardening contracts..."
$v1070Tag = & git rev-list -n 1 v10.7.0 2>$null
$v1070TagType = & git cat-file -t v10.7.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.7.1"
Assert-NotContains $cargoContent1031 'version = "10.7.0"' "kernel-lab stale v10.7.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.7.1"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.7.0"' "kernel-lab stale v10.7.0 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.7.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.7.1 qemu docs title"
...
Assert-Contains $sequenceNotePrintBlock1070 $sequenceNoteExact1070 "v10.7.1 mutation sequence note exact output"
Assert-Contains $sequenceStatusPrintBlock1070 $sequenceStatusExact1070 "v10.7.1 mutation sequence status exact output"
Assert-Contains $sequenceStatusPrintBlock1070 $sequenceStatusExact1070 "v10.7.1 mutation sequence plan exact output"
Assert-Contains $sequenceBlockersPrintBlock1070 $sequenceBlockersExact1070 "v10.7.1 mutation sequence blockers exact output"
Assert-Contains $sequenceNoteBlock1070 'print_irq_runtime_mutation_sequence_note();' "v10.7.1 mutation sequence note dispatcher calls print helper"
Assert-Contains $sequenceStatusBlock1070 'print_irq_runtime_mutation_sequence_status();' "v10.7.1 mutation sequence status dispatcher calls print helper"
Assert-Contains $sequencePlanBlock1070 'print_irq_runtime_mutation_sequence_status();' "v10.7.1 mutation sequence plan dispatcher calls status helper"
Assert-Contains $sequenceBlockersBlock1070 'print_irq_runtime_mutation_sequence_blockers();' "v10.7.1 mutation sequence blockers dispatcher calls print helper"
...
Assert-ContainsInOrder $sequenceSnapshotBlock1070 $sequenceReaders1071 "v10.7.1 mutation sequence reader ordering"
foreach ($sequenceReader1071 in $sequenceReaders1071) {
    $readerCount1071 = [regex]::Matches($sequenceSnapshotBlock1070, [regex]::Escape($sequenceReader1071)).Count
    if ($readerCount1071 -ne 1) {
        throw "v10.7.1 mutation sequence reader count changed for '$sequenceReader1071': expected 1, got $readerCount1071"
    }
}

foreach ($sequenceSurface1071 in @($sequenceSnapshotBlock1070, $sequenceNotePrintBlock1070, $sequenceStatusPrintBlock1070, $sequenceBlockersPrintBlock1070, $sequenceNoteBlock1070, $sequenceStatusBlock1070, $sequencePlanBlock1070, $sequenceBlockersBlock1070, $sequenceHelperBlock1070)) {
    foreach ($blockedSequenceCall1071 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $sequenceSurface1071 $blockedSequenceCall1071 "v10.7.1 mutation sequence path is read-only: $blockedSequenceCall1071"
    }
}

foreach ($sequenceDispatchBlock1071 in @($sequenceNoteBlock1070, $sequenceStatusBlock1070, $sequencePlanBlock1070, $sequenceBlockersBlock1070)) {
    foreach ($blockedSequenceDispatcherInline1071 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $sequenceDispatchBlock1071 $blockedSequenceDispatcherInline1071 "v10.7.1 mutation sequence dispatcher remains helper-only: $blockedSequenceDispatcherInline1071"
    }
}

Assert-NotContains $mainContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.7.1 kernel main does not dispatch master EOI"
Assert-NotContains $mainContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.7.1 kernel main does not dispatch slave EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_MASTER_CMD, PIC_EOI)' "v10.7.1 pic source does not dispatch master EOI"
Assert-NotContains $picContent1031 'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)' "v10.7.1 pic source does not dispatch slave EOI"
Assert-NotContains $mainContent1031 'timer_interrupt_handler_stub' "v10.7.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1031 'keyboard_interrupt_handler_stub' "v10.7.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1031 'timer_irq' "v10.7.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1031 'keyboard_irq' "v10.7.1 kernel main has no keyboard IRQ activation path"

foreach ($forbiddenSequencePositive1071 in @(
    'mutation sequence ready: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'next mutation step: idt',
    ...
    Assert-NotContains $mainContent1031 $forbiddenSequencePositive1071 "v10.7.1 forbidden positive mutation sequence state in main: $forbiddenSequencePositive1071"
    Assert-NotContains $irrContent1031 $forbiddenSequencePositive1071 "v10.7.1 forbidden positive mutation sequence state in irq source: $forbiddenSequencePositive1071"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenSequencePositive1071 "v10.7.1 forbidden positive mutation sequence state in irq docs: $forbiddenSequencePositive1071"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenSequencePositive1071 "v10.7.1 forbidden positive mutation sequence state in qemu docs: $forbiddenSequencePositive1071"
}

Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.7.1 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.7.1 keyboard status polling remains PS/2 read"
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.8.0"
Assert-NotContains $cargoContent1031 'version = "10.7.1"' "kernel-lab stale v10.7.1 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.8.0"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.7.1"' "kernel-lab stale v10.7.1 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.8.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.8.0 qemu docs title"
...
$eoiWriteCandidateSnapshotStartForPreflight1080 = $mainContent1031.IndexOf('fn eoi_write_smoke_candidate_snapshot()')
...
if ($eoiWriteCandidateSnapshotStartForPreflight1080 -lt 0) { $eoiWriteCandidateSnapshotStartForPreflight1080 = $eoiWriteNotePrintStart1080 }
if ($eoiWriteSnapshotStart1080 -lt 0 -or $eoiWriteCandidateSnapshotStartForPreflight1080 -lt $eoiWriteSnapshotStart1080 -or $eoiWriteNotePrintStart1080 -lt $eoiWriteCandidateSnapshotStartForPreflight1080 -or $eoiWriteStatusPrintStart1080 -lt $eoiWriteNotePrintStart1080 -or $eoiWriteBlockersPrintStart1080 -lt $eoiWriteStatusPrintStart1080 -or $kernelMainStart1080 -lt $eoiWriteBlockersPrintStart1080) {
    throw "v10.8.0 eoi write preflight helper/print isolation failed"
}
$eoiWriteSnapshotBlock1080 = $mainContent1031.Substring($eoiWriteSnapshotStart1080, $eoiWriteCandidateSnapshotStartForPreflight1080 - $eoiWriteSnapshotStart1080)
...
# v10.8.1: Controlled EOI Write Smoke Preflight Hardening
Write-Host "Verifying v10.8.1 Controlled EOI Write Smoke Preflight Hardening contracts..."
$v1080Tag = & git rev-list -n 1 v10.8.0 2>$null
$v1080TagType = & git cat-file -t v10.8.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.8.1"
Assert-NotContains $cargoContent1031 'version = "10.8.0"' "kernel-lab stale v10.8.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.8.1"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.8.0"' "kernel-lab stale v10.8.0 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.8.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.8.1 qemu docs title"
...
Assert-Contains $eoiWriteNotePrintBlock1080 $eoiWriteNoteExact1080 "v10.8.1 eoi write preflight note exact output"
Assert-Contains $eoiWriteStatusPrintBlock1080 $eoiWriteStatusExact1080 "v10.8.1 eoi write preflight status exact output"
Assert-Contains $eoiWriteStatusPrintBlock1080 $eoiWriteStatusExact1080 "v10.8.1 eoi write preflight check exact output"
Assert-Contains $eoiWriteBlockersPrintBlock1080 $eoiWriteBlockersExact1080 "v10.8.1 eoi write preflight blockers exact output"
Assert-Contains $eoiWriteNoteBlock1080 'print_eoi_write_smoke_preflight_note();' "v10.8.1 eoi write preflight note dispatcher calls print helper"
Assert-Contains $eoiWriteStatusBlock1080 'print_eoi_write_smoke_preflight_status();' "v10.8.1 eoi write preflight status dispatcher calls print helper"
Assert-Contains $eoiWriteCheckBlock1080 'print_eoi_write_smoke_preflight_status();' "v10.8.1 eoi write preflight check dispatcher calls status helper"
Assert-Contains $eoiWriteBlockersBlock1080 'print_eoi_write_smoke_preflight_blockers();' "v10.8.1 eoi write preflight blockers dispatcher calls print helper"

Assert-ContainsInOrder $eoiWriteSnapshotBlock1080 $eoiWriteReaders1080 "v10.8.1 eoi write preflight reader ordering"
foreach ($eoiWriteReader1081 in $eoiWriteReaders1080) {
    $readerCount1081 = [regex]::Matches($eoiWriteSnapshotBlock1080, [regex]::Escape($eoiWriteReader1081)).Count
    if ($readerCount1081 -ne 1) {
        throw "v10.8.1 eoi write preflight reader count changed for '$eoiWriteReader1081': expected 1, got $readerCount1081"
    }
}

foreach ($eoiWriteSurface1081 in @($eoiWriteSnapshotBlock1080, $eoiWriteNoteBlock1080, $eoiWriteStatusBlock1080, $eoiWriteCheckBlock1080, $eoiWriteBlockersBlock1080, $eoiWriteHelperBlock1080)) {
    foreach ($blockedEoiWriteCall1081 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $eoiWriteSurface1081 $blockedEoiWriteCall1081 "v10.8.1 eoi write preflight path is read-only: $blockedEoiWriteCall1081"
    }
}

foreach ($eoiWritePrintBlock1081 in @($eoiWriteNotePrintBlock1080, $eoiWriteStatusPrintBlock1080, $eoiWriteBlockersPrintBlock1080)) {
    foreach ($blockedEoiWritePrintCall1081 in @('set_handler(', 'write_pic_port(', 'outb(', 'asm!("sti")', 'irq_runtime_commit', 'irq_runtime_arm', 'keyboard_irq')) {
        Assert-NotContains $eoiWritePrintBlock1081 $blockedEoiWritePrintCall1081 "v10.8.1 eoi write preflight print path is read-only: $blockedEoiWritePrintCall1081"
    }
}

foreach ($eoiWriteDispatchBlock1081 in @($eoiWriteNoteBlock1080, $eoiWriteStatusBlock1080, $eoiWriteCheckBlock1080, $eoiWriteBlockersBlock1080)) {
    foreach ($blockedEoiWriteDispatcherInline1081 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $eoiWriteDispatchBlock1081 $blockedEoiWriteDispatcherInline1081 "v10.8.1 eoi write preflight dispatcher remains helper-only: $blockedEoiWriteDispatcherInline1081"
    }
}

Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteNote1080 "v10.8.1 qemu docs eoi write preflight note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteStatus1080 "v10.8.1 qemu docs eoi write preflight status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCheck1080 "v10.8.1 qemu docs eoi write preflight check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteBlockers1080 "v10.8.1 qemu docs eoi write preflight blockers exact rendered contract"

foreach ($activeEoiWrite1081 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite1081 "v10.8.1 no active EOI write in main: $activeEoiWrite1081"
    Assert-NotContains $picContent1031 $activeEoiWrite1081 "v10.8.1 no active EOI write in pic source: $activeEoiWrite1081"
    Assert-NotContains $irrContent1031 $activeEoiWrite1081 "v10.8.1 no active EOI write in irq source: $activeEoiWrite1081"
}

Assert-NotContains $mainContent1031 'timer_interrupt_handler_stub' "v10.8.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1031 'keyboard_interrupt_handler_stub' "v10.8.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1031 'timer_irq' "v10.8.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1031 'keyboard_irq' "v10.8.1 kernel main has no keyboard IRQ activation path"

foreach ($forbiddenEoiWritePositive1081 in @(
    'first PIC_EOI write allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    'eoi dispatch: enabled',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWritePositive1081 "v10.8.1 forbidden positive eoi write preflight state in main: $forbiddenEoiWritePositive1081"
    Assert-NotContains $irrContent1031 $forbiddenEoiWritePositive1081 "v10.8.1 forbidden positive eoi write preflight state in irq source: $forbiddenEoiWritePositive1081"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWritePositive1081 "v10.8.1 forbidden positive eoi write preflight state in irq docs: $forbiddenEoiWritePositive1081"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWritePositive1081 "v10.8.1 forbidden positive eoi write preflight state in qemu docs: $forbiddenEoiWritePositive1081"
}

Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.8.1 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.8.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.8.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.8.1 Controlled EOI Write Smoke Preflight Hardening verified"

# v10.9.0: First Controlled EOI Write Smoke Candidate
Write-Host "Verifying v10.9.0 First Controlled EOI Write Smoke Candidate contracts..."
$v1081Tag = & git rev-list -n 1 v10.8.1 2>$null
$v1081TagType = & git cat-file -t v10.8.1 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.9.0"
Assert-NotContains $cargoContent1031 'version = "10.8.1"' "kernel-lab stale v10.8.1 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.9.0"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.8.1"' "kernel-lab stale v10.8.1 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.9.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.9.0 qemu docs title"
...
Assert-Contains $mainContent1031 'eoi-write-smoke-candidate-note eoi-write-smoke-candidate-status eoi-write-smoke-candidate-arm eoi-write-smoke-candidate-fire eoi-write-smoke-candidate-blockers' "help string includes v10.9.0 eoi write smoke candidate commands"
Assert-Contains $mainContent1031 'line_str == "eoi-write-smoke-candidate-note"' "v10.9.0 eoi write smoke candidate note dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-smoke-candidate-status"' "v10.9.0 eoi write smoke candidate status dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-smoke-candidate-arm"' "v10.9.0 eoi write smoke candidate arm dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-smoke-candidate-fire"' "v10.9.0 eoi write smoke candidate fire dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-smoke-candidate-blockers"' "v10.9.0 eoi write smoke candidate blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct EoiWriteSmokeCandidate' "v10.9.0 eoi write smoke candidate telemetry struct"
Assert-Contains $irrContent1031 'pub fn eoi_write_smoke_candidate(' "v10.9.0 eoi write smoke candidate helper"
Assert-Contains $mainContent1031 'fn eoi_write_smoke_candidate_snapshot() -> irq::EoiWriteSmokeCandidate' "v10.9.0 shared eoi write candidate snapshot helper"

$eoiWriteCandidateHelperStart1090 = $irrContent1031.IndexOf('pub fn eoi_write_smoke_candidate(')
if ($eoiWriteCandidateHelperStart1090 -lt 0) { throw "v10.9.0 eoi write candidate helper isolation failed" }
$eoiWriteCandidateHelperBlock1090 = $irrContent1031.Substring($eoiWriteCandidateHelperStart1090)
$eoiWriteCandidateSnapshotStart1090 = $mainContent1031.IndexOf('fn eoi_write_smoke_candidate_snapshot()')
$eoiWritePermitSnapshotStart10100 = $mainContent1031.IndexOf('fn eoi_write_permit_model_snapshot()')
$eoiWriteCandidateSnapshotEnd1090 = $eoiWritePermitSnapshotStart10100
$eoiWriteCandidateNotePrintStart1090 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_candidate_note()')
$eoiWriteCandidateStatusPrintStart1090 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_candidate_status()')
$eoiWriteCandidateFirePrintStart1090 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_candidate_fire()')
$eoiWriteCandidateBlockersPrintStart1090 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_candidate_blockers()')
$kernelMainStart1090 = $mainContent1031.IndexOf('pub extern "C" fn kernel_main()')
if ($eoiWriteCandidateSnapshotStart1090 -lt 0 -or $eoiWriteCandidateSnapshotEnd1090 -lt $eoiWriteCandidateSnapshotStart1090 -or $eoiWriteCandidateNotePrintStart1090 -lt $eoiWriteCandidateSnapshotEnd1090 -or $eoiWriteCandidateStatusPrintStart1090 -lt $eoiWriteCandidateNotePrintStart1090 -or $eoiWriteCandidateFirePrintStart1090 -lt $eoiWriteCandidateStatusPrintStart1090 -or $eoiWriteCandidateBlockersPrintStart1090 -lt $eoiWriteCandidateFirePrintStart1090 -or $kernelMainStart1090 -lt $eoiWriteCandidateBlockersPrintStart1090) {
    throw "v10.9.0 eoi write candidate helper/print isolation failed"
}
$eoiWriteCandidateSnapshotBlock1090 = $mainContent1031.Substring($eoiWriteCandidateSnapshotStart1090, $eoiWriteCandidateSnapshotEnd1090 - $eoiWriteCandidateSnapshotStart1090)
$eoiWriteCandidateNotePrintBlock1090 = $mainContent1031.Substring($eoiWriteCandidateNotePrintStart1090, $eoiWriteCandidateStatusPrintStart1090 - $eoiWriteCandidateNotePrintStart1090)
$eoiWriteCandidateStatusPrintBlock1090 = $mainContent1031.Substring($eoiWriteCandidateStatusPrintStart1090, $eoiWriteCandidateFirePrintStart1090 - $eoiWriteCandidateStatusPrintStart1090)
$eoiWriteCandidateFirePrintBlock1090 = $mainContent1031.Substring($eoiWriteCandidateFirePrintStart1090, $eoiWriteCandidateBlockersPrintStart1090 - $eoiWriteCandidateFirePrintStart1090)
$eoiWriteCandidateBlockersPrintBlock1090 = $mainContent1031.Substring($eoiWriteCandidateBlockersPrintStart1090, $kernelMainStart1090 - $eoiWriteCandidateBlockersPrintStart1090)
$eoiWriteCandidateNoteStart1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-smoke-candidate-note" {')
$eoiWriteCandidateStatusStart1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-smoke-candidate-status" {')
$eoiWriteCandidateArmStart1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-smoke-candidate-arm" {')
$eoiWriteCandidateFireStart1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-smoke-candidate-fire" {')
$eoiWriteCandidateBlockersStart1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-smoke-candidate-blockers" {')
$eoiWriteCandidateEnd1090 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiWriteCandidateBlockersStart1090)
if ($eoiWriteCandidateNoteStart1090 -lt 0 -or $eoiWriteCandidateStatusStart1090 -lt $eoiWriteCandidateNoteStart1090 -or $eoiWriteCandidateArmStart1090 -lt $eoiWriteCandidateStatusStart1090 -or $eoiWriteCandidateFireStart1090 -lt $eoiWriteCandidateArmStart1090 -or $eoiWriteCandidateBlockersStart1090 -lt $eoiWriteCandidateFireStart1090 -or $eoiWriteCandidateEnd1090 -lt $eoiWriteCandidateBlockersStart1090) {
    throw "v10.9.0 eoi write candidate command block isolation failed"
}
$eoiWriteCandidateNoteBlock1090 = $mainContent1031.Substring($eoiWriteCandidateNoteStart1090, $eoiWriteCandidateStatusStart1090 - $eoiWriteCandidateNoteStart1090)
$eoiWriteCandidateStatusBlock1090 = $mainContent1031.Substring($eoiWriteCandidateStatusStart1090, $eoiWriteCandidateArmStart1090 - $eoiWriteCandidateStatusStart1090)
$eoiWriteCandidateArmBlock1090 = $mainContent1031.Substring($eoiWriteCandidateArmStart1090, $eoiWriteCandidateFireStart1090 - $eoiWriteCandidateArmStart1090)
$eoiWriteCandidateFireBlock1090 = $mainContent1031.Substring($eoiWriteCandidateFireStart1090, $eoiWriteCandidateBlockersStart1090 - $eoiWriteCandidateFireStart1090)
$eoiWriteCandidateBlockersBlock1090 = $mainContent1031.Substring($eoiWriteCandidateBlockersStart1090, $eoiWriteCandidateEnd1090 - $eoiWriteCandidateBlockersStart1090)

$eoiWriteCandidateNoteExact1090 = 'EOI write smoke candidate note\nscope: {}\ncandidate inputs: {}\neoi write smoke candidate: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteCandidateStatusExact1090 = 'EOI write smoke candidate\neoi write smoke candidate: {}\ncandidate armed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\ntarget command port: {}\ntarget irq line: {}\neoi dispatch: {}\nsti: {}\npic unmask: {}\nlive idt bind: {}\nkeyboard mode: {}\n'
$eoiWriteCandidateFireExact1090 = 'EOI write smoke candidate fire\nfire result: {}\nfirst PIC_EOI write performed: {}\ntarget command port: {}\ntarget irq line: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteCandidateBlockersExact1090 = 'EOI write smoke candidate blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nfirst PIC_EOI write performed: {}\n'
Assert-Contains $eoiWriteCandidateNotePrintBlock1090 $eoiWriteCandidateNoteExact1090 "v10.9.0 eoi write candidate note exact output"
Assert-Contains $eoiWriteCandidateStatusPrintBlock1090 $eoiWriteCandidateStatusExact1090 "v10.9.0 eoi write candidate status/arm exact output"
Assert-Contains $eoiWriteCandidateFirePrintBlock1090 $eoiWriteCandidateFireExact1090 "v10.9.0 eoi write candidate fire exact output"
Assert-Contains $eoiWriteCandidateBlockersPrintBlock1090 $eoiWriteCandidateBlockersExact1090 "v10.9.0 eoi write candidate blockers exact output"
Assert-Contains $eoiWriteCandidateNoteBlock1090 'print_eoi_write_smoke_candidate_note();' "v10.9.0 eoi write candidate note dispatcher calls print helper"
Assert-Contains $eoiWriteCandidateStatusBlock1090 'print_eoi_write_smoke_candidate_status();' "v10.9.0 eoi write candidate status dispatcher calls print helper"
Assert-Contains $eoiWriteCandidateArmBlock1090 'print_eoi_write_smoke_candidate_status();' "v10.9.0 eoi write candidate arm dispatcher calls status helper"
Assert-Contains $eoiWriteCandidateFireBlock1090 'print_eoi_write_smoke_candidate_fire();' "v10.9.0 eoi write candidate fire dispatcher calls fire helper"
Assert-Contains $eoiWriteCandidateBlockersBlock1090 'print_eoi_write_smoke_candidate_blockers();' "v10.9.0 eoi write candidate blockers dispatcher calls print helper"

$eoiWriteCandidateReaders1090 = @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    'irq::irq_runtime_mutation_sequence(',
    'irq::eoi_write_smoke_preflight(',
    'irq::eoi_write_smoke_candidate('
)
Assert-ContainsInOrder $eoiWriteCandidateSnapshotBlock1090 $eoiWriteCandidateReaders1090 "v10.9.0 eoi write candidate reader ordering"
foreach ($eoiWriteCandidateReader1090 in $eoiWriteCandidateReaders1090) {
    $readerCount1090 = [regex]::Matches($eoiWriteCandidateSnapshotBlock1090, [regex]::Escape($eoiWriteCandidateReader1090)).Count
    if ($readerCount1090 -ne 1) {
        throw "v10.9.0 eoi write candidate reader count changed for '$eoiWriteCandidateReader1090': expected 1, got $readerCount1090"
    }
}

foreach ($eoiWriteCandidateSurface1090 in @($eoiWriteCandidateSnapshotBlock1090, $eoiWriteCandidateNoteBlock1090, $eoiWriteCandidateStatusBlock1090, $eoiWriteCandidateArmBlock1090, $eoiWriteCandidateFireBlock1090, $eoiWriteCandidateBlockersBlock1090, $eoiWriteCandidateHelperBlock1090)) {
    foreach ($blockedEoiWriteCandidateCall1090 in @(
        'set_handler(',
        'write_pic_port(',
        'outb(',
        'irq_gate_bind_smoke_mark_bound()',
        ...
        Assert-NotContains $eoiWriteCandidateSurface1090 $blockedEoiWriteCandidateCall1090 "v10.9.0 eoi write candidate path is read-only: $blockedEoiWriteCandidateCall1090"
    }
}

foreach ($eoiWriteCandidatePrintBlock1090 in @($eoiWriteCandidateNotePrintBlock1090, $eoiWriteCandidateStatusPrintBlock1090, $eoiWriteCandidateFirePrintBlock1090, $eoiWriteCandidateBlockersPrintBlock1090)) {
    foreach ($blockedEoiWriteCandidatePrintCall1090 in @('set_handler(', 'write_pic_port(', 'outb(', 'asm!("sti")', 'irq_runtime_commit', 'irq_runtime_arm', 'keyboard_irq')) {
        Assert-NotContains $eoiWriteCandidatePrintBlock1090 $blockedEoiWriteCandidatePrintCall1090 "v10.9.0 eoi write candidate print path is read-only: $blockedEoiWriteCandidatePrintCall1090"
    }
}

foreach ($eoiWriteCandidateDispatchBlock1090 in @($eoiWriteCandidateNoteBlock1090, $eoiWriteCandidateStatusBlock1090, $eoiWriteCandidateArmBlock1090, $eoiWriteCandidateFireBlock1090, $eoiWriteCandidateBlockersBlock1090)) {
    foreach ($blockedEoiWriteCandidateDispatcherInline1090 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(')) {
        Assert-NotContains $eoiWriteCandidateDispatchBlock1090 $blockedEoiWriteCandidateDispatcherInline1090 "v10.9.0 eoi write candidate dispatcher remains helper-only: $blockedEoiWriteCandidateDispatcherInline1090"
    }
}

$expectedQemuEoiWriteCandidateNote1090 = "EOI write smoke candidate note`n    scope: first controlled PIC_EOI write smoke candidate`n    candidate inputs: eoi-write-preflight/mutation-sequence/mutation-checklist/decision/final-gate/eoi-dispatch/pic-unmask/idt-bind/sti/keyboard`n    eoi write smoke candidate: blocked`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteCandidateStatus1090 = "EOI write smoke candidate`n    eoi write smoke candidate: blocked`n    candidate armed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no`n    target command port: none`n    target irq line: none`n    eoi dispatch: disabled`n    sti: disabled`n    pic unmask: disabled`n    live idt bind: no`n    keyboard mode: polling"
$expectedQemuEoiWriteCandidateArm1090 = "dbyte-kernel> eoi-write-smoke-candidate-arm`n    EOI write smoke candidate`n    eoi write smoke candidate: blocked`n    candidate armed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no`n    target command port: none`n    target irq line: none`n    eoi dispatch: disabled`n    sti: disabled`n    pic unmask: disabled`n    live idt bind: no`n    keyboard mode: polling"
$expectedQemuEoiWriteCandidateFire1090 = "EOI write smoke candidate fire`n    fire result: dry-run blocked`n    first PIC_EOI write performed: no`n    target command port: none`n    target irq line: none`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteCandidateBlockers1090 = "EOI write smoke candidate blockers`n    - eoi write preflight blocked`n    - first PIC_EOI write allowed: no`n    - mutation sequence ready: no`n    - hardware mutation checklist ready: no`n    - activation decision frozen blocked`n    - final activation disallowed`n    - EOI dispatch disabled`n    - PIC unmask disabled`n    - IDT live bind disabled`n    - STI disabled`n    - keyboard mode polling`n    first PIC_EOI write performed: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateNote1090 "v10.9.0 qemu docs eoi write candidate note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateStatus1090 "v10.9.0 qemu docs eoi write candidate status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateArm1090 "v10.9.0 qemu docs eoi write candidate arm exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateFire1090 "v10.9.0 qemu docs eoi write candidate fire exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateBlockers1090 "v10.9.0 qemu docs eoi write candidate blockers exact rendered contract"

foreach ($activeEoiWrite1090 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite1090 "v10.9.0 no active EOI write in main: $activeEoiWrite1090"
    Assert-NotContains $picContent1031 $activeEoiWrite1090 "v10.9.0 no active EOI write in pic source: $activeEoiWrite1090"
    Assert-NotContains $irrContent1031 $activeEoiWrite1090 "v10.9.0 no active EOI write in irq source: $activeEoiWrite1090"
}

Assert-NotContains $mainContent1031 'timer_interrupt_handler_stub' "v10.9.0 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1031 'keyboard_interrupt_handler_stub' "v10.9.0 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1031 'timer_irq' "v10.9.0 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1031 'keyboard_irq' "v10.9.0 kernel main has no keyboard IRQ activation path"

foreach ($forbiddenEoiWriteCandidatePositive1090 in @(
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWriteCandidatePositive1090 "v10.9.0 forbidden positive eoi write candidate state in main: $forbiddenEoiWriteCandidatePositive1090"
    Assert-NotContains $irrContent1031 $forbiddenEoiWriteCandidatePositive1090 "v10.9.0 forbidden positive eoi write candidate state in irq source: $forbiddenEoiWriteCandidatePositive1090"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWriteCandidatePositive1090 "v10.9.0 forbidden positive eoi write candidate state in irq docs: $forbiddenEoiWriteCandidatePositive1090"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWriteCandidatePositive1090 "v10.9.0 forbidden positive eoi write candidate state in qemu docs: $forbiddenEoiWriteCandidatePositive1090"
}

Assert-Contains $mainContent1031 '.skip 262144           /* 256 KiB stack */' "v10.9.0 bootstrap stack remains 256 KiB"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.9.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.9.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.9.0 First Controlled EOI Write Smoke Candidate verified"

# v10.9.1: First Controlled EOI Write Smoke Candidate Hardening
Write-Host "Verifying v10.9.1 First Controlled EOI Write Smoke Candidate Hardening contracts..."
$v1090Tag = & git rev-list -n 1 v10.9.0 2>$null
$v1090TagType = & git cat-file -t v10.9.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.9.1"
Assert-NotContains $cargoContent1031 'version = "10.9.0"' "kernel-lab stale v10.9.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.9.1"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.9.0"' "kernel-lab stale v10.9.0 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.9.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.9.1 qemu docs title"
...
Assert-Contains $eoiWriteCandidateNotePrintBlock1090 $eoiWriteCandidateNoteExact1090 "v10.9.1 eoi write candidate note exact output"
Assert-Contains $eoiWriteCandidateStatusPrintBlock1090 $eoiWriteCandidateStatusExact1090 "v10.9.1 eoi write candidate status exact output"
Assert-Contains $eoiWriteCandidateStatusPrintBlock1090 $eoiWriteCandidateStatusExact1090 "v10.9.1 eoi write candidate arm exact output"
Assert-Contains $eoiWriteCandidateFirePrintBlock1090 $eoiWriteCandidateFireExact1090 "v10.9.1 eoi write candidate fire exact output"
Assert-Contains $eoiWriteCandidateBlockersPrintBlock1090 $eoiWriteCandidateBlockersExact1090 "v10.9.1 eoi write candidate blockers exact output"
Assert-Contains $eoiWriteCandidateStatusBlock1090 'print_eoi_write_smoke_candidate_status();' "v10.9.1 eoi write candidate status dispatcher calls status helper"
Assert-Contains $eoiWriteCandidateArmBlock1090 'print_eoi_write_smoke_candidate_status();' "v10.9.1 eoi write candidate arm dispatcher remains status alias"
Assert-Contains $eoiWriteCandidateFireBlock1090 'print_eoi_write_smoke_candidate_fire();' "v10.9.1 eoi write candidate fire dispatcher calls dry-run fire helper"
Assert-Contains $irrContent1031 'fire_result: EOI_WRITE_SMOKE_CANDIDATE_FIRE_DRY_RUN_BLOCKED' "v10.9.1 candidate fire remains dry-run blocked"
Assert-Contains $irrContent1031 'first_pic_eoi_write_performed: EOI_WRITE_SMOKE_CANDIDATE_WRITE_PERFORMED_NO' "v10.9.1 candidate records no first PIC_EOI write"

Assert-ContainsInOrder $eoiWriteCandidateSnapshotBlock1090 $eoiWriteCandidateReaders1090 "v10.9.1 eoi write candidate reader ordering"
foreach ($eoiWriteCandidateReader1091 in $eoiWriteCandidateReaders1090) {
    $readerCount1091 = [regex]::Matches($eoiWriteCandidateSnapshotBlock1090, [regex]::Escape($eoiWriteCandidateReader1091)).Count
    if ($readerCount1091 -ne 1) {
        throw "v10.9.1 eoi write candidate reader count changed for '$eoiWriteCandidateReader1091': expected 1, got $readerCount1091"
    }
}

foreach ($eoiWriteCandidateSurface1091 in @($eoiWriteCandidateSnapshotBlock1090, $eoiWriteCandidateNotePrintBlock1090, $eoiWriteCandidateStatusPrintBlock1090, $eoiWriteCandidateFirePrintBlock1090, $eoiWriteCandidateBlockersPrintBlock1090, $eoiWriteCandidateNoteBlock1090, $eoiWriteCandidateStatusBlock1090, $eoiWriteCandidateArmBlock1090, $eoiWriteCandidateFireBlock1090, $eoiWriteCandidateBlockersBlock1090, $eoiWriteCandidateHelperBlock1090)) {
    foreach ($blockedEoiWriteCandidateCall1091 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWriteCandidateSurface1091 $blockedEoiWriteCandidateCall1091 "v10.9.1 eoi write candidate surface is read-only: $blockedEoiWriteCandidateCall1091"
    }
}

foreach ($eoiWriteCandidateDispatchBlock1091 in @($eoiWriteCandidateNoteBlock1090, $eoiWriteCandidateStatusBlock1090, $eoiWriteCandidateArmBlock1090, $eoiWriteCandidateFireBlock1090, $eoiWriteCandidateBlockersBlock1090)) {
    foreach ($blockedEoiWriteCandidateDispatcherInline1091 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(')) {
        Assert-NotContains $eoiWriteCandidateDispatchBlock1091 $blockedEoiWriteCandidateDispatcherInline1091 "v10.9.1 eoi write candidate dispatcher remains helper-only: $blockedEoiWriteCandidateDispatcherInline1091"
    }
}

Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateNote1090 "v10.9.1 qemu docs eoi write candidate note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateStatus1090 "v10.9.1 qemu docs eoi write candidate status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateArm1090 "v10.9.1 qemu docs eoi write candidate arm exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateFire1090 "v10.9.1 qemu docs eoi write candidate fire exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteCandidateBlockers1090 "v10.9.1 qemu docs eoi write candidate blockers exact rendered contract"

foreach ($activeEoiWrite1091 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite1091 "v10.9.1 no active EOI write in main: $activeEoiWrite1091"
    Assert-NotContains $picContent1031 $activeEoiWrite1091 "v10.9.1 no active EOI write in pic source: $activeEoiWrite1091"
    Assert-NotContains $irrContent1031 $activeEoiWrite1091 "v10.9.1 no active EOI write in irq source: $activeEoiWrite1091"
}

foreach ($forbiddenEoiWriteCandidatePositive1091 in @(
    'first PIC_EOI write performed: yes',
    'candidate armed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWriteCandidatePositive1091 "v10.9.1 forbidden positive eoi write candidate state in main: $forbiddenEoiWriteCandidatePositive1091"
    Assert-NotContains $irrContent1031 $forbiddenEoiWriteCandidatePositive1091 "v10.9.1 forbidden positive eoi write candidate state in irq source: $forbiddenEoiWriteCandidatePositive1091"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWriteCandidatePositive1091 "v10.9.1 forbidden positive eoi write candidate state in irq docs: $forbiddenEoiWriteCandidatePositive1091"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWriteCandidatePositive1091 "v10.9.1 forbidden positive eoi write candidate state in qemu docs: $forbiddenEoiWriteCandidatePositive1091"
}

Assert-NotContains $mainContent1031 'timer_interrupt_handler_stub' "v10.9.1 kernel main has no live timer IRQ handler"
Assert-NotContains $mainContent1031 'keyboard_interrupt_handler_stub' "v10.9.1 kernel main has no live keyboard IRQ handler"
Assert-NotContains $mainContent1031 'timer_irq' "v10.9.1 kernel main has no timer IRQ activation path"
Assert-NotContains $mainContent1031 'keyboard_irq' "v10.9.1 kernel main has no keyboard IRQ activation path"
Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.9.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.9.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.9.1 First Controlled EOI Write Smoke Candidate Hardening verified"

# v10.10.0: Controlled EOI Write Permit Model Foundation
Write-Host "Verifying v10.10.0 Controlled EOI Write Permit Model Foundation contracts..."
$v1091Tag = & git rev-list -n 1 v10.9.1 2>$null
$v1091TagType = & git cat-file -t v10.9.1 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.10.0"
Assert-NotContains $cargoContent1031 'version = "10.9.1"' "kernel-lab stale v10.9.1 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.10.0"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.9.1"' "kernel-lab stale v10.9.1 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.10.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.10.0 qemu docs title"
...
Assert-Contains $mainContent1031 'eoi-write-permit-note eoi-write-permit-status eoi-write-permit-check eoi-write-permit-blockers' "help string includes v10.10.0 eoi write permit commands"
Assert-Contains $mainContent1031 'line_str == "eoi-write-permit-note"' "v10.10.0 eoi write permit note dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-permit-status"' "v10.10.0 eoi write permit status dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-permit-check"' "v10.10.0 eoi write permit check dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-permit-blockers"' "v10.10.0 eoi write permit blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct EoiWritePermitModel' "v10.10.0 eoi write permit telemetry struct"
Assert-Contains $irrContent1031 'pub fn eoi_write_permit_model(' "v10.10.0 eoi write permit helper"
Assert-Contains $mainContent1031 'fn eoi_write_permit_model_snapshot() -> irq::EoiWritePermitModel' "v10.10.0 shared eoi write permit snapshot helper"

$eoiWritePermitHelperStart10100 = $irrContent1031.IndexOf('pub fn eoi_write_permit_model(')
if ($eoiWritePermitHelperStart10100 -lt 0) { throw "v10.10.0 eoi write permit helper isolation failed" }
$eoiWritePermitHelperBlock10100 = $irrContent1031.Substring($eoiWritePermitHelperStart10100)
$eoiWritePermitSnapshotStart10100 = $mainContent1031.IndexOf('fn eoi_write_permit_model_snapshot()')
$eoiWritePermitSnapshotEnd10100 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_preflight_note()')
$eoiWritePermitNotePrintStart10100 = $mainContent1031.IndexOf('fn print_eoi_write_permit_note()')
$eoiWritePermitStatusPrintStart10100 = $mainContent1031.IndexOf('fn print_eoi_write_permit_status()')
$eoiWritePermitBlockersPrintStart10100 = $mainContent1031.IndexOf('fn print_eoi_write_permit_blockers()')
$kernelMainStart10100 = $mainContent1031.IndexOf('pub extern "C" fn kernel_main()')
if ($eoiWritePermitSnapshotStart10100 -lt 0 -or $eoiWritePermitSnapshotEnd10100 -lt $eoiWritePermitSnapshotStart10100 -or $eoiWritePermitNotePrintStart10100 -lt $eoiWritePermitSnapshotEnd10100 -or $eoiWritePermitStatusPrintStart10100 -lt $eoiWritePermitNotePrintStart10100 -or $eoiWritePermitBlockersPrintStart10100 -lt $eoiWritePermitStatusPrintStart10100 -or $kernelMainStart10100 -lt $eoiWritePermitBlockersPrintStart10100) {
    throw "v10.10.0 eoi write permit helper/print isolation failed"
}
$eoiWritePermitSnapshotBlock10100 = $mainContent1031.Substring($eoiWritePermitSnapshotStart10100, $eoiWritePermitSnapshotEnd10100 - $eoiWritePermitSnapshotStart10100)
$eoiWritePermitNotePrintBlock10100 = $mainContent1031.Substring($eoiWritePermitNotePrintStart10100, $eoiWritePermitStatusPrintStart10100 - $eoiWritePermitNotePrintStart10100)
$eoiWritePermitStatusPrintBlock10100 = $mainContent1031.Substring($eoiWritePermitStatusPrintStart10100, $eoiWritePermitBlockersPrintStart10100 - $eoiWritePermitStatusPrintStart10100)
$eoiWritePermitBlockersPrintBlock10100 = $mainContent1031.Substring($eoiWritePermitBlockersPrintStart10100, $kernelMainStart10100 - $eoiWritePermitBlockersPrintStart10100)
$eoiWritePermitNoteStart10100 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-permit-note" {')
$eoiWritePermitStatusStart10100 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-permit-status" {')
$eoiWritePermitCheckStart10100 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-permit-check" {')
$eoiWritePermitBlockersStart10100 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-permit-blockers" {')
$eoiWritePermitEnd10100 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiWritePermitBlockersStart10100)
if ($eoiWritePermitNoteStart10100 -lt 0 -or $eoiWritePermitStatusStart10100 -lt $eoiWritePermitNoteStart10100 -or $eoiWritePermitCheckStart10100 -lt $eoiWritePermitStatusStart10100 -or $eoiWritePermitBlockersStart10100 -lt $eoiWritePermitCheckStart10100 -or $eoiWritePermitEnd10100 -lt $eoiWritePermitBlockersStart10100) {
    throw "v10.10.0 eoi write permit command block isolation failed"
}
$eoiWritePermitNoteBlock10100 = $mainContent1031.Substring($eoiWritePermitNoteStart10100, $eoiWritePermitStatusStart10100 - $eoiWritePermitNoteStart10100)
$eoiWritePermitStatusBlock10100 = $mainContent1031.Substring($eoiWritePermitStatusStart10100, $eoiWritePermitCheckStart10100 - $eoiWritePermitStatusStart10100)
$eoiWritePermitCheckBlock10100 = $mainContent1031.Substring($eoiWritePermitCheckStart10100, $eoiWritePermitBlockersStart10100 - $eoiWritePermitCheckStart10100)
$eoiWritePermitBlockersBlock10100 = $mainContent1031.Substring($eoiWritePermitBlockersStart10100, $eoiWritePermitEnd10100 - $eoiWritePermitBlockersStart10100)

$eoiWritePermitNoteExact10100 = 'EOI write permit note\nscope: {}\npermit inputs: {}\npermit granted: {}\nfirst PIC_EOI write allowed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWritePermitStatusExact10100 = 'EOI write permit model\npermit granted: {}\nfirst PIC_EOI write allowed: {}\ntarget command port: {}\ntarget value: {}\ntarget irq line: {}\nhardware mutation: {}\nruntime irq active: {}\nfire command: {}\n'
$eoiWritePermitBlockersExact10100 = 'EOI write permit blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\npermit granted: {}\n'
Assert-Contains $eoiWritePermitNotePrintBlock10100 $eoiWritePermitNoteExact10100 "v10.10.0 eoi-write-permit-note exact output"
Assert-Contains $eoiWritePermitStatusPrintBlock10100 $eoiWritePermitStatusExact10100 "v10.10.0 eoi-write-permit-status exact output"
Assert-Contains $eoiWritePermitStatusPrintBlock10100 $eoiWritePermitStatusExact10100 "v10.10.0 eoi-write-permit-check exact output"
Assert-Contains $eoiWritePermitBlockersPrintBlock10100 $eoiWritePermitBlockersExact10100 "v10.10.0 eoi-write-permit-blockers exact output"
Assert-Contains $eoiWritePermitNoteBlock10100 'print_eoi_write_permit_note();' "v10.10.0 eoi write permit note dispatcher calls print helper"
Assert-Contains $eoiWritePermitStatusBlock10100 'print_eoi_write_permit_status();' "v10.10.0 eoi write permit status dispatcher calls status helper"
Assert-Contains $eoiWritePermitCheckBlock10100 'print_eoi_write_permit_status();' "v10.10.0 eoi write permit check dispatcher calls status helper"
Assert-Contains $eoiWritePermitBlockersBlock10100 'print_eoi_write_permit_blockers();' "v10.10.0 eoi write permit blockers dispatcher calls print helper"

$eoiWritePermitReaders10100 = @(
    'pic::ProgrammableInterruptController::pic_remap_state();',
    'irq::irq_gate_bind_state();',
    'pic::ProgrammableInterruptController::pic_mask_plan();',
    'pic::ProgrammableInterruptController::pic_mask_status();',
    ...
    'irq::eoi_write_smoke_preflight(',
    'irq::eoi_write_smoke_candidate(',
    'irq::eoi_write_permit_model('
)
Assert-ContainsInOrder $eoiWritePermitSnapshotBlock10100 $eoiWritePermitReaders10100 "v10.10.0 eoi write permit reader ordering"
foreach ($eoiWritePermitReader10100 in $eoiWritePermitReaders10100) {
    $readerCount10100 = [regex]::Matches($eoiWritePermitSnapshotBlock10100, [regex]::Escape($eoiWritePermitReader10100)).Count
    if ($readerCount10100 -ne 1) {
        throw "v10.10.0 eoi write permit reader count changed for '$eoiWritePermitReader10100': expected 1, got $readerCount10100"
    }
}

foreach ($eoiWritePermitSurface10100 in @($eoiWritePermitSnapshotBlock10100, $eoiWritePermitNotePrintBlock10100, $eoiWritePermitStatusPrintBlock10100, $eoiWritePermitBlockersPrintBlock10100, $eoiWritePermitNoteBlock10100, $eoiWritePermitStatusBlock10100, $eoiWritePermitCheckBlock10100, $eoiWritePermitBlockersBlock10100, $eoiWritePermitHelperBlock10100)) {
    foreach ($blockedEoiWritePermitCall10100 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWritePermitSurface10100 $blockedEoiWritePermitCall10100 "v10.10.0 eoi write permit surface is read-only: $blockedEoiWritePermitCall10100"
    }
}

foreach ($eoiWritePermitDispatchBlock10100 in @($eoiWritePermitNoteBlock10100, $eoiWritePermitStatusBlock10100, $eoiWritePermitCheckBlock10100, $eoiWritePermitBlockersBlock10100)) {
    foreach ($blockedEoiWritePermitDispatcherInline10100 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(')) {
        Assert-NotContains $eoiWritePermitDispatchBlock10100 $blockedEoiWritePermitDispatcherInline10100 "v10.10.0 eoi write permit dispatcher remains helper-only: $blockedEoiWritePermitDispatcherInline10100"
    }
}

$expectedQemuEoiWritePermitNote10100 = "EOI write permit note`n    scope: controlled first PIC_EOI write permit model`n    permit inputs: candidate/preflight/mutation-sequence/mutation-checklist/decision/final-gate/eoi-dispatch/pic-unmask/idt-bind/sti/keyboard`n    permit granted: no`n    first PIC_EOI write allowed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWritePermitStatus10100 = "EOI write permit model`n    permit granted: no`n    first PIC_EOI write allowed: no`n    target command port: none`n    target value: none`n    target irq line: none`n    hardware mutation: no`n    runtime irq active: no`n    fire command: dry-run blocked"
$expectedQemuEoiWritePermitCheck10100 = "dbyte-kernel> eoi-write-permit-check`n    EOI write permit model`n    permit granted: no`n    first PIC_EOI write allowed: no`n    target command port: none`n    target value: none`n    target irq line: none`n    hardware mutation: no`n    runtime irq active: no`n    fire command: dry-run blocked"
$expectedQemuEoiWritePermitBlockers10100 = "EOI write permit blockers`n    - activation decision frozen blocked`n    - final gate denied`n    - mutation checklist denied`n    - mutation sequencer denied`n    - EOI write candidate fire blocked`n    - STI disabled`n    - PIC unmask disabled`n    - live IRQ runtime disabled`n    permit granted: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitNote10100 "v10.10.0 qemu docs eoi write permit note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitStatus10100 "v10.10.0 qemu docs eoi write permit status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitCheck10100 "v10.10.0 qemu docs eoi write permit check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitBlockers10100 "v10.10.0 qemu docs eoi write permit blockers exact rendered contract"

foreach ($activeEoiWrite10100 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite10100 "v10.10.0 no active EOI write in main: $activeEoiWrite10100"
    Assert-NotContains $picContent1031 $activeEoiWrite10100 "v10.10.0 no active EOI write in pic source: $activeEoiWrite10100"
    Assert-NotContains $irrContent1031 $activeEoiWrite10100 "v10.10.0 no active EOI write in irq source: $activeEoiWrite10100"
}

foreach ($forbiddenEoiWritePermitPositive10100 in @(
    'permit granted: yes',
    'first PIC_EOI write allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWritePermitPositive10100 "v10.10.0 forbidden positive eoi write permit state in main: $forbiddenEoiWritePermitPositive10100"
    Assert-NotContains $irrContent1031 $forbiddenEoiWritePermitPositive10100 "v10.10.0 forbidden positive eoi write permit state in irq source: $forbiddenEoiWritePermitPositive10100"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWritePermitPositive10100 "v10.10.0 forbidden positive eoi write permit state in irq docs: $forbiddenEoiWritePermitPositive10100"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWritePermitPositive10100 "v10.10.0 forbidden positive eoi write permit state in qemu docs: $forbiddenEoiWritePermitPositive10100"
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.10.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.10.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.10.0 Controlled EOI Write Permit Model Foundation verified"

# v10.10.1: Controlled EOI Write Permit Model Hardening
Write-Host "Verifying v10.10.1 Controlled EOI Write Permit Model Hardening contracts..."
$v10100Tag = & git rev-list -n 1 v10.10.0 2>$null
$v10100TagType = & git cat-file -t v10.10.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.10.1"
Assert-NotContains $cargoContent1031 'version = "10.10.0"' "kernel-lab stale v10.10.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.10.1"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.10.0"' "kernel-lab stale v10.10.0 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.10.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.10.1 qemu docs title"
...
Assert-Contains $kernelBootSmokeDocs1031 'v10.10.1` is not an EOI write release. It hardens the existing permit model only' "v10.10.1 qemu docs no-write note"

Assert-Contains $eoiWritePermitNotePrintBlock10100 $eoiWritePermitNoteExact10100 "v10.10.1 eoi-write-permit-note exact output"
Assert-Contains $eoiWritePermitStatusPrintBlock10100 $eoiWritePermitStatusExact10100 "v10.10.1 eoi-write-permit-status exact output"
Assert-Contains $eoiWritePermitStatusPrintBlock10100 $eoiWritePermitStatusExact10100 "v10.10.1 eoi-write-permit-check exact output"
Assert-Contains $eoiWritePermitBlockersPrintBlock10100 $eoiWritePermitBlockersExact10100 "v10.10.1 eoi-write-permit-blockers exact output"
Assert-Contains $eoiWritePermitNoteBlock10100 'print_eoi_write_permit_note();' "v10.10.1 eoi write permit note dispatcher calls print helper"
Assert-Contains $eoiWritePermitStatusBlock10100 'print_eoi_write_permit_status();' "v10.10.1 eoi write permit status dispatcher calls status helper"
Assert-Contains $eoiWritePermitCheckBlock10100 'print_eoi_write_permit_status();' "v10.10.1 eoi write permit check dispatcher calls status helper"
Assert-Contains $eoiWritePermitBlockersBlock10100 'print_eoi_write_permit_blockers();' "v10.10.1 eoi write permit blockers dispatcher calls print helper"
Assert-ContainsInOrder $eoiWritePermitSnapshotBlock10100 $eoiWritePermitReaders10100 "v10.10.1 eoi write permit reader ordering"
foreach ($eoiWritePermitReader10101 in $eoiWritePermitReaders10100) {
    $readerCount10101 = [regex]::Matches($eoiWritePermitSnapshotBlock10100, [regex]::Escape($eoiWritePermitReader10101)).Count
    if ($readerCount10101 -ne 1) {
        throw "v10.10.1 eoi write permit reader count changed for '$eoiWritePermitReader10101': expected 1, got $readerCount10101"
    }
}

foreach ($eoiWritePermitSurface10101 in @($eoiWritePermitSnapshotBlock10100, $eoiWritePermitNotePrintBlock10100, $eoiWritePermitStatusPrintBlock10100, $eoiWritePermitBlockersPrintBlock10100, $eoiWritePermitNoteBlock10100, $eoiWritePermitStatusBlock10100, $eoiWritePermitCheckBlock10100, $eoiWritePermitBlockersBlock10100, $eoiWritePermitHelperBlock10100)) {
    foreach ($blockedEoiWritePermitCall10101 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWritePermitSurface10101 $blockedEoiWritePermitCall10101 "v10.10.1 eoi write permit surface is read-only: $blockedEoiWritePermitCall10101"
    }
}

foreach ($eoiWritePermitDispatchBlock10101 in @($eoiWritePermitNoteBlock10100, $eoiWritePermitStatusBlock10100, $eoiWritePermitCheckBlock10100, $eoiWritePermitBlockersBlock10100)) {
    foreach ($blockedEoiWritePermitDispatcherInline10101 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(')) {
        Assert-NotContains $eoiWritePermitDispatchBlock10101 $blockedEoiWritePermitDispatcherInline10101 "v10.10.1 eoi write permit dispatcher remains helper-only: $blockedEoiWritePermitDispatcherInline10101"
    }
}

Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitNote10100 "v10.10.1 qemu docs eoi write permit note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitStatus10100 "v10.10.1 qemu docs eoi write permit status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitCheck10100 "v10.10.1 qemu docs eoi write permit check exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWritePermitBlockers10100 "v10.10.1 qemu docs eoi write permit blockers exact rendered contract"

foreach ($activeEoiWrite10101 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite10101 "v10.10.1 no active EOI write in main: $activeEoiWrite10101"
    Assert-NotContains $picContent1031 $activeEoiWrite10101 "v10.10.1 no active EOI write in pic source: $activeEoiWrite10101"
    Assert-NotContains $irrContent1031 $activeEoiWrite10101 "v10.10.1 no active EOI write in irq source: $activeEoiWrite10101"
    Assert-NotContains $kernelIrqDocs1031 $activeEoiWrite10101 "v10.10.1 no active EOI write in irq docs: $activeEoiWrite10101"
    Assert-NotContains $kernelBootSmokeDocs1031 $activeEoiWrite10101 "v10.10.1 no active EOI write in qemu docs: $activeEoiWrite10101"
}

foreach ($forbiddenEoiWritePermitPositive10101 in @(
    'permit granted: yes',
    'first PIC_EOI write allowed: yes',
    'hardware mutation: yes',
    'runtime irq active: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWritePermitPositive10101 "v10.10.1 forbidden positive eoi write permit state in main: $forbiddenEoiWritePermitPositive10101"
    Assert-NotContains $irrContent1031 $forbiddenEoiWritePermitPositive10101 "v10.10.1 forbidden positive eoi write permit state in irq source: $forbiddenEoiWritePermitPositive10101"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWritePermitPositive10101 "v10.10.1 forbidden positive eoi write permit state in irq docs: $forbiddenEoiWritePermitPositive10101"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWritePermitPositive10101 "v10.10.1 forbidden positive eoi write permit state in qemu docs: $forbiddenEoiWritePermitPositive10101"
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.10.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.10.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.10.1 Controlled EOI Write Permit Model Hardening verified"

# v10.11.0: Controlled EOI Write One-Shot Command Path Foundation
Write-Host "Verifying v10.11.0 Controlled EOI Write One-Shot Command Path Foundation contracts..."
$v10101Tag = & git rev-list -n 1 v10.10.1 2>$null
$v10101TagType = & git cat-file -t v10.10.1 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.11.0"
Assert-NotContains $cargoContent1031 'version = "10.10.1"' "kernel-lab stale v10.10.1 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.11.0"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.10.1"' "kernel-lab stale v10.10.1 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.11.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.11.0 qemu docs title"
...
Assert-Contains $mainContent1031 'eoi-write-oneshot-note eoi-write-oneshot-status eoi-write-oneshot-arm eoi-write-oneshot-fire eoi-write-oneshot-blockers' "help string includes v10.11.0 eoi write one-shot commands"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-note"' "v10.11.0 eoi write one-shot note dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-status"' "v10.11.0 eoi write one-shot status dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-arm"' "v10.11.0 eoi write one-shot arm dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-fire"' "v10.11.0 eoi write one-shot fire dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-blockers"' "v10.11.0 eoi write one-shot blockers dispatcher"
Assert-Contains $irrContent1031 'pub struct EoiWriteOneShotCommandPath' "v10.11.0 eoi write one-shot telemetry struct"
Assert-Contains $irrContent1031 'pub fn eoi_write_oneshot_command_path(' "v10.11.0 eoi write one-shot helper"
Assert-Contains $mainContent1031 'fn eoi_write_oneshot_command_path_snapshot() -> irq::EoiWriteOneShotCommandPath' "v10.11.0 shared eoi write one-shot snapshot helper"

$eoiWriteOneShotHelperStart10110 = $irrContent1031.IndexOf('pub fn eoi_write_oneshot_command_path(')
if ($eoiWriteOneShotHelperStart10110 -lt 0) { throw "v10.11.0 eoi write one-shot helper isolation failed" }
$eoiWriteOneShotHelperBlock10110 = $irrContent1031.Substring($eoiWriteOneShotHelperStart10110)
$eoiWriteOneShotSnapshotStart10110 = $mainContent1031.IndexOf('fn eoi_write_oneshot_command_path_snapshot()')
$eoiWriteOneShotSnapshotEnd10110 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_preflight_note()')
$eoiWriteOneShotNotePrintStart10110 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_note()')
$eoiWriteOneShotStatusPrintStart10110 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_status()')
$eoiWriteOneShotFirePrintStart10110 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_fire()')
$eoiWriteOneShotBlockersPrintStart10110 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_blockers()')
if ($eoiWriteOneShotSnapshotStart10110 -lt 0 -or $eoiWriteOneShotSnapshotEnd10110 -lt $eoiWriteOneShotSnapshotStart10110 -or $eoiWriteOneShotNotePrintStart10110 -lt 0 -or $eoiWriteOneShotStatusPrintStart10110 -lt $eoiWriteOneShotNotePrintStart10110 -or $eoiWriteOneShotFirePrintStart10110 -lt $eoiWriteOneShotStatusPrintStart10110 -or $eoiWriteOneShotBlockersPrintStart10110 -lt $eoiWriteOneShotFirePrintStart10110 -or $kernelMainStart10100 -lt $eoiWriteOneShotBlockersPrintStart10110) {
    throw "v10.11.0 eoi write one-shot helper/print isolation failed"
}
$eoiWriteOneShotSnapshotBlock10110 = $mainContent1031.Substring($eoiWriteOneShotSnapshotStart10110, $eoiWriteOneShotSnapshotEnd10110 - $eoiWriteOneShotSnapshotStart10110)
$eoiWriteOneShotNotePrintBlock10110 = $mainContent1031.Substring($eoiWriteOneShotNotePrintStart10110, $eoiWriteOneShotStatusPrintStart10110 - $eoiWriteOneShotNotePrintStart10110)
$eoiWriteOneShotStatusPrintBlock10110 = $mainContent1031.Substring($eoiWriteOneShotStatusPrintStart10110, $eoiWriteOneShotFirePrintStart10110 - $eoiWriteOneShotStatusPrintStart10110)
$eoiWriteOneShotFirePrintBlock10110 = $mainContent1031.Substring($eoiWriteOneShotFirePrintStart10110, $eoiWriteOneShotBlockersPrintStart10110 - $eoiWriteOneShotFirePrintStart10110)
$eoiWriteOneShotBlockersPrintBlock10110 = $mainContent1031.Substring($eoiWriteOneShotBlockersPrintStart10110, $kernelMainStart10100 - $eoiWriteOneShotBlockersPrintStart10110)
$eoiWriteOneShotNoteStart10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-note" {')
$eoiWriteOneShotStatusStart10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-status" {')
$eoiWriteOneShotArmStart10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-arm" {')
$eoiWriteOneShotFireStart10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-fire" {')
$eoiWriteOneShotBlockersStart10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-blockers" {')
$eoiWriteOneShotEnd10110 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiWriteOneShotBlockersStart10110)
if ($eoiWriteOneShotNoteStart10110 -lt 0 -or $eoiWriteOneShotStatusStart10110 -lt $eoiWriteOneShotNoteStart10110 -or $eoiWriteOneShotArmStart10110 -lt $eoiWriteOneShotStatusStart10110 -or $eoiWriteOneShotFireStart10110 -lt $eoiWriteOneShotArmStart10110 -or $eoiWriteOneShotBlockersStart10110 -lt $eoiWriteOneShotFireStart10110 -or $eoiWriteOneShotEnd10110 -lt $eoiWriteOneShotBlockersStart10110) {
    throw "v10.11.0 eoi write one-shot command block isolation failed"
}
$eoiWriteOneShotNoteBlock10110 = $mainContent1031.Substring($eoiWriteOneShotNoteStart10110, $eoiWriteOneShotStatusStart10110 - $eoiWriteOneShotNoteStart10110)
$eoiWriteOneShotStatusBlock10110 = $mainContent1031.Substring($eoiWriteOneShotStatusStart10110, $eoiWriteOneShotArmStart10110 - $eoiWriteOneShotStatusStart10110)
$eoiWriteOneShotArmBlock10110 = $mainContent1031.Substring($eoiWriteOneShotArmStart10110, $eoiWriteOneShotFireStart10110 - $eoiWriteOneShotArmStart10110)
$eoiWriteOneShotFireBlock10110 = $mainContent1031.Substring($eoiWriteOneShotFireStart10110, $eoiWriteOneShotBlockersStart10110 - $eoiWriteOneShotFireStart10110)
$eoiWriteOneShotBlockersBlock10110 = $mainContent1031.Substring($eoiWriteOneShotBlockersStart10110, $eoiWriteOneShotEnd10110 - $eoiWriteOneShotBlockersStart10110)

$eoiWriteOneShotNoteExact10110 = 'EOI write one-shot note\nscope: {}\ninputs: {}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotStatusExact10110 = 'EOI write one-shot command path\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\ntarget command port: {}\ntarget value: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotFireExact10110 = 'EOI write one-shot fire\n{}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\n'
$eoiWriteOneShotBlockersExact10110 = 'EOI write one-shot blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nfirst PIC_EOI write performed: {}\n'
Assert-Contains $eoiWriteOneShotNotePrintBlock10110 $eoiWriteOneShotNoteExact10110 "v10.11.0 eoi-write-oneshot-note exact output"
Assert-Contains $eoiWriteOneShotStatusPrintBlock10110 $eoiWriteOneShotStatusExact10110 "v10.11.0 eoi-write-oneshot-status exact output"
Assert-Contains $eoiWriteOneShotStatusPrintBlock10110 $eoiWriteOneShotStatusExact10110 "v10.11.0 eoi-write-oneshot-arm exact output"
Assert-Contains $eoiWriteOneShotFirePrintBlock10110 $eoiWriteOneShotFireExact10110 "v10.11.0 eoi-write-oneshot-fire exact output"
Assert-Contains $eoiWriteOneShotBlockersPrintBlock10110 $eoiWriteOneShotBlockersExact10110 "v10.11.0 eoi-write-oneshot-blockers exact output"
Assert-Contains $eoiWriteOneShotNoteBlock10110 'print_eoi_write_oneshot_note();' "v10.11.0 eoi write one-shot note dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotStatusBlock10110 'print_eoi_write_oneshot_status();' "v10.11.0 eoi write one-shot status dispatcher calls status helper"
Assert-Contains $eoiWriteOneShotArmBlock10110 'print_eoi_write_oneshot_status();' "v10.11.0 eoi write one-shot arm dispatcher calls status helper"
Assert-Contains $eoiWriteOneShotFireBlock10110 'print_eoi_write_oneshot_fire();' "v10.11.0 eoi write one-shot fire dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotBlockersBlock10110 'print_eoi_write_oneshot_blockers();' "v10.11.0 eoi write one-shot blockers dispatcher calls print helper"

Assert-ContainsInOrder $eoiWriteOneShotSnapshotBlock10110 @(
    'let permit = eoi_write_permit_model_snapshot();',
    'irq::eoi_write_oneshot_command_path(permit)'
) "v10.11.0 eoi write one-shot snapshot reader ordering"

foreach ($eoiWriteOneShotSurface10110 in @($eoiWriteOneShotSnapshotBlock10110, $eoiWriteOneShotNotePrintBlock10110, $eoiWriteOneShotStatusPrintBlock10110, $eoiWriteOneShotFirePrintBlock10110, $eoiWriteOneShotBlockersPrintBlock10110, $eoiWriteOneShotNoteBlock10110, $eoiWriteOneShotStatusBlock10110, $eoiWriteOneShotArmBlock10110, $eoiWriteOneShotFireBlock10110, $eoiWriteOneShotBlockersBlock10110, $eoiWriteOneShotHelperBlock10110)) {
    foreach ($blockedEoiWriteOneShotCall10110 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWriteOneShotSurface10110 $blockedEoiWriteOneShotCall10110 "v10.11.0 eoi write one-shot surface is read-only: $blockedEoiWriteOneShotCall10110"
    }
}

foreach ($eoiWriteOneShotDispatchBlock10110 in @($eoiWriteOneShotNoteBlock10110, $eoiWriteOneShotStatusBlock10110, $eoiWriteOneShotArmBlock10110, $eoiWriteOneShotFireBlock10110, $eoiWriteOneShotBlockersBlock10110)) {
    foreach ($blockedEoiWriteOneShotDispatcherInline10110 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(')) {
        Assert-NotContains $eoiWriteOneShotDispatchBlock10110 $blockedEoiWriteOneShotDispatcherInline10110 "v10.11.0 eoi write one-shot dispatcher remains helper-only: $blockedEoiWriteOneShotDispatcherInline10110"
    }
}

$expectedQemuEoiWriteOneShotNote10110 = "EOI write one-shot note`n    scope: controlled first PIC_EOI write one-shot command path`n    inputs: permit-model/candidate/preflight/mutation-sequence/mutation-checklist/decision/final-gate/eoi-dispatch/pic-unmask/idt-bind/sti/keyboard`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotStatus10110 = "EOI write one-shot command path`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    target command port: none`n    target value: none`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotArm10110 = "dbyte-kernel> eoi-write-oneshot-arm`n    EOI write one-shot command path`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    target command port: none`n    target value: none`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotFire10110 = "EOI write one-shot fire`n    error: EOI one-shot fire blocked by permit model`n    first PIC_EOI write performed: no`n    hardware mutation: no"
$expectedQemuEoiWriteOneShotBlockers10110 = "EOI write one-shot blockers`n    - permit granted: no`n    - first PIC_EOI write allowed: no`n    - hardware mutation: no`n    - runtime irq active: no`n    - STI disabled`n    - PIC unmask disabled`n    - live IRQ runtime disabled`n    first PIC_EOI write performed: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotNote10110 "v10.11.0 qemu docs eoi write one-shot note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotStatus10110 "v10.11.0 qemu docs eoi write one-shot status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotArm10110 "v10.11.0 qemu docs eoi write one-shot arm exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotFire10110 "v10.11.0 qemu docs eoi write one-shot fire exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotBlockers10110 "v10.11.0 qemu docs eoi write one-shot blockers exact rendered contract"

foreach ($activeEoiWrite10110 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite10110 "v10.11.0 no active EOI write in main: $activeEoiWrite10110"
    Assert-NotContains $picContent1031 $activeEoiWrite10110 "v10.11.0 no active EOI write in pic source: $activeEoiWrite10110"
    Assert-NotContains $irrContent1031 $activeEoiWrite10110 "v10.11.0 no active EOI write in irq source: $activeEoiWrite10110"
    Assert-NotContains $kernelIrqDocs1031 $activeEoiWrite10110 "v10.11.0 no active EOI write in irq docs: $activeEoiWrite10110"
    Assert-NotContains $kernelBootSmokeDocs1031 $activeEoiWrite10110 "v10.11.0 no active EOI write in qemu docs: $activeEoiWrite10110"
}

foreach ($forbiddenEoiWriteOneShotPositive10110 in @(
    'permit granted: yes',
    'first PIC_EOI write allowed: yes',
    'fire allowed: yes',
    'first PIC_EOI write performed: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWriteOneShotPositive10110 "v10.11.0 forbidden positive eoi write one-shot state in main: $forbiddenEoiWriteOneShotPositive10110"
    Assert-NotContains $irrContent1031 $forbiddenEoiWriteOneShotPositive10110 "v10.11.0 forbidden positive eoi write one-shot state in irq source: $forbiddenEoiWriteOneShotPositive10110"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWriteOneShotPositive10110 "v10.11.0 forbidden positive eoi write one-shot state in irq docs: $forbiddenEoiWriteOneShotPositive10110"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWriteOneShotPositive10110 "v10.11.0 forbidden positive eoi write one-shot state in qemu docs: $forbiddenEoiWriteOneShotPositive10110"
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.11.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.11.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.11.0 Controlled EOI Write One-Shot Command Path Foundation verified"

# v10.11.1: Controlled EOI Write One-Shot Command Path Hardening
Write-Host "Verifying v10.11.1 Controlled EOI Write One-Shot Command Path Hardening contracts..."
$v10110Tag = & git rev-list -n 1 v10.11.0 2>$null
$v10110TagType = & git cat-file -t v10.11.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.11.1"
Assert-NotContains $cargoContent1031 'version = "10.11.0"' "kernel-lab stale v10.11.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.11.1"
Assert-NotContains $kernelCargoLockContent1031 'version = "10.11.0"' "kernel-lab stale v10.11.0 lockfile version guard"
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.11.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.11.1 qemu docs title"
...
Assert-Contains $kernelBootSmokeDocs1031 'v10.11.1` is not a latch or EOI write release' "v10.11.1 qemu docs no-latch/no-write note"

Assert-Contains $eoiWriteOneShotNotePrintBlock10110 $eoiWriteOneShotNoteExact10110 "v10.11.1 eoi-write-oneshot-note exact output"
Assert-Contains $eoiWriteOneShotStatusPrintBlock10110 $eoiWriteOneShotStatusExact10110 "v10.11.1 eoi-write-oneshot-status exact output"
Assert-Contains $eoiWriteOneShotStatusPrintBlock10110 $eoiWriteOneShotStatusExact10110 "v10.11.1 eoi-write-oneshot-arm exact output"
Assert-Contains $eoiWriteOneShotFirePrintBlock10110 $eoiWriteOneShotFireExact10110 "v10.11.1 eoi-write-oneshot-fire exact output"
Assert-Contains $eoiWriteOneShotBlockersPrintBlock10110 $eoiWriteOneShotBlockersExact10110 "v10.11.1 eoi-write-oneshot-blockers exact output"
Assert-Contains $eoiWriteOneShotNoteBlock10110 'print_eoi_write_oneshot_note();' "v10.11.1 eoi write one-shot note dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotStatusBlock10110 'print_eoi_write_oneshot_status();' "v10.11.1 eoi write one-shot status dispatcher calls status helper"
Assert-Contains $eoiWriteOneShotArmBlock10110 'print_eoi_write_oneshot_status();' "v10.11.1 eoi write one-shot arm dispatcher stays read-only status helper"
Assert-Contains $eoiWriteOneShotFireBlock10110 'print_eoi_write_oneshot_fire();' "v10.11.1 eoi write one-shot fire dispatcher remains permit-blocked print helper"
Assert-Contains $eoiWriteOneShotBlockersBlock10110 'print_eoi_write_oneshot_blockers();' "v10.11.1 eoi write one-shot blockers dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotFirePrintBlock10110 'oneshot.fire_result' "v10.11.1 eoi write one-shot fire prints modeled blocked result"
Assert-Contains $irrContent1031 'EOI_WRITE_ONESHOT_FIRE_BLOCKED_BY_PERMIT' "v10.11.1 eoi write one-shot fire blocked constant remains present"
Assert-Contains $irrContent1031 'error: EOI one-shot fire blocked by permit model' "v10.11.1 eoi write one-shot fire remains blocked by permit model"
Assert-ContainsInOrder $eoiWriteOneShotSnapshotBlock10110 @(
    'let permit = eoi_write_permit_model_snapshot();',
    'irq::eoi_write_oneshot_command_path(permit)'
) "v10.11.1 eoi write one-shot snapshot reader ordering"

foreach ($eoiWriteOneShotSurface10111 in @($eoiWriteOneShotSnapshotBlock10110, $eoiWriteOneShotNotePrintBlock10110, $eoiWriteOneShotStatusPrintBlock10110, $eoiWriteOneShotFirePrintBlock10110, $eoiWriteOneShotBlockersPrintBlock10110, $eoiWriteOneShotNoteBlock10110, $eoiWriteOneShotStatusBlock10110, $eoiWriteOneShotArmBlock10110, $eoiWriteOneShotFireBlock10110, $eoiWriteOneShotBlockersBlock10110, $eoiWriteOneShotHelperBlock10110)) {
    foreach ($blockedEoiWriteOneShotCall10111 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWriteOneShotSurface10111 $blockedEoiWriteOneShotCall10111 "v10.11.1 eoi write one-shot surface is read-only/no-latch: $blockedEoiWriteOneShotCall10111"
    }
}

foreach ($eoiWriteOneShotDispatchBlock10111 in @($eoiWriteOneShotNoteBlock10110, $eoiWriteOneShotStatusBlock10110, $eoiWriteOneShotArmBlock10110, $eoiWriteOneShotFireBlock10110, $eoiWriteOneShotBlockersBlock10110)) {
    foreach ($blockedEoiWriteOneShotDispatcherInline10111 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(', 'AtomicBool', 'static mut')) {
        Assert-NotContains $eoiWriteOneShotDispatchBlock10111 $blockedEoiWriteOneShotDispatcherInline10111 "v10.11.1 eoi write one-shot dispatcher remains helper-only/no-latch: $blockedEoiWriteOneShotDispatcherInline10111"
    }
}

$eoiWriteOneShotCombinedSource10111 = "$mainContent1031`n$irrContent1031"
if ([regex]::IsMatch($eoiWriteOneShotCombinedSource10111, 'static\s+mut\s+.*(ONESHOT|ONE_SHOT).*ARM')) {
    throw "v10.11.1 eoi write one-shot must not add static mut armed latch state"
}
Assert-NotContains $eoiWriteOneShotHelperBlock10110 'AtomicBool' "v10.11.1 eoi write one-shot helper remains no-latch; v10.12 latch namespace owns AtomicBool"

Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotNote10110 "v10.11.1 qemu docs eoi write one-shot note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotStatus10110 "v10.11.1 qemu docs eoi write one-shot status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotArm10110 "v10.11.1 qemu docs eoi write one-shot arm exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotFire10110 "v10.11.1 qemu docs eoi write one-shot fire exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotBlockers10110 "v10.11.1 qemu docs eoi write one-shot blockers exact rendered contract"

foreach ($activeEoiWrite10111 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite10111 "v10.11.1 no active EOI write in main: $activeEoiWrite10111"
    Assert-NotContains $picContent1031 $activeEoiWrite10111 "v10.11.1 no active EOI write in pic source: $activeEoiWrite10111"
    Assert-NotContains $irrContent1031 $activeEoiWrite10111 "v10.11.1 no active EOI write in irq source: $activeEoiWrite10111"
    Assert-NotContains $kernelIrqDocs1031 $activeEoiWrite10111 "v10.11.1 no active EOI write in irq docs: $activeEoiWrite10111"
    Assert-NotContains $kernelBootSmokeDocs1031 $activeEoiWrite10111 "v10.11.1 no active EOI write in qemu docs: $activeEoiWrite10111"
}

foreach ($forbiddenEoiWriteOneShotPositive10111 in @(
    'permit granted: yes',
    'first PIC_EOI write allowed: yes',
    'fire allowed: yes',
    'first PIC_EOI write performed: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWriteOneShotPositive10111 "v10.11.1 forbidden positive eoi write one-shot state in main: $forbiddenEoiWriteOneShotPositive10111"
    Assert-NotContains $irrContent1031 $forbiddenEoiWriteOneShotPositive10111 "v10.11.1 forbidden positive eoi write one-shot state in irq source: $forbiddenEoiWriteOneShotPositive10111"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWriteOneShotPositive10111 "v10.11.1 forbidden positive eoi write one-shot state in irq docs: $forbiddenEoiWriteOneShotPositive10111"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWriteOneShotPositive10111 "v10.11.1 forbidden positive eoi write one-shot state in qemu docs: $forbiddenEoiWriteOneShotPositive10111"
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.11.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.11.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.11.1 Controlled EOI Write One-Shot Command Path Hardening verified"

# v10.12.0: Controlled EOI Write One-Shot Latch Foundation
Write-Host "Verifying v10.12.0 Controlled EOI Write One-Shot Latch Foundation contracts..."
$v10111Tag = & git rev-list -n 1 v10.11.1 2>$null
$v10111TagType = & git cat-file -t v10.11.1 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.12.0"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.12.0"
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.12.0 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.12.0 qemu docs title"
...
Assert-Contains $mainContent1031 'eoi-write-oneshot-latch-note eoi-write-oneshot-latch-status eoi-write-oneshot-latch-arm eoi-write-oneshot-latch-clear eoi-write-oneshot-latch-fire eoi-write-oneshot-latch-blockers' "help string includes v10.12.0 eoi write one-shot latch commands"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-note"' "v10.12.0 eoi write one-shot latch note dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-status"' "v10.12.0 eoi write one-shot latch status dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-arm"' "v10.12.0 eoi write one-shot latch arm dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-clear"' "v10.12.0 eoi write one-shot latch clear dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-fire"' "v10.12.0 eoi write one-shot latch fire dispatcher"
Assert-Contains $mainContent1031 'line_str == "eoi-write-oneshot-latch-blockers"' "v10.12.0 eoi write one-shot latch blockers dispatcher"

Assert-Contains $irrContent1031 'use core::sync::atomic::{AtomicBool, Ordering};' "v10.12.0 latch uses core atomics"
Assert-Contains $irrContent1031 'static EOI_WRITE_ONESHOT_LATCH_ARMED: AtomicBool = AtomicBool::new(false);' "v10.12.0 latch static defaults to clear"
Assert-Contains $irrContent1031 'EOI_WRITE_ONESHOT_LATCH_ARMED.store(true, Ordering::SeqCst);' "v10.12.0 latch arm store"
Assert-Contains $irrContent1031 'EOI_WRITE_ONESHOT_LATCH_ARMED.store(false, Ordering::SeqCst);' "v10.12.0 latch clear store"
Assert-Contains $irrContent1031 'EOI_WRITE_ONESHOT_LATCH_ARMED.load(Ordering::SeqCst);' "v10.12.0 latch reads state"
Assert-Contains $irrContent1031 'pub struct EoiWriteOneShotLatch' "v10.12.0 latch telemetry struct"
Assert-Contains $irrContent1031 'pub fn eoi_write_oneshot_latch_status(' "v10.12.0 latch status helper"
Assert-Contains $irrContent1031 'pub fn eoi_write_oneshot_latch_arm(' "v10.12.0 latch arm helper"
Assert-Contains $irrContent1031 'pub fn eoi_write_oneshot_latch_clear(' "v10.12.0 latch clear helper"
Assert-Contains $irrContent1031 'pub fn eoi_write_oneshot_latch_fire(' "v10.12.0 latch fire helper"

$eoiWriteOneShotLatchStatusSnapshotStart10120 = $mainContent1031.IndexOf('fn eoi_write_oneshot_latch_status_snapshot()')
$eoiWriteOneShotLatchArmSnapshotStart10120 = $mainContent1031.IndexOf('fn eoi_write_oneshot_latch_arm_snapshot()')
$eoiWriteOneShotLatchClearSnapshotStart10120 = $mainContent1031.IndexOf('fn eoi_write_oneshot_latch_clear_snapshot()')
$eoiWriteOneShotLatchFireSnapshotStart10120 = $mainContent1031.IndexOf('fn eoi_write_oneshot_latch_fire_snapshot()')
$eoiWriteOneShotLatchSnapshotEnd10120 = $mainContent1031.IndexOf('fn print_eoi_write_smoke_preflight_note()')
$eoiWriteOneShotLatchNotePrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_note()')
$eoiWriteOneShotLatchStatusPrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_status()')
$eoiWriteOneShotLatchArmPrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_arm()')
$eoiWriteOneShotLatchClearPrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_clear()')
$eoiWriteOneShotLatchFirePrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_fire()')
$eoiWriteOneShotLatchBlockersPrintStart10120 = $mainContent1031.IndexOf('fn print_eoi_write_oneshot_latch_blockers()')
if ($eoiWriteOneShotLatchStatusSnapshotStart10120 -lt 0 -or $eoiWriteOneShotLatchArmSnapshotStart10120 -lt $eoiWriteOneShotLatchStatusSnapshotStart10120 -or $eoiWriteOneShotLatchClearSnapshotStart10120 -lt $eoiWriteOneShotLatchArmSnapshotStart10120 -or $eoiWriteOneShotLatchFireSnapshotStart10120 -lt $eoiWriteOneShotLatchClearSnapshotStart10120 -or $eoiWriteOneShotLatchSnapshotEnd10120 -lt $eoiWriteOneShotLatchFireSnapshotStart10120 -or $eoiWriteOneShotLatchNotePrintStart10120 -lt 0 -or $eoiWriteOneShotLatchStatusPrintStart10120 -lt $eoiWriteOneShotLatchNotePrintStart10120 -or $eoiWriteOneShotLatchArmPrintStart10120 -lt $eoiWriteOneShotLatchStatusPrintStart10120 -or $eoiWriteOneShotLatchClearPrintStart10120 -lt $eoiWriteOneShotLatchArmPrintStart10120 -or $eoiWriteOneShotLatchFirePrintStart10120 -lt $eoiWriteOneShotLatchClearPrintStart10120 -or $eoiWriteOneShotLatchBlockersPrintStart10120 -lt $eoiWriteOneShotLatchFirePrintStart10120 -or $kernelMainStart10100 -lt $eoiWriteOneShotLatchBlockersPrintStart10120) {
    throw "v10.12.0 eoi write one-shot latch helper/print isolation failed"
}
$eoiWriteOneShotLatchSnapshotBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchStatusSnapshotStart10120, $eoiWriteOneShotLatchSnapshotEnd10120 - $eoiWriteOneShotLatchStatusSnapshotStart10120)
$eoiWriteOneShotLatchNotePrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchNotePrintStart10120, $eoiWriteOneShotLatchStatusPrintStart10120 - $eoiWriteOneShotLatchNotePrintStart10120)
$eoiWriteOneShotLatchStatusPrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchStatusPrintStart10120, $eoiWriteOneShotLatchArmPrintStart10120 - $eoiWriteOneShotLatchStatusPrintStart10120)
$eoiWriteOneShotLatchArmPrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchArmPrintStart10120, $eoiWriteOneShotLatchClearPrintStart10120 - $eoiWriteOneShotLatchArmPrintStart10120)
$eoiWriteOneShotLatchClearPrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchClearPrintStart10120, $eoiWriteOneShotLatchFirePrintStart10120 - $eoiWriteOneShotLatchClearPrintStart10120)
$eoiWriteOneShotLatchFirePrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchFirePrintStart10120, $eoiWriteOneShotLatchBlockersPrintStart10120 - $eoiWriteOneShotLatchFirePrintStart10120)
$eoiWriteOneShotLatchBlockersPrintBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchBlockersPrintStart10120, $kernelMainStart10100 - $eoiWriteOneShotLatchBlockersPrintStart10120)

$eoiWriteOneShotLatchNoteStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-note" {')
$eoiWriteOneShotLatchStatusStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-status" {')
$eoiWriteOneShotLatchArmStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-arm" {')
$eoiWriteOneShotLatchClearStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-clear" {')
$eoiWriteOneShotLatchFireStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-fire" {')
$eoiWriteOneShotLatchBlockersStart10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-write-oneshot-latch-blockers" {')
$eoiWriteOneShotLatchEnd10120 = $mainContent1031.IndexOf('} else if line_str == "eoi-runtime-note" {', $eoiWriteOneShotLatchBlockersStart10120)
if ($eoiWriteOneShotLatchNoteStart10120 -lt 0 -or $eoiWriteOneShotLatchStatusStart10120 -lt $eoiWriteOneShotLatchNoteStart10120 -or $eoiWriteOneShotLatchArmStart10120 -lt $eoiWriteOneShotLatchStatusStart10120 -or $eoiWriteOneShotLatchClearStart10120 -lt $eoiWriteOneShotLatchArmStart10120 -or $eoiWriteOneShotLatchFireStart10120 -lt $eoiWriteOneShotLatchClearStart10120 -or $eoiWriteOneShotLatchBlockersStart10120 -lt $eoiWriteOneShotLatchFireStart10120 -or $eoiWriteOneShotLatchEnd10120 -lt $eoiWriteOneShotLatchBlockersStart10120) {
    throw "v10.12.0 eoi write one-shot latch command block isolation failed"
}
$eoiWriteOneShotLatchNoteBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchNoteStart10120, $eoiWriteOneShotLatchStatusStart10120 - $eoiWriteOneShotLatchNoteStart10120)
$eoiWriteOneShotLatchStatusBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchStatusStart10120, $eoiWriteOneShotLatchArmStart10120 - $eoiWriteOneShotLatchStatusStart10120)
$eoiWriteOneShotLatchArmBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchArmStart10120, $eoiWriteOneShotLatchClearStart10120 - $eoiWriteOneShotLatchArmStart10120)
$eoiWriteOneShotLatchClearBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchClearStart10120, $eoiWriteOneShotLatchFireStart10120 - $eoiWriteOneShotLatchClearStart10120)
$eoiWriteOneShotLatchFireBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchFireStart10120, $eoiWriteOneShotLatchBlockersStart10120 - $eoiWriteOneShotLatchFireStart10120)
$eoiWriteOneShotLatchBlockersBlock10120 = $mainContent1031.Substring($eoiWriteOneShotLatchBlockersStart10120, $eoiWriteOneShotLatchEnd10120 - $eoiWriteOneShotLatchBlockersStart10120)

$eoiWriteOneShotLatchNoteExact10120 = 'EOI write one-shot latch note\nscope: {}\ninputs: {}\nlatch: {}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotLatchStatusExact10120 = 'EOI write one-shot latch status\nlatch: {}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\ntarget command port: {}\ntarget value: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotLatchArmExact10120 = 'EOI write one-shot latch arm\nresult: {}\nlatch: {}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotLatchClearExact10120 = 'EOI write one-shot latch clear\nresult: {}\nlatch: {}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\n'
$eoiWriteOneShotLatchFireExact10120 = 'EOI write one-shot latch fire\n{}\none-shot armed: {}\nfire allowed: {}\nfirst PIC_EOI write performed: {}\nhardware mutation: {}\nruntime irq active: {}\nblocked fire cleared latch: {}\n'
$eoiWriteOneShotLatchBlockersExact10120 = 'EOI write one-shot latch blockers\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\n- {}\nfirst PIC_EOI write performed: {}\n'
Assert-Contains $eoiWriteOneShotLatchNotePrintBlock10120 $eoiWriteOneShotLatchNoteExact10120 "v10.12.0 eoi-write-oneshot-latch-note exact output"
Assert-Contains $eoiWriteOneShotLatchStatusPrintBlock10120 $eoiWriteOneShotLatchStatusExact10120 "v10.12.0 eoi-write-oneshot-latch-status exact output"
Assert-Contains $eoiWriteOneShotLatchArmPrintBlock10120 $eoiWriteOneShotLatchArmExact10120 "v10.12.0 eoi-write-oneshot-latch-arm exact output"
Assert-Contains $eoiWriteOneShotLatchClearPrintBlock10120 $eoiWriteOneShotLatchClearExact10120 "v10.12.0 eoi-write-oneshot-latch-clear exact output"
Assert-Contains $eoiWriteOneShotLatchFirePrintBlock10120 $eoiWriteOneShotLatchFireExact10120 "v10.12.0 eoi-write-oneshot-latch-fire exact output"
Assert-Contains $eoiWriteOneShotLatchBlockersPrintBlock10120 $eoiWriteOneShotLatchBlockersExact10120 "v10.12.0 eoi-write-oneshot-latch-blockers exact output"

Assert-Contains $eoiWriteOneShotLatchNoteBlock10120 'print_eoi_write_oneshot_latch_note();' "v10.12.0 latch note dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotLatchStatusBlock10120 'print_eoi_write_oneshot_latch_status();' "v10.12.0 latch status dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotLatchArmBlock10120 'print_eoi_write_oneshot_latch_arm();' "v10.12.0 latch arm dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotLatchClearBlock10120 'print_eoi_write_oneshot_latch_clear();' "v10.12.0 latch clear dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotLatchFireBlock10120 'print_eoi_write_oneshot_latch_fire();' "v10.12.0 latch fire dispatcher calls print helper"
Assert-Contains $eoiWriteOneShotLatchBlockersBlock10120 'print_eoi_write_oneshot_latch_blockers();' "v10.12.0 latch blockers dispatcher calls print helper"

Assert-ContainsInOrder $eoiWriteOneShotLatchSnapshotBlock10120 @(
    'let permit = eoi_write_permit_model_snapshot();',
...
) "v10.12.0 latch snapshot reader/mutator ordering"

Assert-ContainsInOrder $irrContent1031 @(
    'pub fn eoi_write_oneshot_latch_arm(',
    'EOI_WRITE_ONESHOT_LATCH_ARMED.store(true, Ordering::SeqCst);',
    'eoi_write_oneshot_latch_from_state(permit, true)'
) "v10.12.0 arm only mutates software latch"
Assert-ContainsInOrder $irrContent1031 @(
    'pub fn eoi_write_oneshot_latch_clear(',
...
Assert-Contains $eoiWriteOneShotLatchFirePrintBlock10120 'latch.fire_cleared_latch' "v10.12.0 latch fire prints no-clear field"

foreach ($eoiWriteOneShotLatchSurface10120 in @($eoiWriteOneShotLatchSnapshotBlock10120, $eoiWriteOneShotLatchNotePrintBlock10120, $eoiWriteOneShotLatchStatusPrintBlock10120, $eoiWriteOneShotLatchArmPrintBlock10120, $eoiWriteOneShotLatchClearPrintBlock10120, $eoiWriteOneShotLatchFirePrintBlock10120, $eoiWriteOneShotLatchBlockersPrintBlock10120, $eoiWriteOneShotLatchNoteBlock10120, $eoiWriteOneShotLatchStatusBlock10120, $eoiWriteOneShotLatchArmBlock10120, $eoiWriteOneShotLatchClearBlock10120, $eoiWriteOneShotLatchFireBlock10120, $eoiWriteOneShotLatchBlockersBlock10120, $eoiWriteOneShotLatchFireHelperBlock10120)) {
    foreach ($blockedEoiWriteOneShotLatchCall10120 in @(
        'write_pic_port(',
        'outb(',
        'asm!("sti")',
        'asm!("sti",',
        ...
        Assert-NotContains $eoiWriteOneShotLatchSurface10120 $blockedEoiWriteOneShotLatchCall10120 "v10.12.0 eoi write one-shot latch surface is software-only/no-hardware: $blockedEoiWriteOneShotLatchCall10120"
    }
}

foreach ($eoiWriteOneShotLatchDispatchBlock10120 in @($eoiWriteOneShotLatchNoteBlock10120, $eoiWriteOneShotLatchStatusBlock10120, $eoiWriteOneShotLatchArmBlock10120, $eoiWriteOneShotLatchClearBlock10120, $eoiWriteOneShotLatchFireBlock10120, $eoiWriteOneShotLatchBlockersBlock10120)) {
    foreach ($blockedEoiWriteOneShotLatchDispatcherInline10120 in @('write!(', 'serial::print', 'vga::print', 'irq::', 'pic::', 'set_handler(', 'write_pic_port(', 'outb(', 'AtomicBool')) {
        Assert-NotContains $eoiWriteOneShotLatchDispatchBlock10120 $blockedEoiWriteOneShotLatchDispatcherInline10120 "v10.12.0 eoi write one-shot latch dispatcher remains helper-only: $blockedEoiWriteOneShotLatchDispatcherInline10120"
    }
}

$expectedQemuEoiWriteOneShotLatchNote10120 = "EOI write one-shot latch note`n    scope: controlled first PIC_EOI write one-shot software latch`n    inputs: software-latch/permit-model/candidate/preflight/mutation-sequence/mutation-checklist/decision/final-gate`n    latch: software telemetry only`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotLatchStatus10120 = "EOI write one-shot latch status`n    latch: software telemetry only`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    target command port: none`n    target value: none`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotLatchArm10120 = "dbyte-kernel> eoi-write-oneshot-latch-arm`n    EOI write one-shot latch arm`n    result: software latch armed`n    latch: software telemetry only`n    one-shot armed: yes`n    fire allowed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotLatchFire10120 = "dbyte-kernel> eoi-write-oneshot-latch-fire`n    EOI write one-shot latch fire`n    error: EOI one-shot latch fire blocked by permit model`n    one-shot armed: yes`n    fire allowed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no`n    blocked fire cleared latch: no"
$expectedQemuEoiWriteOneShotLatchClear10120 = "dbyte-kernel> eoi-write-oneshot-latch-clear`n    EOI write one-shot latch clear`n    result: software latch cleared`n    latch: software telemetry only`n    one-shot armed: no`n    fire allowed: no`n    first PIC_EOI write performed: no`n    hardware mutation: no`n    runtime irq active: no"
$expectedQemuEoiWriteOneShotLatchBlockers10120 = "EOI write one-shot latch blockers`n    - latch scope: software telemetry only`n    - permit granted: no`n    - first PIC_EOI write allowed: no`n    - hardware mutation: no`n    - runtime irq active: no`n    - STI disabled`n    - PIC unmask disabled`n    - live IRQ runtime disabled`n    first PIC_EOI write performed: no"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchNote10120 "v10.12.0 qemu docs eoi write one-shot latch note exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchStatus10120 "v10.12.0 qemu docs eoi write one-shot latch status exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchArm10120 "v10.12.0 qemu docs eoi write one-shot latch arm exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchFire10120 "v10.12.0 qemu docs eoi write one-shot latch fire exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchClear10120 "v10.12.0 qemu docs eoi write one-shot latch clear exact rendered contract"
Assert-Contains $kernelBootSmokeDocs1031 $expectedQemuEoiWriteOneShotLatchBlockers10120 "v10.12.0 qemu docs eoi write one-shot latch blockers exact rendered contract"

foreach ($activeEoiWrite10120 in @(
    'write_pic_port(PIC_MASTER_CMD, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_CMD, PIC_EOI)',
    'write_pic_port(PIC_MASTER_COMMAND, PIC_EOI)',
    'write_pic_port(PIC_SLAVE_COMMAND, PIC_EOI)'
)) {
    Assert-NotContains $mainContent1031 $activeEoiWrite10120 "v10.12.0 no active EOI write in main: $activeEoiWrite10120"
    Assert-NotContains $picContent1031 $activeEoiWrite10120 "v10.12.0 no active EOI write in pic source: $activeEoiWrite10120"
    Assert-NotContains $irrContent1031 $activeEoiWrite10120 "v10.12.0 no active EOI write in irq source: $activeEoiWrite10120"
    Assert-NotContains $kernelIrqDocs1031 $activeEoiWrite10120 "v10.12.0 no active EOI write in irq docs: $activeEoiWrite10120"
    Assert-NotContains $kernelBootSmokeDocs1031 $activeEoiWrite10120 "v10.12.0 no active EOI write in qemu docs: $activeEoiWrite10120"
}

foreach ($forbiddenEoiWriteOneShotLatchPositive10120 in @(
    'permit granted: yes',
    'first PIC_EOI write allowed: yes',
    'fire allowed: yes',
    'first PIC_EOI write performed: yes',
    ...
    Assert-NotContains $mainContent1031 $forbiddenEoiWriteOneShotLatchPositive10120 "v10.12.0 forbidden positive eoi write latch state in main: $forbiddenEoiWriteOneShotLatchPositive10120"
    Assert-NotContains $irrContent1031 $forbiddenEoiWriteOneShotLatchPositive10120 "v10.12.0 forbidden positive eoi write latch state in irq source: $forbiddenEoiWriteOneShotLatchPositive10120"
    Assert-NotContains $kernelIrqDocs1031 $forbiddenEoiWriteOneShotLatchPositive10120 "v10.12.0 forbidden positive eoi write latch state in irq docs: $forbiddenEoiWriteOneShotLatchPositive10120"
    Assert-NotContains $kernelBootSmokeDocs1031 $forbiddenEoiWriteOneShotLatchPositive10120 "v10.12.0 forbidden positive eoi write latch state in qemu docs: $forbiddenEoiWriteOneShotLatchPositive10120"
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.12.0 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.12.0 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.12.0 Controlled EOI Write One-Shot Latch Foundation verified"

# v10.12.1: Controlled EOI Write One-Shot Latch Hardening
Write-Host "Verifying v10.12.1 Controlled EOI Write One-Shot Latch Hardening contracts..."
$v10120Tag = & git rev-list -n 1 v10.12.0 2>$null
$v10120TagType = & git cat-file -t v10.12.0 2>$null
...
Assert-Contains $cargoContent1031 'version = "10.12.1"' "kernel-lab version 10.12.1"
Assert-Contains $kernelCargoLockContent1031 'version = "10.12.1"' "kernel-lab lockfile version 10.12.1"
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.12.1)" "v10.12.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.12.1)" "v10.12.1 qemu docs title"
...
$latchDispatchCount10121 = [regex]::Matches($mainContent1031, 'line_str == "eoi-write-oneshot-latch-[^"]+"').Count
if ($latchDispatchCount10121 -ne 6) { throw "v10.12.1 must not add or remove latch commands; expected 6 dispatches, found $latchDispatchCount10121" }
Assert-Contains $mainContent1031 'eoi-write-oneshot-latch-note eoi-write-oneshot-latch-status eoi-write-oneshot-latch-arm eoi-write-oneshot-latch-clear eoi-write-oneshot-latch-fire eoi-write-oneshot-latch-blockers' "v10.12.1 latch command surface unchanged"

Assert-Contains $eoiWriteOneShotLatchNotePrintBlock10120 $eoiWriteOneShotLatchNoteExact10120 "v10.12.1 eoi-write-oneshot-latch-note exact output"
Assert-Contains $eoiWriteOneShotLatchStatusPrintBlock10120 $eoiWriteOneShotLatchStatusExact10120 "v10.12.1 eoi-write-oneshot-latch-status exact output"
Assert-Contains $eoiWriteOneShotLatchArmPrintBlock10120 $eoiWriteOneShotLatchArmExact10120 "v10.12.1 eoi-write-oneshot-latch-arm exact output"
Assert-Contains $eoiWriteOneShotLatchClearPrintBlock10120 $eoiWriteOneShotLatchClearExact10120 "v10.12.1 eoi-write-oneshot-latch-clear exact output"
Assert-Contains $eoiWriteOneShotLatchFirePrintBlock10120 $eoiWriteOneShotLatchFireExact10120 "v10.12.1 eoi-write-oneshot-latch-fire exact output"
Assert-Contains $eoiWriteOneShotLatchBlockersPrintBlock10120 $eoiWriteOneShotLatchBlockersExact10120 "v10.12.1 eoi-write-oneshot-latch-blockers exact output"

Assert-ContainsInOrder $kernelIrqDocs1031 @(
...
) "v10.12.1 latch lock state sequence documented"
Assert-ContainsInOrder $kernelBootSmokeDocs1031 @(
    'initial one-shot armed: no',
    'unarmed fire blocked by latch state before hardware write',
    'arm reports `one-shot armed: yes`',
    'armed fire remains blocked by the permit model',
    'status remains armed',
    'clear reports `one-shot armed: no`',
    'status remains unarmed'
...
$latchClearStoreCount10121 = [regex]::Matches($irrContent1031, [regex]::Escape('EOI_WRITE_ONESHOT_LATCH_ARMED.store(false, Ordering::SeqCst);')).Count
if ($latchArmStoreCount10121 -ne 1) { throw "v10.12.1 arm must be the only path storing latch true" }
if ($latchClearStoreCount10121 -ne 1) { throw "v10.12.1 clear must be the only path storing latch false" }
Assert-ContainsInOrder $irrContent1031 @(
    'pub fn eoi_write_oneshot_latch_arm(',
    'EOI_WRITE_ONESHOT_LATCH_ARMED.store(true, Ordering::SeqCst);',
    'eoi_write_oneshot_latch_from_state(permit, true)'
) "v10.12.1 arm is the only latch true path"
Assert-ContainsInOrder $irrContent1031 @(
    'pub fn eoi_write_oneshot_latch_clear(',
    'EOI_WRITE_ONESHOT_LATCH_ARMED.store(false, Ordering::SeqCst);',
    'eoi_write_oneshot_latch_from_state(permit, false)'
) "v10.12.1 clear is the only latch false path"
Assert-Contains $eoiWriteOneShotLatchFireHelperBlock10120 'EOI_WRITE_ONESHOT_LATCH_ARMED.load(Ordering::SeqCst);' "v10.12.1 latch fire reads latch"
Assert-NotContains $eoiWriteOneShotLatchFireHelperBlock10120 '.store(' "v10.12.1 latch fire must not mutate latch"
Assert-Contains $eoiWriteOneShotLatchFirePrintBlock10120 'blocked fire cleared latch: {}' "v10.12.1 blocked fire exposes no-clear field"
Assert-Contains $expectedQemuEoiWriteOneShotLatchFire10120 'blocked fire cleared latch: no' "v10.12.1 blocked fire qemu contract does not clear latch"

foreach ($eoiWriteNoHardwareSource10121 in @($mainContent1031, $irrContent1031)) {
    if ([regex]::IsMatch($eoiWriteNoHardwareSource10121, 'write_pic_port\s*\(\s*PIC_(MASTER|SLAVE)_(CMD|COMMAND)\s*,\s*PIC_EOI\s*\)')) {
        throw "v10.12.1 must not write PIC_EOI through a PIC command port"
    }
    Assert-NotContains $eoiWriteNoHardwareSource10121 'asm!("sti")' "v10.12.1 no sti instruction"
    Assert-NotContains $eoiWriteNoHardwareSource10121 'runtime irq active: yes' "v10.12.1 no runtime irq active yes"
    Assert-NotContains $eoiWriteNoHardwareSource10121 'keyboard mode: irq' "v10.12.1 no keyboard IRQ mode"
}

foreach ($eoiWriteOneShotLatchSurface10121 in @($eoiWriteOneShotLatchSnapshotBlock10120, $eoiWriteOneShotLatchNotePrintBlock10120, $eoiWriteOneShotLatchStatusPrintBlock10120, $eoiWriteOneShotLatchArmPrintBlock10120, $eoiWriteOneShotLatchClearPrintBlock10120, $eoiWriteOneShotLatchFirePrintBlock10120, $eoiWriteOneShotLatchBlockersPrintBlock10120, $eoiWriteOneShotLatchNoteBlock10120, $eoiWriteOneShotLatchStatusBlock10120, $eoiWriteOneShotLatchArmBlock10120, $eoiWriteOneShotLatchClearBlock10120, $eoiWriteOneShotLatchFireBlock10120, $eoiWriteOneShotLatchBlockersBlock10120, $eoiWriteOneShotLatchFireHelperBlock10120)) {
    foreach ($blockedLatchHardwareCall10121 in @('write_pic_port(', 'outb(', 'asm!("sti")', 'set_handler(', 'idt::IDT.entries[32]', 'idt::IDT.entries[33]', 'keyboard mode: irq')) {
        Assert-NotContains $eoiWriteOneShotLatchSurface10121 $blockedLatchHardwareCall10121 "v10.12.1 latch surface remains software-only: $blockedLatchHardwareCall10121"
    }
}

Assert-Contains $mainContent1031 'let status = serial::inb(0x64);' "v10.12.1 keyboard status polling remains PS/2 read"
Assert-Contains $mainContent1031 'let scancode = serial::inb(0x60);' "v10.12.1 keyboard scancode polling remains PS/2 read"

Write-Host "[OK] v10.12.1 Controlled EOI Write One-Shot Latch Hardening verified"
...
$kernelMainEntryIndex = $kernelMainSource.IndexOf('pub extern "C" fn kernel_main()')
if ($kernelMainEntryIndex -lt 0) { throw "Kernel boot path guard failed: kernel_main entry not found" }
$kernelBootPath = $kernelMainSource.Substring($kernelMainEntryIndex, $kernelMainSource.IndexOf('loop {') - $kernelMainEntryIndex)
...
if ($picRemapStateCalls -ne 46 -or $picRemapHistoryCalls -ne 1 -or $picRemapPreflightCalls -ne 1) {
    throw "Kernel PIC remap telemetry guard failed: expected state=46 (existing telemetry readers plus irq-runtime-gate-status/check/blockers, irq-runtime-sim-status/run/blockers, sti-status/preflight/blockers, irq-runtime-activation-smoke/status/blockers, eoi-dispatch-smoke commands, pic-unmask-smoke commands, idt-runtime-bind-smoke commands, irq-runtime-final-gate commands, and shared irq-runtime-decision/mutation/sequence/eoi-write-preflight/eoi-write-candidate/eoi-write-permit snapshots; one-shot delegates through the permit snapshot), history=1, preflight=1; found state=$picRemapStateCalls history=$picRemapHistoryCalls preflight=$picRemapPreflightCalls"
}
...
$stiStatusDispatch = $kernelMainSource.IndexOf('line_str == "sti-status"')
$stiPreflightDispatch = $kernelMainSource.IndexOf('line_str == "sti-preflight"')
$stiBlockersDispatch = $kernelMainSource.IndexOf('line_str == "sti-blockers"')
$irqRuntimeActivationSmokeDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-activation-smoke"')
$irqRuntimeActivationSmokeStatusDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-activation-smoke-status"')
$irqRuntimeActivationSmokeBlockersDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-activation-smoke-blockers"')
$eoiDispatchSmokeNoteDispatch = $kernelMainSource.IndexOf('line_str == "eoi-dispatch-smoke-note"')
$eoiDispatchSmokeStatusDispatch = $kernelMainSource.IndexOf('line_str == "eoi-dispatch-smoke-status"')
$eoiDispatchSmokePlanDispatch = $kernelMainSource.IndexOf('line_str == "eoi-dispatch-smoke-plan"')
$eoiDispatchSmokeBlockersDispatch = $kernelMainSource.IndexOf('line_str == "eoi-dispatch-smoke-blockers"')
$picUnmaskSmokeNoteDispatch = $kernelMainSource.IndexOf('line_str == "pic-unmask-smoke-note"')
$picUnmaskSmokeStatusDispatch = $kernelMainSource.IndexOf('line_str == "pic-unmask-smoke-status"')
$picUnmaskSmokePlanDispatch = $kernelMainSource.IndexOf('line_str == "pic-unmask-smoke-plan"')
$picUnmaskSmokeBlockersDispatch = $kernelMainSource.IndexOf('line_str == "pic-unmask-smoke-blockers"')
$idtRuntimeBindSmokeNoteDispatch = $kernelMainSource.IndexOf('line_str == "idt-runtime-bind-smoke-note"')
$idtRuntimeBindSmokeStatusDispatch = $kernelMainSource.IndexOf('line_str == "idt-runtime-bind-smoke-status"')
$idtRuntimeBindSmokePlanDispatch = $kernelMainSource.IndexOf('line_str == "idt-runtime-bind-smoke-plan"')
$idtRuntimeBindSmokeBlockersDispatch = $kernelMainSource.IndexOf('line_str == "idt-runtime-bind-smoke-blockers"')
$irqRuntimeFinalGateNoteDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-final-gate-note"')
$irqRuntimeFinalGateStatusDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-final-gate-status"')
$irqRuntimeFinalGateCheckDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-final-gate-check"')
$irqRuntimeFinalGateBlockersDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-final-gate-blockers"')
$irqRuntimeDecisionNoteDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-decision-note"')
$irqRuntimeDecisionStatusDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-decision-status"')
$irqRuntimeDecisionFreezeDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-decision-freeze"')
$irqRuntimeDecisionBlockersDispatch = $kernelMainSource.IndexOf('line_str == "irq-runtime-decision-blockers"')
...
$eoiWriteSmokeCandidateSnapshotHelper = $kernelMainSource.IndexOf('fn eoi_write_smoke_candidate_snapshot()')
$eoiWritePermitSnapshotHelper = $kernelMainSource.IndexOf('fn eoi_write_permit_model_snapshot()')
$eoiWriteOneShotSnapshotHelper = $kernelMainSource.IndexOf('fn eoi_write_oneshot_command_path_snapshot()')
...
foreach ($call in [regex]::Matches($kernelMainSource, 'pic::ProgrammableInterruptController::pic_remap_state\(\)')) {
    ...
    $nearStiStatusCommand = ($callIndex -gt $stiStatusDispatch -and $callIndex -lt $stiStatusDispatch + 2048)
    $nearStiPreflightCommand = ($callIndex -gt $stiPreflightDispatch -and $callIndex -lt $stiPreflightDispatch + 2048)
    $nearStiBlockersCommand = ($callIndex -gt $stiBlockersDispatch -and $callIndex -lt $stiBlockersDispatch + 2048)
    $nearIrqRuntimeActivationSmokeCommand = ($callIndex -gt $irqRuntimeActivationSmokeDispatch -and $callIndex -lt $irqRuntimeActivationSmokeDispatch + 4096)
    $nearIrqRuntimeActivationSmokeStatusCommand = ($callIndex -gt $irqRuntimeActivationSmokeStatusDispatch -and $callIndex -lt $irqRuntimeActivationSmokeStatusDispatch + 4096)
    $nearIrqRuntimeActivationSmokeBlockersCommand = ($callIndex -gt $irqRuntimeActivationSmokeBlockersDispatch -and $callIndex -lt $irqRuntimeActivationSmokeBlockersDispatch + 4096)
    $nearEoiDispatchSmokeNoteCommand = ($callIndex -gt $eoiDispatchSmokeNoteDispatch -and $callIndex -lt $eoiDispatchSmokeNoteDispatch + 4096)
    $nearEoiDispatchSmokeStatusCommand = ($callIndex -gt $eoiDispatchSmokeStatusDispatch -and $callIndex -lt $eoiDispatchSmokeStatusDispatch + 4096)
    $nearEoiDispatchSmokePlanCommand = ($callIndex -gt $eoiDispatchSmokePlanDispatch -and $callIndex -lt $eoiDispatchSmokePlanDispatch + 4096)
    $nearEoiDispatchSmokeBlockersCommand = ($callIndex -gt $eoiDispatchSmokeBlockersDispatch -and $callIndex -lt $eoiDispatchSmokeBlockersDispatch + 4096)
    $nearPicUnmaskSmokeNoteCommand = ($callIndex -gt $picUnmaskSmokeNoteDispatch -and $callIndex -lt $picUnmaskSmokeNoteDispatch + 4096)
    $nearPicUnmaskSmokeStatusCommand = ($callIndex -gt $picUnmaskSmokeStatusDispatch -and $callIndex -lt $picUnmaskSmokeStatusDispatch + 4096)
    $nearPicUnmaskSmokePlanCommand = ($callIndex -gt $picUnmaskSmokePlanDispatch -and $callIndex -lt $picUnmaskSmokePlanDispatch + 4096)
    $nearPicUnmaskSmokeBlockersCommand = ($callIndex -gt $picUnmaskSmokeBlockersDispatch -and $callIndex -lt $picUnmaskSmokeBlockersDispatch + 4096)
    $nearIdtRuntimeBindSmokeNoteCommand = ($callIndex -gt $idtRuntimeBindSmokeNoteDispatch -and $callIndex -lt $idtRuntimeBindSmokeNoteDispatch + 4096)
    $nearIdtRuntimeBindSmokeStatusCommand = ($callIndex -gt $idtRuntimeBindSmokeStatusDispatch -and $callIndex -lt $idtRuntimeBindSmokeStatusDispatch + 4096)
    $nearIdtRuntimeBindSmokePlanCommand = ($callIndex -gt $idtRuntimeBindSmokePlanDispatch -and $callIndex -lt $idtRuntimeBindSmokePlanDispatch + 4096)
    $nearIdtRuntimeBindSmokeBlockersCommand = ($callIndex -gt $idtRuntimeBindSmokeBlockersDispatch -and $callIndex -lt $idtRuntimeBindSmokeBlockersDispatch + 4096)
    $nearIrqRuntimeFinalGateNoteCommand = ($callIndex -gt $irqRuntimeFinalGateNoteDispatch -and $callIndex -lt $irqRuntimeFinalGateNoteDispatch + 4096)
    $nearIrqRuntimeFinalGateStatusCommand = ($callIndex -gt $irqRuntimeFinalGateStatusDispatch -and $callIndex -lt $irqRuntimeFinalGateStatusDispatch + 4096)
    $nearIrqRuntimeFinalGateCheckCommand = ($callIndex -gt $irqRuntimeFinalGateCheckDispatch -and $callIndex -lt $irqRuntimeFinalGateCheckDispatch + 4096)
    $nearIrqRuntimeFinalGateBlockersCommand = ($callIndex -gt $irqRuntimeFinalGateBlockersDispatch -and $callIndex -lt $irqRuntimeFinalGateBlockersDispatch + 4096)
    $nearIrqRuntimeDecisionNoteCommand = ($callIndex -gt $irqRuntimeDecisionNoteDispatch -and $callIndex -lt $irqRuntimeDecisionNoteDispatch + 4096)
    $nearIrqRuntimeDecisionStatusCommand = ($callIndex -gt $irqRuntimeDecisionStatusDispatch -and $callIndex -lt $irqRuntimeDecisionStatusDispatch + 4096)
    $nearIrqRuntimeDecisionFreezeCommand = ($callIndex -gt $irqRuntimeDecisionFreezeDispatch -and $callIndex -lt $irqRuntimeDecisionFreezeDispatch + 4096)
    $nearIrqRuntimeDecisionBlockersCommand = ($callIndex -gt $irqRuntimeDecisionBlockersDispatch -and $callIndex -lt $irqRuntimeDecisionBlockersDispatch + 4096)
...
if ($irqGateStateCalls -ne 46 -or $irqGateHistoryCalls -ne 1 -or $irqGatePreflightCalls -ne 1) {
    throw "Kernel IRQ gate bind telemetry guard failed: expected state=46 (existing telemetry readers plus irq-runtime-gate-status/check/blockers, irq-runtime-sim-status/run/blockers, sti-status/preflight/blockers, irq-runtime-activation-smoke/status/blockers, eoi-dispatch-smoke commands, pic-unmask-smoke commands, idt-runtime-bind-smoke commands, irq-runtime-final-gate commands, and shared irq-runtime-decision/mutation/sequence/eoi-write-preflight/eoi-write-candidate/eoi-write-permit snapshots; one-shot delegates through the permit snapshot), history=1, preflight=1; found state=$irqGateStateCalls history=$irqGateHistoryCalls preflight=$irqGatePreflightCalls"
}
