...
Assert-Contains $cargoContent 'version = "10.6.1"' "kernel-lab version 10.6.1"
...
Assert-Contains $cargoContent930 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent931 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent940 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent941 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent950 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent951 'version = "10.6.1"' "kernel-lab current version 10.6.1"
...
Assert-Contains $cargoContent960 'version = "10.6.1"' "kernel-lab version 10.6.1"
...
Assert-Contains $cargoContent961 'version = "10.6.1"' "kernel-lab version 10.6.1"
...
Assert-Contains $cargoContent971 'version = "10.6.1"' "kernel-lab version 10.6.1"
...
Assert-Contains $cargoContent980 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent980 'version = "9.7.1"' "kernel-lab stale v9.7.1 package version guard"
Assert-Contains $kernelCargoLockContent980 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent981 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent981 'version = "9.8.0"' "kernel-lab stale v9.8.0 package version guard"
Assert-Contains $kernelCargoLockContent981 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent990 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent990 'version = "9.8.1"' "kernel-lab stale v9.8.1 package version guard"
Assert-Contains $kernelCargoLockContent990 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent991 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent991 'version = "9.9.0"' "kernel-lab stale v9.9.0 package version guard"
Assert-Contains $kernelCargoLockContent991 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1000 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1000 'version = "9.9.1"' "kernel-lab stale v9.9.1 package version guard"
Assert-Contains $kernelCargoLockContent1000 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1001 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1001 'version = "10.0.0"' "kernel-lab stale v10.0.0 package version guard"
Assert-Contains $kernelCargoLockContent1001 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1010 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1010 'version = "10.0.1"' "kernel-lab stale v10.0.1 package version guard"
Assert-Contains $kernelCargoLockContent1010 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1011 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1011 'version = "10.1.0"' "kernel-lab stale v10.1.0 package version guard"
Assert-Contains $kernelCargoLockContent1011 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1020 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1020 'version = "10.1.1"' "kernel-lab stale v10.1.1 package version guard"
Assert-Contains $kernelCargoLockContent1020 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1021 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1021 'version = "10.2.0"' "kernel-lab stale v10.2.0 package version guard"
Assert-Contains $kernelCargoLockContent1021 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1030 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1030 'version = "10.2.1"' "kernel-lab stale v10.2.1 package version guard"
Assert-Contains $kernelCargoLockContent1030 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $cargoContent1031 'version = "10.6.1"' "kernel-lab version 10.6.1"
Assert-NotContains $cargoContent1031 'version = "10.3.0"' "kernel-lab stale v10.3.0 package version guard"
Assert-Contains $kernelCargoLockContent1031 'version = "10.6.1"' "kernel-lab lockfile version 10.6.1"
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.6.1)" "current irq docs title preserves later release"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.6.1)" "current qemu docs title preserves later release"
...
Assert-Contains $mainContent1031 'irq-runtime-mutation-note irq-runtime-mutation-status irq-runtime-mutation-check irq-runtime-mutation-blockers' "help string includes v10.6.0 mutation commands"
...
Assert-Contains $kernelIrqDocs1031 "# DByteOS Kernel IRQ/PIC Safety Notes (v10.6.1)" "v10.6.1 irq docs title"
Assert-Contains $kernelBootSmokeDocs1031 "# DByteOS QEMU Boot Smoke (v10.6.1)" "v10.6.1 qemu docs title"
...
Assert-Contains $mainContent1031 'irq-runtime-mutation-note irq-runtime-mutation-status irq-runtime-mutation-check irq-runtime-mutation-blockers' "help string includes v10.6.1 mutation commands"
...
if ($irqGateStateCalls -ne 42 -or $irqGateHistoryCalls -ne 1 -or $irqGatePreflightCalls -ne 1) {
    throw "Kernel IRQ gate bind telemetry guard failed: expected state=42 (existing telemetry readers plus irq-runtime-gate-status/check/blockers, irq-runtime-sim-status/run/blockers, sti-status/preflight/blockers, irq-runtime-activation-smoke/status/blockers, eoi-dispatch-smoke commands, pic-unmask-smoke commands, idt-runtime-bind-smoke commands, irq-runtime-final-gate commands, and shared irq-runtime-decision/mutation snapshots), history=1, preflight=1; found state=$irqGateStateCalls history=$irqGateHistoryCalls preflight=$irqGatePreflightCalls"
}
