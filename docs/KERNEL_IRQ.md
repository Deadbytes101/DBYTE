...
## v8.14.1 IRQ Gate Bind State Telemetry & Static Guards
...
- **IRQ0 timer**: skeleton planned PIT timer interrupt; bind smoke stub is dormant in `v8.14.1`.
- **IRQ1 keyboard**: skeleton planned PS/2 keyboard interrupt; bind smoke stub is dormant in `v8.14.1`.
...
- **STI**: Set Interrupt Flag instruction; not used in `v8.14.1`.
