...
Pinned `v10.46.0` graphics argtest serial proofs are: `gfx-console-shell: command dispatched: apps`, `gfx-console-shell: app dispatched: argtest`, and `gfx-console-shell: exit`.

Pinned `v10.46.0` graphics argtest proof strings are: `command: apps`, `apps: hello math sysinfo`, `apps: ticks tickmath argtest`, `command: run argtest`, `APP ARGTEST`, and `ARG VALUE 7`.
