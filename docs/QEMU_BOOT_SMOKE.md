...
Pinned `v10.44.0` graphics tick proof strings are: `command: apps`, `apps: hello math sysinfo ticks`, `command: run ticks`, `APP TICKS`, `IRQ0 TICKS 0008`, and `IRQ0 MASKED`.
...
3. Type commands and press Enter to execute them. For example:
   ```txt
    ...
    gfx-console-shell: app dispatched: ticks
