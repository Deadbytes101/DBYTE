# DByteOS QEMU Boot Smoke (v7.0.1)
...
| `version` | None | Prints: `DByteOS Kernel Lab 7.0.1` |
...
> [!WARNING]
> This release (`v7.0.1`) enforces strict technical bounds to maintain lab stability:
>
