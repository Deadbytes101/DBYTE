# DByteOS QEMU Boot Smoke (v10.48.0)
...
Pinned `v10.48.0` graphics logtest serial proofs are: `gfx-console-shell: command dispatched: apps`, `gfx-console-shell: app dispatched: logtest`, and `gfx-console-shell: exit`.

Pinned `v10.48.0` graphics logtest proof strings are: `command: apps`, `apps: hello math sysinfo`, `apps: ticks tickmath argtest`, `apps: strtest logtest`, `command: run logtest`, `APP LOGTEST`, and `HELLO GRAPHICS LOG`.
