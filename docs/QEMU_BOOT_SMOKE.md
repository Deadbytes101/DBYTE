# DByteOS QEMU Boot Smoke (v8.7.0)
...
| `version` | None | Prints: `DByteOS Kernel Lab 8.7.0` |
...
> [!WARNING]
> This release (`v8.7.0`) enforces strict technical bounds to maintain lab stability:
>
