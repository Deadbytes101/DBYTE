...
Pinned `v10.47.0` graphics strtest serial proofs are: `gfx-console-shell: command dispatched: apps`, `gfx-console-shell: app dispatched: strtest`, and `gfx-console-shell: exit`.

Pinned `v10.47.0` graphics strtest proof strings are: `command: apps`, `apps: hello math sysinfo`, `apps: ticks tickmath argtest`, `apps: strtest`, `command: run strtest`, `APP STRTEST`, and `ARG TEXT DBYTE SERVICE ARG`.
