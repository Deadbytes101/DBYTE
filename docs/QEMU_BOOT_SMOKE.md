# DByteOS QEMU Boot Smoke (v8.9.0)
...
| `version` | None | Prints: `DByteOS Kernel Lab 8.9.0` |
...
> [!WARNING]
> This readiness release (`v8.9.0`) enforces strict technical bounds to maintain lab stability:
>
