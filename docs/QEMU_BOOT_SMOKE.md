# DByteOS QEMU Boot Smoke (v10.45.1)
...
Pinned `v10.45.1` graphics tickmath clipping proof strings are: `command: apps`, `apps: hello math sysinfo ticks tickmath`, `command: run tickmath`, `APP TICKMATH`, and `9`.
