# DByteOS QEMU Boot Smoke (v7.0.0)
...
| `version` | None | Prints: `DByteOS Kernel Lab 7.0.0` |
...
| `system` | None | Prints overall system summary (version, input, display, COM1 serial settings, `filesystem: none`, `process model: none`, `dbyte vm: none`, `interrupts: planned / disabled`). |
...
> [!WARNING]
> This release (`v7.0.0`) enforces strict technical bounds to maintain lab stability:
>
