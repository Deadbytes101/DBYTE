...
Pinned `v10.43.0` graphics KCALL proof strings are: `command: apps`, `apps: hello math sysinfo`, `command: run sysinfo`, `APP SYSINFO`, `KERNEL ONLINE`, `DBYTE VM ONLINE`, and `GRAPHICS MODE 13H`.
...
3. Type commands and press Enter to execute them. For example:
   ```txt
    ...
    gfx-console-shell: app dispatched: sysinfo
