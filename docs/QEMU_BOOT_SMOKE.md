# DByteOS QEMU Boot Smoke (v7.7.1)
...
| `version` | None | Prints: `DByteOS Kernel Lab 7.7.1` |
...
| `handlers` | None | Lists active handlers for vector 0 and 3, plus planned vector 14 page fault. |
...
> [!WARNING]
> This release (`v7.7.1`) enforces strict technical bounds to maintain lab stability:
>
