...
Pinned `v10.45.0` graphics tickmath proof strings are: `command: apps`, `apps: hello math sysinfo ticks tickmath`, `command: run tickmath`, `APP TICKMATH`, and `9`.
