# DByteOS QEMU Boot Smoke (v7.3.0)
...
| `version` | None | Prints: `DByteOS Kernel Lab 7.3.0` |
...
> [!WARNING]
> This release (`v7.3.0`) enforces strict technical bounds to maintain lab stability:
>
