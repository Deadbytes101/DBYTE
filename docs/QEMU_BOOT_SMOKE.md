...
| `gfx-console-shell`    | One bounded command via PS/2 polling | Enters VGA Mode 13h, dispatches the graphics-only `status` command or deterministic unknown-command result, and prints the dispatch result over serial. |
