...
As the v5.1.0 Personal Alpha milestone, DByteOS includes the shell, package flow, manual pages, onboarding, profile/config/preferences, prompt integration, notes, journal, workspace projects, services, diagnostics, snapshot, and simulated permission model. Future releases can build on this baseline without redefining the userland boundary.

---
[Home](../README.md) | [Personal Alpha](DBYTEOS_PERSONAL_ALPHA.md) | [Commands](DBYTEOS_COMMANDS.md) | [Projects](DBYTEOS_PROJECTS.md) | [Security](DBYTEOS_SECURITY.md) | [Boot](DBYTEOS_BOOT.md)
