...
fn idt_bind_runtime_bridge_readiness_snapshot() -> irq::IdtBindRuntimeBridgeReadiness {
    ...
    irq::idt_bind_runtime_bridge_readiness(
        smoke.manual_idt_bind_smoke_proven_this_boot,
        bind,
    )
}
